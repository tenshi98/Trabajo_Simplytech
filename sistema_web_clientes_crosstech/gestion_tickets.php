...
if(!empty($_GET['id'])){
	/*******************************************************/
	// consulto los datos
	$SIS_query = 'idArea, idPrioridad, Titulo, Descripcion';
	$SIS_join  = '';
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
		switch ($_GET['order_by']) {
			...
			default: $order_by = 'crosstech_gestion_tickets.idEstado ASC, crosstech_gestion_tickets.FechaCreacion DESC'; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Estado Ascendente, Fecha Creacion Descendente';
		}
	}else{
		$order_by = 'crosstech_gestion_tickets.idEstado ASC, crosstech_gestion_tickets.FechaCreacion DESC'; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Estado Ascendente, Fecha Creacion Descendente';
	}
	/**********************************************************/
	//Variable de busqueda
	$SIS_where = "crosstech_gestion_tickets.idTicket!=0";
	//sistema
	$SIS_where.= " AND crosstech_gestion_tickets.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];
	//solo mostrar los tickets propios
	$SIS_where.= " AND crosstech_gestion_tickets.idCliente=".$_SESSION['usuario']['basic_data']['idCliente'];
	/**********************************************************/
