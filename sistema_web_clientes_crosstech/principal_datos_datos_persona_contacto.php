...
$location = $original;
$new_location = "principal_datos_datos_persona_contacto.php";
//Titulo ventana
...
/*******************************************************/
// consulto los datos
$SIS_query = 'Nombre,PersonaContacto, PersonaContacto_Fono, PersonaContacto_email, idTipo';
$SIS_join  = '';
$SIS_where = 'idCliente = '.$_SESSION['usuario']['basic_data']['idCliente'];
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li class="active"><a href="<?php echo 'principal_datos_datos_persona_contacto.php'; ?>" ><i class="fa fa-volume-control-phone" aria-hidden="true"></i> Persona Contacto</a></li>
