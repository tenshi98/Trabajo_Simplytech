...
/*******************************************************************************************************************/
	...
	foreach ($piezas as $valor) {
		...
		switch ($valor) {
			case 'idPermisos':  if(empty($idPermisos)){  $error['idPermisos']  = 'error/No ha ingresado el id';}break;
			case 'idUsuario':   if(empty($idUsuario)){   $error['idUsuario']   = 'error/No ha seleccionado a un usuario';}break;
			case 'idAdmpm':     if(empty($idAdmpm)){     $error['idAdmpm']     = 'error/No ha seleccionado un permiso';}break;
			case 'level':       if(empty($level)){       $error['level']       = 'error/No ha seleccionado el nivel del permiso';}break;
