...
/*******************************************************************************************************************/		
		case 'insert':
			...
			if(isset($Nombre)){
				$sql_usuario = mysqli_query("SELECT Nombre FROM productos_categorias WHERE Nombre='".$Nombre."' "); 
			...
			if ( empty($error) ) {
				...
				$query  = "INSERT INTO `productos_categorias` (Nombre) VALUES ({$a} )";
...
/*******************************************************************************************************************/		
		case 'update':	
			...
			if ( empty($error) ) {
				...
				// inserto los datos de registro en la db
				$query  = "UPDATE `productos_categorias` SET ".$a." WHERE idCategoria = '$idCategoria'";
				$result = mysqli_query($dbConn, $query);
...
/*******************************************************************************************************************/
		case 'del':	
			...
			$query  = "DELETE FROM `productos_categorias` WHERE idCategoria = {$_GET['del']}";
			$result = mysqli_query($dbConn, $query);	
