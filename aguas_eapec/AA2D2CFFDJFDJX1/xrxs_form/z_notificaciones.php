...
/*******************************************************************************************************************/		
		case 'enviar_masivo':
			...
			if ( empty($error) ) {
				...
				$Notificacion  = '<div class="btn-group" ><a href="view_notificacion.php?view='.$ultimo_id.'" data-placement="bottom" title="Ver Informacion" data-toggle="tooltip" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-list"></i></a></div>';
				$Notificacion .= $Titulo;
				$Estado = '1';
