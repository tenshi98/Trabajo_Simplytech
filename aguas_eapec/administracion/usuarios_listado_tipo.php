...
if ( !empty($_POST['submit_edit']) )  { 
	...
	$location.='&id='.$_GET['id'];
	$form_obligatorios = 'idUsuario,tipo';
	$form_trabajo= 'update';
        ...
        <div class="table-responsive">
			<div class="col-lg-6 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" name="form1">
					...
					if(isset($tipo)) {         $x1  = $tipo;         }else{$x1  = $rowdata['tipo'];}

					//se dibujan los inputs
					echo '<h3>Cambiar Tipo de usuario</h3>';
					echo form_select('Tipo de usuario','tipo', $x1, 2, 'Nombre', 'Nombre', 'usuarios_tipos', 0, $dbConn);
					?>
