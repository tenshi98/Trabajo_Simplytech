...
<?php require_once 'core/header.php';?>
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            <h3><i class="fa fa-dashboard"></i> Administracion de SuperUsuarios</h3>
          </div>
        </header>
      </div>
      <div id="left">
...
<a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" >Crear Nuevo Usuario</a>
</div>
<div class="clearfix"></div>                       
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group widthtd120" >
								<a href="<?php echo $location.'&view='.$usuarios['idUsuario']; ?>" data-placement="bottom" title="Ver Informacion" data-toggle="tooltip" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-list"></i></a>
								<a href="<?php echo $location.'&id='.$usuarios['idUsuario']; ?>" data-placement="bottom" title="Editar Informacion" data-toggle="tooltip" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-pencil-square-o"></i></a>
								<?php 
								$ubicacion = $location.'&del='.$usuarios['idUsuario'];
								$dialogo   = '¿Realmente deseas eliminar el registro de : '.$usuarios['Nombre'].'?';?>
