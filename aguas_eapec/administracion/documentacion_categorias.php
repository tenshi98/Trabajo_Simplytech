...
$original = "documentacion_categorias.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/documentacion_categorias.php';
}
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE documentacion_categorias.idSistema>=0";	
}else{
	$z="WHERE documentacion_categorias.idSistema={$arrUsuario['idSistema']}";	
}
//Verifico si la variable de busqueda existe
if (isset($_GET['search']) && $_GET['search'] != ''){      
	$z .=" AND documentacion_categorias.Nombre LIKE '%{$_GET['search']}%'";
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT documentacion_categorias.idCategoria FROM `documentacion_categorias` ".$z."";
...
FROM `documentacion_categorias`
LEFT JOIN `core_sistemas` ON core_sistemas.idSistema = documentacion_categorias.idSistema
".$z."
