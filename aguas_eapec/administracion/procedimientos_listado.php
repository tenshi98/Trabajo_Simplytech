...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" >Crear Nuevo Procedimiento</a><?php } ?>
</div>
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group widthtd120" >
								...
								<?php if ($rowlevel['level']>=2){?><a href="?php echo $location.'&id='.$tipo['idProcedimiento']; ?>" data-placement="bottom" title="Editar Informacion" data-toggle="tooltip" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-pencil-square-o"></i></a><?php } ?>
								<?php if ($rowlevel['level']>=4){
									$ubicacion = $location.'&del='.$tipo['idProcedimiento'];
