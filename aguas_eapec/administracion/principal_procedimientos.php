...
<?php require_once 'core/header.php';?>
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            <h3><i class="fa fa-file-word-o"></i> Procedimientos</h3>
          </div>
        </header>
      </div>
      <div id="left">
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z =" WHERE procedimientos_listado.idSistema>=0";			
}else{
	$z = "WHERE procedimientos_listado.idSistema={$arrUsuario['idSistema']} OR procedimientos_listado.idSistema=9999";	
}
if (isset($_GET['filtersender'])){
	$z .= " AND procedimientos_listado.idCategoria = {$_GET['filtersender']}";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idProcedimiento FROM `procedimientos_listado` 
".$z;
...
count(procedimientos_listado.idProcedimiento)AS cuenta
FROM `procedimientos_categorias`
LEFT JOIN `procedimientos_listado`  ON procedimientos_listado.idCategoria   = procedimientos_categorias.idCategoria
GROUP BY procedimientos_categorias.idCategoria
