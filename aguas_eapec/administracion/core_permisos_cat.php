...
<?php require_once 'core/header.php';?>
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            <h3><i class="fa fa-dashboard"></i> Mantencion de las categorias de los permisos</h3>
          </div>
        </header>
      </div>
      <div id="left">
...
<a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" >Crear Nueva Categoria</a>
</div>
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group widthtd120" >
								<a href="<?php echo $location.'&id='.$catpem['id_pmcat']; ?>" data-placement="bottom" title="Editar Informacion" data-toggle="tooltip" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-pencil-square-o"></i></a>
								<?php 
								$ubicacion = $location.'&del='.$catpem['id_pmcat'];
								$dialogo   = '¿Realmente deseas eliminar el registro de : '.$catpem['Nombre'].'?';?>
