...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Facturacion fecha '.$arrFacturacion[0]['Fecha']);
...
header('Content-Disposition: attachment;filename="Facturacion fecha '.$arrFacturacion[0]['Fecha'].'.xls"');
