...
$location = $original;
$new_location = "usuarios_listado_datos.php";
...
$query = "SELECT Nombre, Fono, email, Rut, fNacimiento, Ciudad, Comuna, Direccion, Direccion_img, idSistema
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'usuarios_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos</a></li>
        ...
        <div class="table-responsive">
			<div class="col-lg-6 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post"  name="form1">		
					...
					echo '<h3>Modificacion Datos Personales</h3>';
