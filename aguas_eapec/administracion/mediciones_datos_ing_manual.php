...
$original = "mediciones_datos_ing_manual.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'Fecha,Nombre,idSistema,idCliente,Consumo';
	$form_trabajo= 'insert_manual';
...
$query = "SELECT idTipoFacturacion, idTipoLectura, Consumo
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post"  name="form1">
			...
			<?php 
			//Se verifican si existen los datos
			if(isset($idTipoFacturacion)) {  $x1  = $idTipoFacturacion;   }else{$x1  = $rowdata['idTipoFacturacion'];}
			if(isset($idTipoLectura)) {      $x2  = $idTipoLectura;       }else{$x2  = $rowdata['idTipoLectura'];}
			if(isset($Consumo)) {            $x3  = $Consumo;             }else{$x3  = $rowdata['Consumo'];}
	

			//se dibujan los inputs
			echo form_select('Tipo Facturacion','idTipoFacturacion', $x1, 2, 'idTipoFacturacion', 'Nombre', 'mediciones_datos_detalle_tipofacturacion', 'idTipoFacturacion!=1', $dbConn);
			echo form_select('Tipo Lectura','idTipoLectura', $x2, 2, 'idTipoLectura', 'Nombre', 'mediciones_datos_detalle_tipolectura', 'idTipoLectura!=1', $dbConn);
			echo form_input_number('Consumo', 'Consumo', $x3, 2);
...
if($arrUsuario['tipo']=='SuperAdmin'){
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			<div class="icons"><i class="fa fa-edit"></i></div>
			<h5>Crear Nuevo Ingreso Manual</h5>
		</header>
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1" >
				...
				if(isset($idTipoFacturacion)) { $x15 = $idTipoFacturacion;  }else{$x15 = '';}
				if(isset($idTipoLectura)) {     $x16 = $idTipoLectura;      }else{$x16 = '';}
				...
				echo form_select('Tipo Facturacion','idTipoFacturacion', $x15, 2, 'idTipoFacturacion', 'Nombre', 'mediciones_datos_detalle_tipofacturacion', 'idTipoFacturacion!=1', $dbConn);
				echo form_select('Tipo Lectura','idTipoLectura', $x16, 2, 'idTipoLectura', 'Nombre', 'mediciones_datos_detalle_tipolectura', 'idTipoLectura!=1', $dbConn);
...
//se filtran para mostrar solo los ingresos manuales
$z.=" AND mediciones_datos.idTipo=3";	
