...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'Proveedor: '.$arrProductos[0]['Proveedor']);
//Titulo columnas
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A2', 'Registros de '.$arrProductos[0]['Mes'].' de '.$_GET['Creacion_ano']);            
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('F'.$nn, cantidades_excel($productos['Cantidad_ing']))
...
header('Content-Disposition: attachment;filename="Movimiento Proveedor '.$arrProductos[0]['Proveedor'].'.xls"');
