							...
							<div style="width:90px;" >		 
								...
								<ul class="interruptor">   
								   <?php if ( $rowdata['estado']=='Activo' ) {?>   
									<li class="primer_int"><a href="<?php echo $new_location.'&id='.$rowdata['idUsuario'].'&estado=2' ; ?>">OFF</a></li>
									<li class="ultimo_int on"><a href="#">ON</a></li>
								   <?php } else {?>
									<li class="primer_int on"><a href="#">OFF</a></li>
									<li class="ultimo_int"><a href="<?php echo $new_location.'&id='.$rowdata['idUsuario'].'&estado=1' ; ?>">ON</a></li>
								   <?php }?>    
								</ul>
								<?php }?>  
							</div>     
