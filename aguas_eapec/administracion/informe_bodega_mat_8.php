...
$original = "informe_bodega_mat_8.php";
$location = $original;
...
<div class="col-lg-12">
	<div class="box">
		<header>
			...
			<h5>Listado de Movimientos de <?php echo $arrProductos[0]['NombreCliente'];?> </h5>
			<div class="toolbar">
				<?php
				$zz  = '?idSistema='.$arrUsuario['idSistema'];
				$zz .= '&idCliente='.$_GET['idCliente'];
				$zz .= '&Creacion_ano='.$_GET['Creacion_ano'];
				$zz .= '&Creacion_mes='.$_GET['Creacion_mes'];
				?>
				<a target="new" href="informe_bodega_mat_8_to_excel.php<?php echo $zz ?>" class="btn btn-sm btn-metis-2"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
				<a target="new" href="informe_bodega_mat_8_to_pdf.php<?php echo $zz ?>" class="btn btn-sm btn-metis-3"><i class="fa fa-file-pdf-o"></i> Exportar a PDF</a>
				<a target="new" href="informe_bodega_mat_8_to_print.php<?php echo $zz ?>" class="btn btn-sm btn-metis-5"><i class="fa fa-print"></i> Imprimir</a>
			</div>
		</header>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1">
				...
				echo form_select('Cliente','idCliente', $x1, 2, 'idCliente', 'Nombre', 'clientes_listado', $z, $dbConn);
