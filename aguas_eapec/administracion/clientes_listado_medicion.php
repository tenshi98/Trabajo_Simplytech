...
$location = $original;
$new_location = "clientes_listado_medicion.php";
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	$location.='&id='.$_GET['id'];
	$form_obligatorios = 'idCliente,idSector,idPuntoMuestreo';
	$form_trabajo= 'update';
...
$query = "SELECT Nombre , idSector, idPuntoMuestreo, UTM_norte, UTM_este
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'clientes_listado_medicion.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos Mediciones</a></li>
			</ul>	
		</header>
        <div class="table-responsive">
			<div class="col-lg-6 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post"  name="form1">		
					...
					echo form_select('Sector','idSector', $x1, 2, 'idSector', 'Nombre', 'analisis_sectores', $z, $dbConn);
					echo form_select('Tipo de Medicion','idPuntoMuestreo', $x2, 2, 'idPuntoMuestreo', 'Nombre', 'analisis_aguas_tipo_punto_muestreo', 0, $dbConn);
					echo form_input('text', 'UTM Norte', 'UTM_norte', $x3, 1);
					echo form_input('text', 'UTM Este', 'UTM_este', $x4, 1);
					?>
