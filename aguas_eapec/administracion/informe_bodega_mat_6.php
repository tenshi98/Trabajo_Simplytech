...
$original = "informe_bodega_mat_6.php";
$location = $original;
...
WHERE bodegas_facturacion.idProveedor={$_GET['idProveedor']}  
...
<div class="col-lg-12">
	<div class="box">
		<header>
			...
			<h5>Listado de Movimientos de <?php echo $arrProductos[0]['NombreProveedor'];?> </h5>
			<div class="toolbar">
				<?php
				$zz  = '?idSistema='.$arrUsuario['idSistema'];
				$zz .= '&idProveedor='.$_GET['idProveedor'];
				$zz .= '&Creacion_ano='.$_GET['Creacion_ano'];
				$zz .= '&Creacion_mes='.$_GET['Creacion_mes'];
				?>
				<a target="new" href="informe_bodega_mat_6_to_excel.php<?php echo $zz ?>" class="btn btn-sm btn-metis-2"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
				<a target="new" href="informe_bodega_mat_6_to_pdf.php<?php echo $zz ?>" class="btn btn-sm btn-metis-3"><i class="fa fa-file-pdf-o"></i> Exportar a PDF</a>
				<a target="new" href="informe_bodega_mat_6_to_print.php<?php echo $zz ?>" class="btn btn-sm btn-metis-5"><i class="fa fa-print"></i> Imprimir</a>
			</div>
		</header>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1">
				...
				echo form_select_filter('Provedor','idProveedor', $x1, 2, 'idProveedor', 'Nombre', 'proveedor_listado', $z, $dbConn);
				echo form_select_n_auto('Año','Creacion_ano', $x2, 2, 2015, 2030);
				echo form_select('Mes','Creacion_mes', $x3, 2, 'idMes', 'Nombre', 'mnt_meses', 0, $dbConn);
