...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de la Bodega</h5>
		</header>
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			<div class="form-group">
            	<input type="hidden" name="idBodega" value="<?php echo $_GET['id']; ?>" >
...
$query = "SELECT idBodega FROM `bodegas_listado` ".$z."";
...
<label class="control-label col-lg-4">Buscar Bodega</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" >Crear Nueva Bodega</a><?php } ?>
</div>
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group widthtd120" >
								<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$tipo['idBodega']; ?>" data-placement="bottom" title="Editar Informacion" data-toggle="tooltip" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-pencil-square-o"></i></a><?php } ?>
