...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'Nombre,Fono,idSistema,idUsuario';
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/agenda_telefonica.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idAgenda,Nombre,Fono,idSistema,idUsuario';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/agenda_telefonica.php';
}
//se borra un dato
...
<?php require_once 'core/header.php';?>
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            <h3><i class="fa fa-phone"></i> Agenda Telefonica</h3>
          </div>
        </header>
      </div>
      <div id="left">
...
$query = "SELECT Nombre, Fono, idSistema
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			echo form_input_phone('Telefono', 'Fono', $x2, 2);
			...
			<div class="form-group">
            	<input type="hidden" name="idAgenda" value="<?php echo $_GET['id']; ?>" >
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE agenda_telefonica.idSistema>=0";	
}else{
	$z="WHERE agenda_telefonica.idSistema={$arrUsuario['idSistema']}";	
}
//Verifico si la variable de busqueda existe
if (isset($_GET['search']) && $_GET['search'] != ''){      
	$z .=" AND agenda_telefonica.Nombre LIKE '%{$_GET['search']}%'";
}
//filtro si el documento lo creo el usuario o el sistema
$z .=" AND agenda_telefonica.idUsuario = '{$arrUsuario['idUsuario']}' ";
$z .=" OR agenda_telefonica.idUsuario = '9999' ";
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idAgenda FROM `agenda_telefonica` ".$z."";
...
$arrContactos = array();
$query = "SELECT 
agenda_telefonica.idAgenda,
agenda_telefonica.Nombre,
agenda_telefonica.Fono,
agenda_telefonica.idUsuario,
core_sistemas.Nombre AS Sistema
FROM `agenda_telefonica`
LEFT JOIN `core_sistemas` ON core_sistemas.idSistema = agenda_telefonica.idSistema
".$z."
ORDER BY Nombre ASC
...
<label class="control-label col-lg-4">Buscar Nombre</label>
    <div class="col-lg-5">
...
<a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" >Crear Nuevo Contacto</a>
</div>
						...
						<td>
							<div class="btn-group widthtd120" >
								<?php if($cont['idUsuario']!=9999){?>
									<a href="<?php echo $location.'&id='.$cont['idAgenda']; ?>" data-placement="bottom" title="Editar Informacion" data-toggle="tooltip" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-pencil-square-o"></i></a>
								<?php 
