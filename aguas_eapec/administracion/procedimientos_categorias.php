...
$original = "procedimientos_categorias.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/procedimientos_categorias.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idCategoria,Nombre';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/procedimientos_categorias.php';
}
//se borra un dato
...
FROM `procedimientos_categorias`
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE procedimientos_categorias.idSistema>=0";	
}else{
	$z="WHERE procedimientos_categorias.idSistema={$arrUsuario['idSistema']}";	
}
//Verifico si la variable de busqueda existe
if (isset($_GET['search']) && $_GET['search'] != ''){      
	$z .=" AND procedimientos_categorias.Nombre LIKE '%{$_GET['search']}%'";
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT procedimientos_categorias.idCategoria FROM `procedimientos_categorias` ".$z."";
...
$arrCategorias = array();
$query = "SELECT 
procedimientos_categorias.idCategoria,
procedimientos_categorias.Nombre,
core_sistemas.Nombre AS Sistema
FROM `procedimientos_categorias`
LEFT JOIN `core_sistemas` ON core_sistemas.idSistema = procedimientos_categorias.idSistema
".$z."
ORDER BY procedimientos_categorias.Nombre ASC
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" >Crear Nueva Categoria</a><?php } ?>
</div>
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				...
				<?php foreach ($arrCategorias as $cat) { ?>
					<tr class="odd">
						...
						<td><?php echo $cat['Sistema']; ?></td>
						<td>
							<div class="btn-group widthtd120" >
								<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$cat['idCategoria']; ?>" data-placement="bottom" title="Editar Informacion" data-toggle="tooltip" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-pencil-square-o"></i></a><?php } ?>
