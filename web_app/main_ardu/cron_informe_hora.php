...
$Tittle_Body_Mail = 'Alertas Informe Hora';
...
$SubAlert_NC_AlertasCatastrofica     = $Global_inf_hora_SA_NC_AlertasCatastrofica;     //Alertas Catastroficas
$SubAlert_NC_AlertasNormales         = $Global_inf_hora_SA_NC_AlertasNormales;         //Alertas Normales
$SubAlert_NC_ExcesoVelocidad         = $Global_inf_hora_SA_NC_ExcesoVelocidad;         //Exceso Limite Velocidad
$SubAlert_NC_FueraGeocerca           = $Global_inf_hora_SA_NC_FueraGeocerca;           //Equipo Fuera de Geocerca
$SubAlert_NC_FueraLinea              = $Global_inf_hora_SA_NC_FueraLinea;              //Fuera de Linea
$SubAlert_NC_FueraLineaActual        = $Global_inf_hora_SA_NC_FueraLineaActual;        //Fuera de Linea Actual
$SubAlert_NW_AlertasCatastrofica     = $Global_inf_hora_SA_NW_AlertasCatastrofica;     //Alertas Catastroficas
$SubAlert_NW_AlertasNormales         = $Global_inf_hora_SA_NW_AlertasPersonalizadas;   //Alertas Normales
$SubAlert_NW_ExcesoVelocidad         = $Global_inf_hora_SA_NW_ExcesoVelocidad;         //Exceso Limite Velocidad
$SubAlert_NW_FueraGeocerca           = $Global_inf_hora_SA_NW_FueraGeocerca;           //Equipo Fuera de Geocerca
$SubAlert_NW_FueraLinea              = $Global_inf_hora_SA_NW_FueraLinea;              //Fuera de Linea
$SubAlert_NW_FueraLineaActual        = $Global_inf_hora_SA_NW_FueraLineaActual;        //Fuera de Linea Actual
$TextFile_User                       = $Global_inf_hora_TextFile_User;                 //Archivo a escribir
