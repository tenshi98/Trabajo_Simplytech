...
$location = $original;
$new_location = "admin_datos_datos_oc.php";
...
if (isset($_GET['created'])){ $error['created'] = 'sucess/Aprobador Creado correctamente';}
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Aprobador Modificado correctamente';}
if (isset($_GET['deleted'])){ $error['deleted'] = 'sucess/Aprobador Borrado correctamente';}
...
$SIS_join  = 'LEFT JOIN `usuarios_listado` ON usuarios_listado.idUsuario = sistema_aprobador_oc.idUsuario';
$SIS_where = 'sistema_aprobador_oc.idSistema = '.$_SESSION['usuario']['basic_data']['idSistema'];
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if(isset($Count_OC)&&$Count_OC!=0){ ?>
							<li class="active"><a href="<?php echo 'admin_datos_datos_oc.php'; ?>" ><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Aprobador OC</a></li>
						<?php } ?>
