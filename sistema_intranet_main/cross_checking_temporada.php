...
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){      $SIS_where .= " AND cross_checking_temporada.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['Codigo']) && $_GET['Codigo'] != ''){      $SIS_where .= " AND cross_checking_temporada.Codigo LIKE '%".$_GET['Codigo']."%'";}
