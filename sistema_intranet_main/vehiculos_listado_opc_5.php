		...
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
					...
					$Form_Imputs->form_select_filter('Pasajeros Disponibles','idHijos', $x1, 2, 'idHijos', 'Rut,Nombre,ApellidoPat,ApellidoMat', 'apoderados_listado_hijos', 'idVehiculo=0', '', $dbConn);
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Pasajeros</span>
			</div>
		</div>
	</div>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						if(isset($rowdata['idOpciones_5'])&&$rowdata['idOpciones_5']==1){ ?>
							<li class="active"><a href="<?php echo 'vehiculos_listado_opc_5.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Pasajeros</a></li>
						<?php }
						...
						<td>
							<div class="btn-group" style="width: 35px;" >
								<?php if ($rowlevel['level']>=4){
									$ubicacion = $new_location.'&id='.$_GET['id'].'&del_pasajero='.$carga['idHijos'];
