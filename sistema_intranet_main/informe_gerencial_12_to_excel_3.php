...
//sololas del mismo sistema
$SIS_where_1.=" GROUP BY bodegas_arriendos_facturacion.idCliente, bodegas_arriendos_facturacion.Creacion_fecha";
$SIS_where_2.=" GROUP BY bodegas_insumos_facturacion.idCliente, bodegas_insumos_facturacion.Creacion_fecha";
$SIS_where_3.=" GROUP BY bodegas_productos_facturacion.idCliente, bodegas_productos_facturacion.Creacion_fecha";
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Ventas Clientes Por dia');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Ventas Clientes Por dia';
