...
//Si no se slecciono se traen todos los equipos a los cuales tiene permiso
	...
	foreach ($arrEquipos as $equipo) {
		...
		$row_data = db_select_data (false, $SIS_query, 'backup_telemetria_listado_tablarelacionada_'.$_GET['idTelemetria'], '', $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'row_data');
