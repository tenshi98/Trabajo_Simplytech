...
$original = "cross_shipping_consolidacion_aprobadas.php";
$location = $original;
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'instructivo_asc':   $order_by = 'ORDER BY cross_shipping_instructivo.Nombre ASC ';                                      $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> N° Instructivo Ascendente';break;
		case 'instructivo_desc':  $order_by = 'ORDER BY cross_shipping_instructivo.Nombre DESC ';                                     $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> N° Instructivo Descendente';break;
...
$z.=" AND cross_shipping_consolidacion.idEstado=2";
...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table" aria-hidden="true"></i></div><h5>Consolidaciones Aprobadas</h5>
			<div class="toolbar">
				<?php 
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				<thead>
					<tr role="row">
						...
						<th>
							<div class="pull-left">N° Instructivo</div>
							<div class="btn-group pull-right" style="width: 50px;" >
								<a href="<?php echo $location.'&order_by=instructivo_asc'; ?>" title="Ascendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>
								<a href="<?php echo $location.'&order_by=instructivo_desc'; ?>" title="Descendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-desc" aria-hidden="true"></i></a>
							</div>
						</th>
						<th>
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					...
					<tr class="odd">
						...
						<td><?php echo $tipo['InstructivoNombre']; ?></td>
