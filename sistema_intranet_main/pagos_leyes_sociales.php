...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Pago Modificado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Pago borrado correctamente';}
				...
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
					<?php if($AFP_Total_deuda>0){ ?>
						<div class="col-sm-12 breadcrumb-bar" style="margin-bottom:10px;">
							<p class="fleft" style="margin-top: 0px;margin-bottom: 0px;">AFP a Pagar <strong><?php echo valores($AFP_Total_deuda, 0);?></strong></p>
							<a onclick="pago_afp_add();"  class="btn btn-default fright margin_width" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> Agregar Pago</a>
						</div>
					...
					<?php if($SALUD_Total_deuda>0){ ?>
						<div class="col-sm-12 breadcrumb-bar" style="margin-bottom:10px;">
							<p class="fleft" style="margin-top: 0px;margin-bottom: 0px;">Salud a Pagar <strong><?php echo valores($SALUD_Total_deuda, 0);?></strong></p>
							<a onclick="pago_salud_add();"  class="btn btn-default fright margin_width" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> Agregar Pago</a>
						</div>
						<div class="clearfix"></div> 
					...
					<?php if($SEGURIDAD_Total_deuda>0){ ?>
						<div class="col-sm-12 breadcrumb-bar" style="margin-bottom:10px;">
							<p class="fleft" style="margin-top: 0px;margin-bottom: 0px;">Seguridad a Pagar <strong><?php echo valores($SEGURIDAD_Total_deuda, 0);?></strong></p>
							<a onclick="pago_seguridad_add();"  class="btn btn-default fright margin_width" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> Agregar Pago</a>
						</div>
						<div class="clearfix"></div> 
			...
			<div id="div-1" class="body">
				...
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
					<?php if($_SESSION['pagos_leyes_sociales_basicos']['AFP_MontoPago']!=0){ ?>
						<div class="col-sm-12 breadcrumb-bar" style="margin-bottom:10px;">
							<p class="fleft" style="margin-top: 0px;margin-bottom: 0px;">AFP a Pagar <strong><?php echo valores($_SESSION['pagos_leyes_sociales_basicos']['AFP_MontoPago'], 0);?></strong></p>
							<a onclick="pago_afp_add();"  class="btn btn-default fright margin_width" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> Agregar Pago</a>
						</div>
						<div class="clearfix"></div> 
						<div id="insert_pago_afp"></div>
					...
					<?php if($_SESSION['pagos_leyes_sociales_basicos']['SALUD_MontoPago']!=0){ ?>
						<div class="col-sm-12 breadcrumb-bar" style="margin-bottom:10px;">
							<p class="fleft" style="margin-top: 0px;margin-bottom: 0px;">Salud a Pagar <strong><?php echo valores($_SESSION['pagos_leyes_sociales_basicos']['SALUD_MontoPago'], 0);?></strong></p>
							<a onclick="pago_salud_add();"  class="btn btn-default fright margin_width" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> Agregar Pago</a>
						</div>
						<div class="clearfix"></div> 
						<div id="insert_pago_salud"></div>
					...
					<?php if($_SESSION['pagos_leyes_sociales_basicos']['SEGURIDAD_MontoPago']!=0){ ?>
						<div class="col-sm-12 breadcrumb-bar" style="margin-bottom:10px;">
							<p class="fleft" style="margin-top: 0px;margin-bottom: 0px;">Seguridad a Pagar <strong><?php echo valores($_SESSION['pagos_leyes_sociales_basicos']['SEGURIDAD_MontoPago'], 0);?></strong></p>
							<a onclick="pago_seguridad_add();"  class="btn btn-default fright margin_width" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> Agregar Pago</a>
						</div>
						<div class="clearfix"></div> 
						<div id="insert_pago_seguridad"></div>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_select_filter('Periodo Mes','Periodo_Mes', $x2, 2, 'idMes', 'Nombre', 'core_tiempo_meses', 0, 'ORDER BY idMes ASC', $dbConn);
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'periodo_ano_asc':    $order_by = 'ORDER BY pagos_leyes_sociales.Periodo_Ano ASC ';    $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Año Ascendente';break;
		case 'periodo_ano_desc':   $order_by = 'ORDER BY pagos_leyes_sociales.Periodo_Ano DESC ';   $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Año Descendente';break;
		case 'periodo_mes_asc':    $order_by = 'ORDER BY pagos_leyes_sociales.Periodo_Mes ASC ';    $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Mes Ascendente';break;
		case 'periodo_mes_desc':   $order_by = 'ORDER BY pagos_leyes_sociales.Periodo_Mes DESC ';   $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Mes Descendente';break;
		case 'fecha_pago_asc':     $order_by = 'ORDER BY pagos_leyes_sociales.Pago_fecha ASC ';     $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha de Pago Ascendente';break;
		case 'fecha_pago_desc':    $order_by = 'ORDER BY pagos_leyes_sociales.Pago_fecha DESC ';    $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha de Pago Descendente';break;
		...
		default: $order_by = 'ORDER BY pagos_leyes_sociales.idEstadoPago ASC, pagos_leyes_sociales.Pago_fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Estado de Pago Ascendente, Fecha de Pago Descendente';
	}
}else{
	$order_by = 'ORDER BY pagos_leyes_sociales.idEstadoPago ASC, pagos_leyes_sociales.Pago_fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Estado de Pago Ascendente, Fecha de Pago Descendente';
}
/**********************************************************/
//Variable con la ubicacion
$z="WHERE pagos_leyes_sociales.idFactSocial!=0";
//Verifico el tipo de usuario que esta ingresando
$z.=" AND pagos_leyes_sociales.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];	

/**********************************************************/
//Se aplican los filtros
if(isset($_GET['Periodo_Ano']) && $_GET['Periodo_Ano'] != ''){  $z .= " AND pagos_leyes_sociales.Periodo_Ano='".$_GET['Periodo_Ano']."'";}
if(isset($_GET['Pago_fecha']) && $_GET['Periodo_Mes'] != ''){   $z .= " AND pagos_leyes_sociales.Periodo_Mes='".$_GET['Periodo_Mes']."'";}
if(isset($_GET['Pago_fecha']) && $_GET['Pago_fecha'] != ''){    $z .= " AND pagos_leyes_sociales.Pago_fecha='".$_GET['Pago_fecha']."'";}
if(isset($_GET['idUsuario']) && $_GET['idUsuario'] != ''){      $z .= " AND pagos_leyes_sociales.idUsuario=".$_GET['idUsuario'];}
/**********************************************************/
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idFactSocial FROM `pagos_leyes_sociales` ".$z;
//Consulta
