	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['servicios_egr_nd_productos'][$_GET['editProd']]['ValorIngreso']));
				$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x4, 2);
				$Form_Inputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['servicios_egr_nd_productos'][$_GET['editProd']]['ValorIngreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['servicios_egr_nd_otros'][$_GET['editOtros']]['idOtros'], 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idUsoIVA)) {           $x5  = $idUsoIVA;         }else{$x5  = $_SESSION['servicios_egr_nd_basicos']['idUsoIVA'];}
...
<div class="col-sm-12">
		...
		<div id="customer">
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<?php if(isset($_SESSION['servicios_egr_nd_basicos']['idUsoIVA'])&&$_SESSION['servicios_egr_nd_basicos']['idUsoIVA']==1){ ?>
						<tr>
    ...
    <div class="row">
		<div class="col-xs-12">
			...
			<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['servicios_egr_nd_basicos']['Observaciones'];?></p>
		</div>
	</div>
...
$SIS_where = "bodegas_servicios_facturacion.idTipo=12";//Solo ingresos
