				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						if(isset($rowdata['idOpciones_3'])&&$rowdata['idOpciones_3']==1){ ?>
							<li class="active"><a href="<?php echo 'vehiculos_listado_opc_3.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Ruta</a></li>
						<?php }
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_select('Ruta','idRuta', $x1, 2, 'idRuta', 'Nombre', 'vehiculos_rutas', 0, '', $dbConn);
