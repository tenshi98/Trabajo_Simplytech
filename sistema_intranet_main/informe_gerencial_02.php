...
<div class="col-sm-12">
	<div class="box">
		<header>
			...
			<div class="toolbar">
				<a target="new" href="<?php echo 'informe_gerencial_02_to_excel_4.php?d=d'.$search  ?>" class="btn btn-xs btn-metis-2 btn-line cboxElement"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
			</div>
		</header>
...
<div class="col-sm-12">
	<div class="box">
		<header>
			...
			<div class="toolbar">
				<a target="new" href="<?php echo 'informe_gerencial_02_to_excel_3.php?d=d'.$search  ?>" class="btn btn-xs btn-metis-2 btn-line cboxElement"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
			</div>
		</header>
		<div class="table-responsive"> 
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
...
<div class="col-sm-12">
	<div class="box">
		<header>
			...
			<div class="toolbar">
				<a target="new" href="<?php echo 'informe_gerencial_02_to_excel_2.php?d=d'.$search  ?>" class="btn btn-xs btn-metis-2 btn-line cboxElement"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
			</div>
		</header>
		<div class="table-responsive"> 
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
...
<div class="col-sm-12">
	<div class="box">
		<header>
			...
			<div class="toolbar">
				<a target="new" href="<?php echo 'informe_gerencial_02_to_excel_1.php?d=d'.$search  ?>" class="btn btn-xs btn-metis-2 btn-line cboxElement"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
			</div>
		</header>
		<div class="table-responsive"> 
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 105px;" >
									<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&details_mensual='.$prod['idTrabajador']; ?>" title="Ver detalle Mensual" class="btn btn-primary btn-sm tooltip"><i class="fa fa-list"></i></a><?php } ?>
									<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&details_semanal='.$prod['idTrabajador']; ?>" title="Ver detalle Semanal" class="btn btn-primary btn-sm tooltip"><i class="fa fa-list"></i></a><?php } ?>
									<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&details_diario='.$prod['idTrabajador']; ?>" title="Ver detalle Diario" class="btn btn-primary btn-sm tooltip"><i class="fa fa-list"></i></a><?php } ?>
								</div>
							</td>
						</tr>
					<?php } ?>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Imputs->form_select_filter('Vendedor','idTrabajador', $x1, 1, 'idTrabajador', 'Rut,Nombre,ApellidoPat,ApellidoMat', 'trabajadores_listado', $z, '', $dbConn);
