...
if(!empty($_GET['detalle'])){
	...
	$SIS_where = 'principal_notificaciones_ver.idNotificaciones ='.$_GET['detalle'];
	$SIS_order = 0;
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_order = 'usuarios_listado.idUsuario ASC';
	$arrNotificaciones = array();
	...
	<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
		<div class="box">
			<header>
				...
				<h5>Crear Notificación para <?php echo $total_usr ?> usuarios</h5>
			</header>
			<div class="body">
