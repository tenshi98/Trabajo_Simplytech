...
$location = $original;
$new_location = "sistema_listado_datos_cross.php";
...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Aprobador editado correctamente';}
...
WHERE sistema_aprobador_cross.idSistema = {$_GET['id']}
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if(isset($Count_Shipping)&&$Count_Shipping!=0){?>
							<li class="active"><a href="<?php echo 'sistema_listado_datos_cross.php?pagina='.$_GET['pagina'].'&id='.$_GET['id'];?>" >Aprobador Cross Shipping</a></li>
