...
WHERE comunicaciones_screen_listado.idScreen = ".$_GET['id'];
//Consulta
...
$query = "SELECT 
usuarios_listado.Nombre AS Usuario
FROM `comunicaciones_screen_listado_usuarios`
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario   = comunicaciones_screen_listado_usuarios.idUsuario

WHERE comunicaciones_screen_listado_usuarios.idScreen = ".$_GET['id']."
...
$z = "WHERE comunicaciones_screen_listado.idEstado!=0";
//Verifico el tipo de usuario que esta ingresando
$z.=" AND comunicaciones_screen_listado.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){ $z .= " AND comunicaciones_screen_listado.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
if(isset($_GET['Fecha']) && $_GET['Fecha']!=''){   $z .= " AND comunicaciones_screen_listado.Fecha='".$_GET['Fecha']."'";}
if(isset($_GET['idEstado']) && $_GET['idEstado']!=''){    $z .= " AND comunicaciones_screen_listado.idEstado='".$_GET['idEstado']."'";}
if(isset($_GET['idTipo']) && $_GET['idTipo']!=''){ $z .= " AND comunicaciones_screen_listado.idTipo='".$_GET['idTipo']."'";}
if(isset($_GET['idUsuario']) && $_GET['idUsuario']!=''){  $z .= " AND comunicaciones_screen_listado.idUsuario='".$_GET['idUsuario']."'";}
/**********************************************************/
...
".$z."
ORDER BY comunicaciones_screen_listado.idEstado ASC, comunicaciones_screen_listado.Fecha ASC
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
while ( $row = mysqli_fetch_assoc ($resultado)){
array_push( $arrScreenSharing,$row );
}
//Verifico el tipo de usuario que esta ingresando
