...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Insumo editado correctamente';}
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'insumos_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos Basicos</a></li>
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_select_filter('Unidad de Medida','idUml', $x3, 2, 'idUml', 'Nombre', 'sistema_productos_uml', 0, '', $dbConn);
					$Form_Imputs->form_input_text( 'Marca', 'Marca', $x4, 2);
					$Form_Imputs->form_input_text( 'Codigo', 'Codigo', $x5, 1);
