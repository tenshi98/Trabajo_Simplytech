	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_disabled('Valor Unitario','Unitario', Cantidades_decimales_justos($_SESSION['productos_traspasomanualempresa_productos'][$_GET['editProd']]['ValorEgreso']), 1);
				$Form_Imputs->form_input_hidden('ValorEgreso', Cantidades_decimales_justos($_SESSION['productos_traspasomanualempresa_productos'][$_GET['editProd']]['ValorEgreso']), 2);
	...
	<div id="page-wrap">
		...
		<table id="items">
			<tbody>
				...
				<tr>
					<?php if(isset($_SESSION['productos_traspasomanualempresa_basicos']['Observaciones'])&&$_SESSION['productos_traspasomanualempresa_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['productos_traspasomanualempresa_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['productos_traspasomanualempresa_temporal'])&&$_SESSION['productos_traspasomanualempresa_temporal']!=''){
								$non = $_SESSION['productos_traspasomanualempresa_temporal'];
							}	
