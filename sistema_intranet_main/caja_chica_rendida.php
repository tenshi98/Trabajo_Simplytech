	...
	<div class="box dark">
		...
		<div class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
				...
				if(isset($Observaciones)){    $x4 = $Observaciones;   }else{$x4 = $_SESSION['caja_rendida_basicos']['Observaciones'];}
				if(isset($idSolicitado)){     $x5 = $idSolicitado;    }else{$x5 = $_SESSION['caja_rendida_basicos']['idSolicitado'];}
				if(isset($idRevisado)){       $x6 = $idRevisado;      }else{$x6 = $_SESSION['caja_rendida_basicos']['idRevisado'];}
				if(isset($idAprobado)){       $x7 = $idAprobado;      }else{$x7 = $_SESSION['caja_rendida_basicos']['idAprobado'];}
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="col-xs-12">
		<div class="row">
			...
			<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['caja_rendida_basicos']['Observaciones']; ?></p>
		</div>
	</div>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb-bar">
	...
	<?php }else{ ?>
		<a href="<?php echo $location; ?>&new=true" class="btn btn-default pull-right margin_width" ><i class="fa fa-file-o" aria-hidden="true"></i> Ingresar Nueva Caja Rendida</a>
	<?php }
	 } ?>
</div>
<div class="clearfix"></div>
		...
		<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" autocomplete="off" novalidate>
				...
				if($_SESSION['usuario']['basic_data']['idTipoUsuario']==1){
					...
					$Form_Inputs->form_select_join_filter('Caja Chica','idCajaChica', $x1, 1, 'idCajaChica', 'Nombre', 'caja_chica_listado', 'usuarios_cajas_chicas', $y, $dbConn);
				}
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table" aria-hidden="true"></i></div><h5>Listado de Cajas Rendidas</h5>
			<div class="toolbar">
				<?php
