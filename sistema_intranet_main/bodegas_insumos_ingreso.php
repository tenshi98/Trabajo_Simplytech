		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['insumos_ing_descuentos'][$_GET['editDescuentos']]['idDescuento'], 2);
					?>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = 'insumos_listado.idProducto='.$_SESSION['insumos_ing_productos'][$_GET['editProd']]['idProducto'];
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['insumos_ing_productos'][$_GET['editProd']]['ValorIngreso']));
					$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x3, 2);
					$Form_Inputs->form_input_hidden('ValorIngreso', Cantidades_decimales_justos($_SESSION['insumos_ing_productos'][$_GET['editProd']]['ValorIngreso']), 2);
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($fecha_fact_desde)){   $x5  = $fecha_fact_desde; }else{$x5  = $_SESSION['insumos_ing_basicos']['fecha_fact_desde'];}
					if(isset($fecha_fact_hasta)){   $x6  = $fecha_fact_hasta; }else{$x6  = $_SESSION['insumos_ing_basicos']['fecha_fact_hasta'];}
					if(isset($idBodega)){           $x7  = $idBodega;         }else{$x7  = $_SESSION['insumos_ing_basicos']['idBodega'];}
					if(isset($Observaciones)){      $x8  = $Observaciones;    }else{$x8  = $_SESSION['insumos_ing_basicos']['Observaciones'];}
					if(isset($idUsoIVA)){           $x9  = $idUsoIVA;         }else{$x9  = $_SESSION['insumos_ing_basicos']['idUsoIVA'];}
					...
					$Form_Inputs->form_select_join_filter('Bodega destino','idBodega', $x7, 2, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $z, $dbConn);
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div id="customer">
				...
				<table id="meta" class="pull-left otdata">
					<tbody>
						...
						<?php if(isset($_SESSION['insumos_ing_basicos']['idUsoIVA'])&&$_SESSION['insumos_ing_basicos']['idUsoIVA']==1){ ?>
							<tr>
		...
		<div class="col-xs-12">
			<div class="row">
				...
				<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['insumos_ing_basicos']['Observaciones']; ?></p>
			</div>
		</div>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$rowData = db_select_data (false, $SIS_query, 'bodegas_insumos_facturacion', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
		switch ($_GET['order_by']) {
			...
			case 'documento_asc':    $order_by = 'core_documentos_mercantiles.Nombre ASC ';          $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Tipo Documento Ascendente';break;
			case 'documento_desc':   $order_by = 'core_documentos_mercantiles.Nombre DESC ';         $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Tipo Documento Descendente';break;
	...
	$SIS_where = "bodegas_insumos_facturacion.idTipo=1";//Solo ingresos
	...
	if(isset($_GET['idBodega']) && $_GET['idBodega']!=''){               $SIS_where .= " AND bodegas_insumos_facturacion.idBodegaDestino=".$_GET['idBodega'];}
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb-bar">
		...
		<?php if ($rowlevel['level']>=3){ ?>
			<?php if (isset($_SESSION['insumos_ing_basicos']['idProveedor'])&&$_SESSION['insumos_ing_basicos']['idProveedor']!=''){ ?>
				...
				<a href="<?php echo $location; ?>&view=true" class="btn btn-default pull-right margin_width" ><i class="fa fa-arrow-right" aria-hidden="true"></i> Continuar Compra</a>
			<?php }else{ ?>
				<a href="<?php echo $location; ?>&new=true" class="btn btn-default pull-right margin_width" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Compra</a>
			<?php } ?>
		<?php } ?>
	</div>
	<div class="clearfix"></div>
		...
		<div class="well">
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
				<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_select_join_filter('Bodega destino','idBodega', $x7, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $y, $dbConn);
					$Form_Inputs->form_textarea('Observaciones','Observaciones', $x8, 1);
					$Form_Inputs->form_post_data(1,1,1, 'Solo las empresas que no sean contribuyentes del Impuesto al Valor Agregado (IVA) y las que gocen de exención del IVA de conformidad a lo dispuesto en los Artículos 12 y 13 de la <a href="http://www.sii.cl/pagina/jurisprudencia/legislacion/basica/dl825.doc">Ley del IVA</a> pueden elegir la opción <strong>SI</strong>, para el resto es de uso obligatorio la opción <strong>NO</strong>. ');
