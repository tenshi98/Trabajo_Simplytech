...
$original = "bodegas_insumos_ingreso.php";
$location = $original;
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idOcompra)) {   $x1  = $idOcompra;    }else{$x1  = $_SESSION['insumos_ing_basicos']['idOcompra'];}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($Nombre)) {      $x1  = $Nombre;     }else{$x1  = $_SESSION['insumos_ing_descuentos'][$_GET['editDescuentos']]['Nombre'];}
				if(isset($vTotal)) {      $x2  = $vTotal;     }else{$x2  = $_SESSION['insumos_ing_descuentos'][$_GET['editDescuentos']]['vTotal'];}
				...
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['insumos_ing_descuentos'][$_GET['editDescuentos']]['idDescuento'], 2);
				?>
...
WHERE insumos_listado.idProducto='{$_SESSION['insumos_ing_productos'][$_GET['editProd']]['idProducto']}'
...
<div class="col-sm-8 fcenter">
	<div class="box dark">
		<header>
			<div class="icons"><i class="fa fa-edit"></i></div>
			<h5>Editar Compra de Insumos</h5>
		</header>
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idProducto)) {       $x1  = $idProducto;      }else{$x1  = $_SESSION['insumos_ing_productos'][$_GET['editProd']]['idProducto'];}
				if(isset($Number)) {           $x2  = $Number;          }else{$x2  = $_SESSION['insumos_ing_productos'][$_GET['editProd']]['Number'];}
				if(isset($ValorTotal)) {       $x3  = $ValorTotal;      }else{$x3  = $_SESSION['insumos_ing_productos'][$_GET['editProd']]['ValorTotal'];}
				...
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['insumos_ing_productos'][$_GET['editProd']]['ValorIngreso']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'ValorTotal', $x3, 2);
				$Form_Imputs->form_input_hidden('ValorIngreso', Cantidades_decimales_justos($_SESSION['insumos_ing_productos'][$_GET['editProd']]['ValorIngreso']), 2);
...
$z=" idDocumentos = 1 AND idEstado = 1 AND idProveedor = {$_SESSION['insumos_ing_basicos']['idProveedor']}";		 
?>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idCentroCosto)) {  $x1  = $idCentroCosto;  }else{$x1  = $_SESSION['insumos_ing_basicos']['idCentroCosto'];}
				if(isset($idLevel_1)) {      $x2  = $idLevel_1;      }else{$x2  = $_SESSION['insumos_ing_basicos']['idLevel_1'];}
				if(isset($idLevel_2)) {      $x3  = $idLevel_2;      }else{$x3  = $_SESSION['insumos_ing_basicos']['idLevel_2'];}
				if(isset($idLevel_3)) {      $x4  = $idLevel_3;      }else{$x4  = $_SESSION['insumos_ing_basicos']['idLevel_3'];}
				if(isset($idLevel_4)) {      $x5  = $idLevel_4;      }else{$x5  = $_SESSION['insumos_ing_basicos']['idLevel_4'];}
				if(isset($idLevel_5)) {      $x6  = $idLevel_5;      }else{$x6  = $_SESSION['insumos_ing_basicos']['idLevel_5'];}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idProveedor)) {      $x1  = $idProveedor;    }else{$x1  = $_SESSION['insumos_ing_basicos']['idProveedor'];}
				if(isset($idDocumentos)) {     $x2  = $idDocumentos;   }else{$x2  = $_SESSION['insumos_ing_basicos']['idDocumentos'];}
				if(isset($N_Doc)) {            $x3  = $N_Doc;          }else{$x3  = $_SESSION['insumos_ing_basicos']['N_Doc'];}
				if(isset($Creacion_fecha)) {   $x4  = $Creacion_fecha; }else{$x4  = $_SESSION['insumos_ing_basicos']['Creacion_fecha'];}
				if(isset($idBodega)) {         $x5  = $idBodega;       }else{$x5  = $_SESSION['insumos_ing_basicos']['idBodega'];}
				...
				$Form_Imputs->form_select_join_filter('Bodega destino','idBodega', $x5, 2, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $z, $dbConn);
...
<div class="col-sm-12 fcenter">
	...
	<div id="page-wrap">
		<div id="header"> <?php echo $_SESSION['insumos_ing_basicos']['TipoDocumento']; ?></div>
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $_SESSION['insumos_ing_basicos']['Proveedor']; ?></td>
					</tr>
					<tr>
						<td class="meta-head">Documento</td>
						<td><?php echo $_SESSION['insumos_ing_basicos']['Documento'].' N°'.$_SESSION['insumos_ing_basicos']['N_Doc']?></td>
					</tr>
					<tr>
						<td class="meta-head">Bodega Destino</td>
						<td><?php echo $_SESSION['insumos_ing_basicos']['Bodega']?></td>
					</tr>
					<tr>
					...
					<?php if(isset($_SESSION['insumos_ing_basicos']['idOcompra'])&&$_SESSION['insumos_ing_basicos']['idOcompra']!=''){ ?>
						<tr>
							<td class="meta-head">Orden de Compra</td>
							<td><?php echo $_SESSION['insumos_ing_basicos']['idOcompra']?></td>
						</tr>
					<?php } ?>
					<tr>
					...
					<tr>
						...
						<td><?php echo $_SESSION['insumos_ing_basicos']['CentroCosto']; ?></td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					...
					<?php if($_SESSION['insumos_ing_basicos']['idDocumentos']==2){?>
						<tr>
							...
							<?php if($_SESSION['insumos_ing_basicos']['Pago_fecha']!='0000-00-00'){?>
								<td><?php echo Fecha_estandar($_SESSION['insumos_ing_basicos']['Pago_fecha']);?></td>
								<td>
		...
		<table id="items">
			<tbody>
				...
				<tr class="item-row fact_tittle">
					<td colspan="5">Insumos a Comprar</td>
					<td>
						<?php if(isset($_SESSION['insumos_ing_basicos']['idOcompra'])&&$_SESSION['insumos_ing_basicos']['idOcompra']==''){ ?>
				...
				/*********************************************************/
				//Guardo el neto
				$_SESSION['insumos_ing_basicos']['valor_neto_fact'] = $vtotal_neto;
				?>
					...
					$_SESSION['insumos_ing_basicos']['valor_neto_imp'] = $vtotal_neto;
					?>
					<tr class="invoice-total" bgcolor="#f1f1f1">
					...
					if (isset($_SESSION['insumos_ing_impuestos'])){
						...
						$tempa = $vtotal_neto;
						//recorro el lsiatdo entregado por la base de datos
						foreach ($_SESSION['insumos_ing_impuestos'] as $key => $producto){
							...
							$_SESSION['insumos_ing_impuestos'][$producto['idImpuesto']]['valor'] = $vtotal_IVA;
					...
					//guardo el total
					$_SESSION['insumos_ing_basicos']['valor_total_fact'] = $vtotal_neto;
				?>
				...
				<tr>
					<?php if(isset($_SESSION['insumos_ing_basicos']['Observaciones'])&&$_SESSION['insumos_ing_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['insumos_ing_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
							<div class="btn-group" style="width: 35px;" >
								<?php 
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['insumos_ing_temporal'])&&$_SESSION['insumos_ing_temporal']!=''){
								$non = $_SESSION['insumos_ing_temporal'];
							}	
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'documento_asc':    $order_by = 'ORDER BY core_documentos_mercantiles.Nombre ASC ';          $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Tipo Documento Ascendente';break;
		case 'documento_desc':   $order_by = 'ORDER BY core_documentos_mercantiles.Nombre DESC ';         $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Tipo Documento Descendente';break;
...
//Verifico el tipo de usuario que esta ingresando
if($_SESSION['usuario']['basic_data']['idTipoUsuario']==1){
	$y="bodegas_insumos_listado.idSistema>=0";
	$w="idSistema>=0 AND idEstado=1";
}else{
	$y="bodegas_insumos_listado.idSistema={$_SESSION['usuario']['basic_data']['idSistema']} AND usuarios_bodegas_insumos.idUsuario = {$_SESSION['usuario']['basic_data']['idUsuario']}";		
	$w="idSistema={$_SESSION['usuario']['basic_data']['idSistema']} AND idEstado=1";
}
/**********************************************************/
//Variable con la ubicacion
$z="WHERE bodegas_insumos_facturacion.idTipo=1";//Solo ingresos
//Verifico el tipo de usuario que esta ingresando
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){ ?>
		<?php if (isset($_SESSION['insumos_ing_basicos']['idProveedor'])&&$_SESSION['insumos_ing_basicos']['idProveedor']!=''){?>
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Imputs->form_select_join_filter('Bodega destino','idBodega', $x5, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $y, $dbConn);
				$Form_Imputs->form_textarea('Observaciones','Observaciones', $x6, 1, 160);
...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Compras</h5>
			<div class="toolbar">
				<?php 
