...
$SIS_where_1 = "bodegas_arriendos_facturacion.idTipo=1"; //solo ventas
$SIS_where_2 = "bodegas_insumos_facturacion.idTipo=1";   //solo ventas
$SIS_where_3 = "bodegas_productos_facturacion.idTipo=1"; //solo ventas
$SIS_where_4 = "bodegas_servicios_facturacion.idTipo=1"; //solo ventas
...
if(isset($_GET['idProveedor'])&&$_GET['idProveedor']!=''){
	$SIS_where_1.=" AND bodegas_arriendos_facturacion.idProveedor=".$_GET['idProveedor'];
	$SIS_where_2.=" AND bodegas_insumos_facturacion.idProveedor=".$_GET['idProveedor'];
	$SIS_where_3.=" AND bodegas_productos_facturacion.idProveedor=".$_GET['idProveedor'];
	$SIS_where_4.=" AND bodegas_servicios_facturacion.idProveedor=".$_GET['idProveedor'];
}
if(isset($_GET['idEstado'])&&$_GET['idEstado']!=''){
	$SIS_where_1.=" AND bodegas_arriendos_facturacion.idEstado=".$_GET['idEstado'];
	$SIS_where_2.=" AND bodegas_insumos_facturacion.idEstado=".$_GET['idEstado'];
...
if(isset($_GET['f_inicio'], $_GET['f_termino'])&&$_GET['f_inicio']!=''&&$_GET['f_termino']!=''){
	...
	$SIS_where_4.=" AND bodegas_servicios_facturacion.Creacion_fecha BETWEEN '".$_GET['f_inicio']."' AND '".$_GET['f_termino']."'";
}
//sololas del mismo sistema
$SIS_where_1.=" GROUP BY bodegas_arriendos_facturacion.idProveedor, bodegas_arriendos_facturacion.Creacion_fecha";
$SIS_where_2.=" GROUP BY bodegas_insumos_facturacion.idProveedor, bodegas_insumos_facturacion.Creacion_fecha";
$SIS_where_3.=" GROUP BY bodegas_productos_facturacion.idProveedor, bodegas_productos_facturacion.Creacion_fecha";
$SIS_where_4.=" GROUP BY bodegas_servicios_facturacion.idProveedor, bodegas_servicios_facturacion.Creacion_fecha";
...
$SIS_join  = 'LEFT JOIN `proveedor_listado`    ON proveedor_listado.idProveedor   = bodegas_arriendos_facturacion.idProveedor';
$SIS_order = 'bodegas_arriendos_facturacion.Creacion_fecha DESC';
$arrTemporal_1 = array();
...
$SIS_join  = 'LEFT JOIN `proveedor_listado`    ON proveedor_listado.idProveedor   = bodegas_insumos_facturacion.idProveedor';
$SIS_order = 'bodegas_insumos_facturacion.Creacion_fecha DESC';
$arrTemporal_2 = array();
...
$SIS_join  = 'LEFT JOIN `proveedor_listado`    ON proveedor_listado.idProveedor   = bodegas_productos_facturacion.idProveedor';
$SIS_order = 'bodegas_productos_facturacion.Creacion_fecha DESC';
$arrTemporal_3 = array();
...
$SIS_join  = 'LEFT JOIN `proveedor_listado`    ON proveedor_listado.idProveedor   = bodegas_servicios_facturacion.idProveedor';
$SIS_order = 'bodegas_servicios_facturacion.Creacion_fecha DESC';
$arrTemporal_4 = array();
...
foreach ($arrCreativo as $datais) {
	$spreadsheet->setActiveSheetIndex(0)->setCellValue('A'.$nn, DeSanitizar($datais[0]['Proveedor']));
	$nn++;
	...
	foreach ($datais as $prod) {
		...
		if(isset($prod['Creacion_fecha'])&&$prod['Creacion_fecha']!='0000-00-00'){
			$spreadsheet->setActiveSheetIndex(0)
						->setCellValue('A'.$nn, '')
						->setCellValue('B'.$nn, Fecha_estandar($prod['Creacion_fecha']))
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Compras Proveedor Por dia');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Compras Proveedor Por dia';
