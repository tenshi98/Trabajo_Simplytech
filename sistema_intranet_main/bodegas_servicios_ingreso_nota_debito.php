	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_select_disabled('Servicios','idServicio_fake', $x1, 2, 'idServicio', 'Nombre', 'servicios_listado', 'idEstado=1', $dbConn);
				...
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['servicios_ing_nd_productos'][$_GET['editProd']]['ValorIngreso']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'ValorTotal', $x4, 2);
				$Form_Imputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['servicios_ing_nd_productos'][$_GET['editProd']]['ValorIngreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['servicios_ing_nd_otros'][$_GET['editOtros']]['idOtros'], 2);
	...
	<div id="page-wrap">
		...
		<table id="items">
			<tbody>
				...
				<tr>
					<?php if(isset($_SESSION['servicios_ing_nd_basicos']['Observaciones'])&&$_SESSION['servicios_ing_nd_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['servicios_ing_nd_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
							<div class="btn-group" style="width: 35px;" >
								<?php 
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['servicios_ing_nd_temporal'])&&$_SESSION['servicios_ing_nd_temporal']!=''){
								$non = $_SESSION['servicios_ing_nd_temporal'];
							}	
