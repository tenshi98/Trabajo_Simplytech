...
if(isset($_GET['N_Doc']) && $_GET['N_Doc'] != ''){                         
	$z .= " AND bodegas_productos_facturacion.N_Doc LIKE '%".$_GET['N_Doc']."%'";
}
...
if(isset($_GET['N_DocPago']) && $_GET['N_DocPago'] != ''){                 
	$z .= " AND bodegas_productos_facturacion.N_DocPago LIKE '%".$_GET['N_DocPago']."%'";
}
...
header('Content-Disposition: attachment;filename="Exportar Datos Bodega Productos.xls"');
