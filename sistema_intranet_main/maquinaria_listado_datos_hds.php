...
$location = $original;
$new_location = "maquinaria_listado_datos_hds.php";
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'maquinaria_listado_datos_hds.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-calendar-check-o" aria-hidden="true"></i> HDS</a></li>
			...
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php }else{ ?>
					...
					<form class="form-horizontal" method="post" id="form1" name="form1" enctype="multipart/form-data" autocomplete="off" novalidate>
						...
						$Form_Inputs->form_post_data(1,1,1, '<strong>Hoja de Seguridad: </strong>Esta Ficha de seguridad proporciona a los usuarios información relacionada con la protección de la salud y la seguridad en el lugar de trabajo');
