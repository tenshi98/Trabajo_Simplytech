...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Centro de Costo creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Centro de Costo editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Centro de Costo borrado correctamente';}
...
WHERE centrocosto_listado.idCentroCosto={$_GET['id']} ";
//Consulta
...
".$leftjoin."
WHERE centrocosto_listado_level_1.idCentroCosto={$_GET['id']}
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				<span class="info-box-text">Centro de Costo</span>
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="<?php echo 'centrocosto_listado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Resumen</a></li>
				<li class=""><a href="<?php echo 'centrocosto_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos Basicos</a></li>
				<li class=""><a href="<?php echo 'centrocosto_listado_estado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Estado</a></li>
				<li class="dropdown">
					<a href="#" data-toggle="dropdown">Ver mas <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li class=""><a href="<?php echo 'centrocosto_listado_itemizado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Itemizado</a></li>
					</ul>
                </li>           
			</ul>	
		</header>
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'nombre_asc':   $order_by = 'ORDER BY centrocosto_listado.Nombre ASC ';   $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';break;
		case 'nombre_desc':  $order_by = 'ORDER BY centrocosto_listado.Nombre DESC ';  $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Nombre Descendente';break;
		
		default: $order_by = 'ORDER BY centrocosto_listado.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';
	}
}else{
	$order_by = 'ORDER BY centrocosto_listado.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';
}
/**********************************************************/ 
//Variable de busqueda
$z = "WHERE centrocosto_listado.idCentroCosto!=0";
//Verifico el tipo de usuario que esta ingresando
$z.=" AND centrocosto_listado.idSistema={$_SESSION['usuario']['basic_data']['idSistema']}";	
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){   $z .= " AND centrocosto_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
/**********************************************************/ 
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idCentroCosto FROM `centrocosto_listado` ".$z;
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
FROM `centrocosto_listado`
LEFT JOIN `core_sistemas`    ON core_sistemas.idSistema   = centrocosto_listado.idSistema
".$z."
".$order_by;
//Consulta
$resultado = mysqli_query ($dbConn, $query);
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Centro de Costo</a><?php }?>
...
<div class="col-sm-12">
	<div class="box">	
		<header>		
			<div class="icons"><i class="fa fa-table"></i></div><h5>Centros de Costos</h5>	
			<div class="toolbar">
				<?php 
					...
					<tr class="odd">			
						...
						<td>
							<div class="btn-group" style="width: 105px;" >
								<?php if ($rowlevel['level']>=1){?><a href="<?php echo 'view_centro_costo.php?view='.$area['idCentroCosto']; ?>" title="Ver Informacion" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list"></i></a><?php } ?>
								<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$area['idCentroCosto']; ?>" title="Editar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a><?php } ?>
								<?php if ($rowlevel['level']>=4){
									$ubicacion = $location.'&del='.$area['idCentroCosto'];
