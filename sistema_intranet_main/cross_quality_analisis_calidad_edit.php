						...
						for ($i = 1; $i <= $_GET['cantPuntos']; $i++) {
							if($grupo['idGrupo']==$rowdata['PuntoidGrupo_'.$i]){
								...
								switch ($rowdata['PuntoidTipo_'.$i]) {
									//Medicion (Decimal) con parametros limitantes
									case 1:
										$Form_Imputs->form_input_number($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, $rowMuestras['Medida_'.$i], 2);
										break;
									//Medicion (Decimal) sin parametros limitantes
									case 2:
										$Form_Imputs->form_input_number($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, $rowMuestras['Medida_'.$i], 2);
									...
									//Medicion (Enteros) con parametros limitantes
									case 3:
										$Form_Imputs->form_input_number_integer($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, $rowMuestras['Medida_'.$i], 2);
										break;
									//Medicion (Enteros) sin parametros limitantes
									case 4:
										$Form_Imputs->form_input_number_integer($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, $rowMuestras['Medida_'.$i], 2);
									...
									//Fecha
									case 5:
										$Form_Imputs->form_date($rowdata['PuntoNombre_'.$i],'Medida_'.$i, $rowMuestras['Medida_'.$i], 2);
										break;
									//Hora
									case 6:
