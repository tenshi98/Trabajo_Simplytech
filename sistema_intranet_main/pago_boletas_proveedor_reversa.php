...
if(isset($_GET['idDocPago'])&&$_GET['idDocPago']!=''){
	$Docsubmit_filter .= ' AND pagos_boletas_proveedores.idDocPago='.$_GET['idDocPago'];
}
if(isset($_GET['N_DocPago'])&&$_GET['N_DocPago']!=''){
	$Docsubmit_filter .= ' AND pagos_boletas_proveedores.N_DocPago='.$_GET['N_DocPago'];
}
...
pagos_boletas_proveedores.idDocPago,
pagos_boletas_proveedores.idFacturacion,
pagos_boletas_proveedores.N_DocPago AS DocumentoPagoNumero,
pagos_boletas_proveedores.montoPactado AS DocumentoMontoPactado,
pagos_boletas_proveedores.MontoPagado AS DocumentoMontoPagado
...
LEFT JOIN `proveedor_listado` prov_2                ON prov_2.idProveedor                            = boleta_honorarios_facturacion.idProveedor
...
LEFT JOIN `sistema_documentos_pago`                 ON sistema_documentos_pago.idDocPago             = pagos_boletas_proveedores.idDocPago
