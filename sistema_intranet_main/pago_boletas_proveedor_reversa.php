...
/**********************************************************************************************/
//datos 
$filter   = 'WHERE pagos_boletas_empresas.idPago!=0';
if(isset($_GET['idDocPago'])&&$_GET['idDocPago']!=''){
	$filter .= ' AND pagos_boletas_empresas.idDocPago='.$_GET['idDocPago'];
}
if(isset($_GET['N_DocPago'])&&$_GET['N_DocPago']!=''){
	$filter .= ' AND pagos_boletas_empresas.N_DocPago='.$_GET['N_DocPago'];
}
