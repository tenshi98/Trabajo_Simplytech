...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B1', 'Stock Min')
            ->setCellValue('C1', 'Stock Actual')
            ->setCellValue('D1', 'Unidad de Medida');
...
header('Content-Disposition: attachment;filename="Stock Critico Bodega '.$arrProductos[0]['NombreBodega'].' al '.fecha_actual().'.xls"');
