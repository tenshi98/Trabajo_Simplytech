	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['arriendos_ing_nd_productos'][$_GET['editProd']]['ValorIngreso']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'ValorTotal', $x4, 2);
				$Form_Imputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['arriendos_ing_nd_productos'][$_GET['editProd']]['ValorIngreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['arriendos_ing_nd_otros'][$_GET['editOtros']]['idOtros'], 2);
...
WHERE idDocumentos = {$_SESSION['arriendos_ing_nd_basicos']['idDocumentos']}";
//Consulta
...
WHERE idTipo = {$_SESSION['arriendos_ing_nd_basicos']['idTipo']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
WHERE idProveedor = {$_SESSION['arriendos_ing_nd_basicos']['idProveedor']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
WHERE idBodega = {$_SESSION['arriendos_ing_nd_basicos']['idBodega']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
	...
	<div id="page-wrap">
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $rowDocumento['Nombre'].' N°'.$_SESSION['arriendos_ing_nd_basicos']['N_Doc']?></td>
					</tr>
					<tr>
		...
		<table id="items">
			<tbody>
				...
				<tr>
					<?php if(isset($_SESSION['arriendos_ing_nd_basicos']['Observaciones'])&&$_SESSION['arriendos_ing_nd_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['arriendos_ing_nd_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
							<div class="btn-group" style="width: 35px;" >
								<?php 
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['arriendos_ing_nd_temporal'])&&$_SESSION['arriendos_ing_nd_temporal']!=''){
								$non = $_SESSION['arriendos_ing_nd_temporal'];
							}	
...
$z="WHERE bodegas_arriendos_facturacion.idTipo=10";//Solo ingresos
//Verifico el tipo de usuario que esta ingresando
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Imputs->form_select_join_filter('Bodega destino','idBodega', $x4, 1, 'idBodega', 'Nombre', 'bodegas_arriendos_listado', 'usuarios_bodegas_arriendos', $y, $dbConn);
				$Form_Imputs->form_textarea('Observaciones','Observaciones', $x5, 1, 160);
