...
$original = "bodegas_arriendos_ingreso_nota_debito.php";
$location = $original;
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($idEquipo)){       $x1  = $idEquipo;      }else{$x1  = $_SESSION['arriendos_ing_nd_productos'][$_GET['editProd']]['idEquipo'];}
					if(isset($Cantidad_ing)){   $x2  = $Cantidad_ing;  }else{$x2  = Cantidades_decimales_justos($_SESSION['arriendos_ing_nd_productos'][$_GET['editProd']]['Cantidad_ing']);}
					if(isset($idFrecuencia)){   $x3  = $idFrecuencia;  }else{$x3  = $_SESSION['arriendos_ing_nd_productos'][$_GET['editProd']]['idFrecuencia'];}
					if(isset($ValorTotal)){     $x4  = $ValorTotal;    }else{$x4  = Cantidades_decimales_justos($_SESSION['arriendos_ing_nd_productos'][$_GET['editProd']]['ValorTotal']);}
					...
					$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['arriendos_ing_nd_productos'][$_GET['editProd']]['ValorIngreso']));
					$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x4, 2);
					$Form_Inputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['arriendos_ing_nd_productos'][$_GET['editProd']]['ValorIngreso']), 2);
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					<?php
					//Se verifican si existen los datos
					if(isset($Nombre)){  $x1  = $Nombre;  }else{$x1  = $_SESSION['arriendos_ing_nd_otros'][$_GET['editOtros']]['Nombre'];}
					if(isset($vTotal)){  $x2  = $vTotal;  }else{$x2  = Cantidades_decimales_justos($_SESSION['arriendos_ing_nd_otros'][$_GET['editOtros']]['vTotal']);}
					...
					$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['arriendos_ing_nd_otros'][$_GET['editOtros']]['idOtros'], 2);
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					<?php
					//Se verifican si existen los datos
					if(isset($idProveedor)){        $x1  = $idProveedor;      }else{$x1  = $_SESSION['arriendos_ing_nd_basicos']['idProveedor'];}
					if(isset($N_Doc)){              $x2  = $N_Doc;            }else{$x2  = $_SESSION['arriendos_ing_nd_basicos']['N_Doc'];}
					if(isset($Creacion_fecha)){     $x3  = $Creacion_fecha;   }else{$x3  = $_SESSION['arriendos_ing_nd_basicos']['Creacion_fecha'];}
					if(isset($idBodega)){           $x4  = $idBodega;         }else{$x4  = $_SESSION['arriendos_ing_nd_basicos']['idBodega'];}
					if(isset($Observaciones)){      $x5  = $Observaciones;    }else{$x5  = $_SESSION['arriendos_ing_nd_basicos']['Observaciones'];}
					...
					$Form_Inputs->form_select_join_filter('Bodega destino','idBodega', $x4, 2, 'idBodega', 'Nombre', 'bodegas_arriendos_listado', 'usuarios_bodegas_arriendos', $z, $dbConn);
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idDocumentos = '.$_SESSION['arriendos_ing_nd_basicos']['idDocumentos'];
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idTipo = '.$_SESSION['arriendos_ing_nd_basicos']['idTipo'];
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idProveedor = '.$_SESSION['arriendos_ing_nd_basicos']['idProveedor'];
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idBodega = '.$_SESSION['arriendos_ing_nd_basicos']['idBodega'];
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div id="page-wrap">
				...
				<table id="meta" class="pull-left otdata">
					<tbody>
						...
						<tr>
							...
							<td><?php echo $rowDocumento['Nombre'].' N°'.n_doc($_SESSION['arriendos_ing_nd_basicos']['N_Doc'], 8); ?></td>
						</tr>
						<tr>
			...
			<table id="items">
				<tbody>
					...
					<?php  //Guardo el neto
					$_SESSION['arriendos_ing_nd_basicos']['valor_neto_fact'] = $vtotal_neto;
					?>
						...
						$_SESSION['arriendos_ing_nd_basicos']['valor_neto_imp'] = $vtotal_neto;
						?>
						<tr class="invoice-total" bgcolor="#f1f1f1">
						...
						if (isset($_SESSION['arriendos_ing_nd_impuestos'])){
							...
							foreach ($arrImpuestos as $impto) {
								foreach ($_SESSION['arriendos_ing_nd_impuestos'] as $key => $producto){
						...
						//guardo el total
						$_SESSION['arriendos_ing_nd_basicos']['valor_total_fact'] = $vtotal_neto; ?>
						<tr class="invoice-total" bgcolor="#f1f1f1">
		...
		<div class="col-xs-12">
			<div class="row">
				...
				<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['arriendos_ing_nd_basicos']['Observaciones']; ?></p>
			</div>
		</div>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = "bodegas_arriendos_facturacion.idTipo=10";//Solo ingresos
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb-bar">
		...
		<?php if ($rowlevel['level']>=3){ ?>
			<?php if (isset($_SESSION['arriendos_ing_nd_basicos']['idProveedor'])&&$_SESSION['arriendos_ing_nd_basicos']['idProveedor']!=''){ ?>
