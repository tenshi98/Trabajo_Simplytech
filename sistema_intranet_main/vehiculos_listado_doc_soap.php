...
idOpciones_6, idOpciones_7, idOpciones_8, doc_soap, doc_fecha_soap
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar SOAP</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_doc_soap.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Archivo - SOAP</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				...
				<?php if(isset($rowdata['doc_soap'])&&$rowdata['doc_soap']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						...
						<?php echo preview_docs('upload', $rowdata['doc_soap'], ''); ?>
				...
				<?php }else{?>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
						...
						echo '<h3>SOAP</h3>';
						$Form_Imputs->form_multiple_upload('Seleccionar archivo','doc_soap', 1, '"doc","docx","pdf","jpg", "png", "gif", "jpeg"');
						$Form_Imputs->form_date('Fecha Vencimiento','doc_fecha_soap', $x1, 2);
