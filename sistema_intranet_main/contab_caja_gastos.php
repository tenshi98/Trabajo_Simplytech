...
if (isset($_GET['created'])){ $error['created'] = 'sucess/Rendicion Realizado correctamente';}
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Rendicion Modificado correctamente';}
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group" style="width: 35px;" >
								<?php if ($rowlevel['level']>=1){ ?><a href="<?php echo 'view_mov_contab_caja_gastos.php?view='.simpleEncode($tipo['idFacturacion'], fecha_actual()); ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
							</div>
						</td>
					</tr>
					<?php } ?>
