						...
						<tr>
							...
							<td>
								<div class="btn-group" style="width: 35px;" >
									<a href="<?php echo 'informe_backup_telemetria_errores_2_view.php?view='.simpleEncode($error['idErrores'], fecha_actual()); ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a>
								</div>
							</td>
						</tr>
                    <?php }  ?>
