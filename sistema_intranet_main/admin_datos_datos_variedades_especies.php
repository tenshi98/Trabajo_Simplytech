...
$location = $original;
$new_location = "admin_datos_datos_variedades_especies.php";
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if(isset($Count_Variedades)&&$Count_Variedades!=0){?>
							<li class="active"><a href="<?php echo 'admin_datos_datos_variedades_especies.php';?>" >Especies</a></li>
						...
						<td>
							<div class="btn-group" style="width: 100px;" id="toggle_event_editing">	
								<?php if ( isset($productos['contar'])&&$productos['contar']!='0' ) {?>    
									<a title="Quitar Permiso" class="btn btn-sm btn-default unlocked_inactive tooltip" href="<?php echo $new_location.'?id='.$_SESSION['usuario']['basic_data']['idSistema'].'&sis_especie_del='.$productos['idpermiso']; ?>">OFF</a>
								...
								<?php } else {?>
									...
									<a title="Dar Permiso" class="btn btn-sm btn-default unlocked_inactive tooltip" href="<?php echo $new_location.'?id='.$_SESSION['usuario']['basic_data']['idSistema'].'&sis_especie_add='.$productos['idCategoria']; ?>">ON</a>
								<?php }?>    
							</div> 
						</td>
					</tr>
