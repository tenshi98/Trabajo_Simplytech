						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 35px;" >
									<a href="<?php echo 'informe_backup_cross_telemetria_01_view_map.php?idTabla='.$med['idTabla'].$search.'&return='.basename($_SERVER["REQUEST_URI"], ".php"); ?>" title="Ver Mapa" class="btn btn-primary btn-sm tooltip"><i class="fa fa-map" aria-hidden="true"></i></a>
								</div>
							</td>
						</tr>
					<?php } ?>
