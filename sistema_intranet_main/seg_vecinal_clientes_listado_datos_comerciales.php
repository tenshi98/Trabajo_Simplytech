...
$location = $original;
$new_location = "seg_vecinal_clientes_listado_datos_comerciales.php";
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if(isset($rowdata['idTipo'])&&$rowdata['idTipo']==1){?>
							<li class="active"><a href="<?php echo 'seg_vecinal_clientes_listado_datos_comerciales.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-usd" aria-hidden="true"></i> Datos Comerciales</a></li>
						<?php } ?>
