...
$location = $original;
$new_location = "contratista_listado_observaciones.php";
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/contratista_observaciones.php';
}
...
if(!empty($_GET['edit'])){
	...
	$rowData = db_select_data (false, $SIS_query, 'contratista_observaciones', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('idContratista', $_GET['id'], 2);
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// consulto los datos
	$SIS_query = '
	contratista_listado.Nombre AS nombre_cliente,
	usuarios_listado.Nombre AS nombre_usuario,
	contratista_observaciones.Fecha,
	contratista_observaciones.Observacion';
	$SIS_join  = '
	LEFT JOIN `contratista_listado` ON contratista_listado.idContratista = contratista_observaciones.idContratista
	LEFT JOIN `usuarios_listado`    ON usuarios_listado.idUsuario        = contratista_observaciones.idUsuario';
	$SIS_where = 'contratista_observaciones.idObservacion ='.$_GET['view'];
	$rowData = db_select_data (false, $SIS_query, 'contratista_observaciones', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// consulto los datos
	$SIS_query = '
	contratista_observaciones.idObservacion,
	contratista_listado.Nombre AS nombre_cliente,
	usuarios_listado.Nombre AS nombre_usuario,
	contratista_observaciones.Fecha,
	contratista_observaciones.Observacion';
	...
	LEFT JOIN `contratista_listado` ON contratista_listado.idContratista = contratista_observaciones.idContratista
	LEFT JOIN `usuarios_listado`    ON usuarios_listado.idUsuario        = contratista_observaciones.idUsuario';
	$SIS_where = 'contratista_observaciones.idContratista =';
	$SIS_order = 'contratista_observaciones.idObservacion ASC';
	$arrObservaciones = array();
	$arrObservaciones = db_select_array (false, $SIS_query, 'contratista_observaciones', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrObservaciones');

	?>

	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Contratista', $rowData['Nombre'], 'Observaciones'); ?>
		...
		<div class="box">
			<header>
				<ul class="nav nav-tabs pull-right">
					<li class=""><a href="<?php echo 'contratista_listado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-bars" aria-hidden="true"></i> Resumen</a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="active"><a href="<?php echo 'contratista_listado_observaciones.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-tasks" aria-hidden="true"></i> Observaciones</a></li>
						</ul>
					</li>
				</ul>
			</header>
