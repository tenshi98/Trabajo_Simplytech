...
$location = $original;
$new_location = "clientes_contab_listado_datos_comerciales.php";
...
/*******************************************************/
// consulto los datos
$SIS_query = 'Nombre,Rut, RazonSocial, Giro, idRubro, idTipo';
$SIS_join  = '';
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if(isset($rowdata['idTipo'])&&$rowdata['idTipo']==1){ ?>
							<li class="active"><a href="<?php echo 'clientes_contab_listado_datos_comerciales.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-usd" aria-hidden="true"></i> Datos Comerciales</a></li>
						<?php } ?>
