...
$original = "informe_busqueda_arriendos_01.php";
$location = $original;
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'fing_asc':         $order_by = 'bodegas_arriendos_facturacion.Creacion_fecha ASC ';                         $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ingreso Ascendente';break;
		case 'fing_desc':        $order_by = 'bodegas_arriendos_facturacion.Creacion_fecha DESC ';                        $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Ingreso Descendente';break;
		case 'fpag_asc':         $order_by = 'bodegas_arriendos_facturacion.Pago_fecha ASC ';                             $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Pago Ascendente';break;
		case 'fpag_desc':        $order_by = 'bodegas_arriendos_facturacion.Pago_fecha DESC ';                            $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Pago Descendente';break;
		case 'tipo_asc':         $order_by = 'bodegas_arriendos_facturacion_tipo.Nombre ASC ';                            $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Tipo Movimiento Ascendente';break;
		case 'tipo_desc':        $order_by = 'bodegas_arriendos_facturacion_tipo.Nombre DESC ';                           $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Tipo Movimiento Descendente';break;
		...
		default: $order_by = 'bodegas_arriendos_facturacion.Pago_fecha ASC, proveedor_listado.Nombre ASC, bodegas_arriendos_facturacion.N_Doc ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Pago, Proveedor, N° Doc Pago Ascendente';
	}
}else{
	$order_by = 'bodegas_arriendos_facturacion.Pago_fecha ASC, proveedor_listado.Nombre ASC, bodegas_arriendos_facturacion.N_Doc ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Pago, Proveedor, N° Doc Pago Ascendente';
}
/**********************************************************/
//Variable de busqueda
$SIS_where = "bodegas_arriendos_facturacion.idFacturacion!=0";
...
if(isset($_GET['N_Doc'])&&$_GET['N_Doc']!=''){       $SIS_where.= " AND bodegas_arriendos_facturacion.N_Doc=".$_GET['N_Doc'];}
...
if(isset($_GET['N_DocPago'])&&$_GET['N_DocPago']!=''){      $SIS_where.= " AND bodegas_arriendos_facturacion.N_DocPago=".$_GET['N_DocPago'];}

if(isset($_GET['f_creacion_inicio'], $_GET['f_creacion_termino'])&&$_GET['f_creacion_inicio']!=''&&$_GET['f_creacion_termino']!=''){
	$SIS_where.= " AND bodegas_arriendos_facturacion.Creacion_fecha BETWEEN '".$_GET['f_creacion_inicio']."' AND '".$_GET['f_creacion_termino']."'";
}
if(isset($_GET['f_pago_inicio'], $_GET['f_pago_termino'])&&$_GET['f_pago_inicio']!=''&&$_GET['f_pago_termino']!=''){
	$SIS_where.= " AND bodegas_arriendos_facturacion.Pago_fecha BETWEEN '".$_GET['f_pago_inicio']."' AND '".$_GET['f_pago_termino']."'";
}
if(isset($_GET['f_inicio_p'], $_GET['f_termino_p'])&&$_GET['f_inicio_p']!=''&&$_GET['f_termino_p']!=''){
	$SIS_where.= " AND bodegas_arriendos_facturacion.F_Pago BETWEEN '".$_GET['f_inicio_p']."' AND '".$_GET['f_termino_p']."'";
}
/**********************************************************/
