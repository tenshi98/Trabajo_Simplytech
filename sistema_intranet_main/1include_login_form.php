<link rel="stylesheet" href="<?php echo DB_SITE ?>/LIB_assets/css/animate/animate.min.css">
<style>
	...
	<div class="tab-content" style="min-height: 200px !important;">
		<div id="login" class="tab-pane active">
			<form class="" method="post"  name="form1" novalidate>
				...
				$Form_Imputs->input_login_usr('Usuario', 'usuario', $x1);
				$Form_Imputs->input_login_pass('Contraseña', 'password', $x2);
				
				$Form_Imputs->input_hidden('fkinput1', '', 1);
		...
		<div id="forgot" class="tab-pane">
			<form class="" method="post"  name="form2" novalidate>
				...
				//se dibujan los inputs
				$Form_Imputs->input_login_mail('mimail@midominio.cl', 'email', $x1);
				
				$Form_Imputs->input_hidden('fkinput2', '', 1);	  
				?>
				<br>
