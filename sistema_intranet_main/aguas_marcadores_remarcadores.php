...
$original = "aguas_marcadores_remarcadores.php";
$location = $original;
...
$search = '';
if(isset($_GET['idMarcadores']) && $_GET['idMarcadores']!=''){   $location .= "&idMarcadores=".$_GET['idMarcadores'];   $search .= "&idMarcadores=".$_GET['idMarcadores'];}
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/aguas_marcadores_remarcadores.php';
}
...
if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){       $SIS_where .= " AND aguas_marcadores_remarcadores.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table" aria-hidden="true"></i></div><h5>Listado de Remarcadores</h5>
			<div class="toolbar">
				<?php
		...
		<div class="table-responsive">
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				<thead>
					<tr role="row">
						<th>
							<div class="pull-left">Medidor</div>
							<div class="btn-group pull-right" style="width: 50px;" >
								<a href="<?php echo $location.'&order_by=medidor_asc'; ?>" title="Ascendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>
								<a href="<?php echo $location.'&order_by=medidor_desc'; ?>" title="Descendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-desc" aria-hidden="true"></i></a>
							</div>
						</th>
						<th>
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 70px;" >
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $location.'&id='.$uml['idRemarcadores']; ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
