...
if(!empty($_GET['id'])){
	...
	/*******************************************************/
	// consulto los datos
	$SIS_query = 'idUsuarioQueja, idTipoQueja, Observaciones, idTrabajadorQueja, NombreQueja';
	$SIS_join  = '';
	$SIS_where = 'idQueja = '.$_GET['id'];
	$rowData = db_select_data (false, $SIS_query, 'gestion_quejas', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
	/*******************************************************/
							...
							<tr class="odd">
								...
								<td>
									<div class="btn-group" style="width: 105px;" >
										<?php if ($rowlevel['level']>=1){ ?><a href="<?php echo 'view_gestion_quejas.php?view='.simpleEncode($usuarios['idQueja'], fecha_actual()); ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
