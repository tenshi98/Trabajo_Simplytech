...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/gestion_quejas.php';
}
...
// consulto los datos
$query = "SELECT idUsuarioQueja, idTipoQueja, Observaciones, idTrabajadorQueja, NombreQueja
FROM `gestion_quejas`
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select('Tipo Queja','idTipoQueja', $x6, 1, 'idTipoQueja', 'Nombre', 'core_tipo_queja_general', 0, '', $dbConn);
						...
						<tr class="odd">			
							...
							<td>
								<div class="btn-group" style="width: 105px;" >
									<?php if ($rowlevel['level']>=1){?><a href="<?php echo 'view_gestion_quejas.php?view='.simpleEncode($usuarios['idQueja'], fecha_actual()); ?>" title="Ver Informacion" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
									...
									<?php if ($rowlevel['level']>=4){
										...
										$dialogo   = '¿Realmente deseas eliminar la queja?';?>
