...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Entrega Realizada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Entrega Modificada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Entrega borrada correctamente';}
