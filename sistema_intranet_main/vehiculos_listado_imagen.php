...
$location = $original;
$new_location = "vehiculos_listado_imagen.php";
...
idOpciones_6, idOpciones_7, idOpciones_8, Direccion_img
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	echo widget_title('bg-aqua', 'fa-cog', 100, 'Vehiculo', $vehiculo, 'Editar Foto'); ?>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_imagen.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-picture-o" aria-hidden="true"></i>  Foto</a></li>
