...
$location = $original;
$new_location = "laboratorio_listado_observaciones.php";
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/laboratorio_observaciones.php';
}
...
// consulto los datos
$query = "SELECT 
laboratorio_listado.Nombre AS nombre_cliente,
usuarios_listado.Nombre AS nombre_usuario,
laboratorio_observaciones.Fecha,
laboratorio_observaciones.Observacion
FROM `laboratorio_observaciones`
LEFT JOIN `laboratorio_listado`   ON laboratorio_listado.idLaboratorio     = laboratorio_observaciones.idLaboratorio
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario     = laboratorio_observaciones.idUsuario
WHERE laboratorio_observaciones.idObservacion = ".$_GET['view']."
...
$query = "SELECT 
laboratorio_observaciones.idObservacion,
laboratorio_listado.Nombre AS nombre_cliente,
usuarios_listado.Nombre AS nombre_usuario,
laboratorio_observaciones.Fecha,
laboratorio_observaciones.Observacion
...
LEFT JOIN `laboratorio_listado`   ON laboratorio_listado.idLaboratorio     = laboratorio_observaciones.idLaboratorio
LEFT JOIN `usuarios_listado`      ON usuarios_listado.idUsuario            = laboratorio_observaciones.idUsuario
WHERE laboratorio_observaciones.idLaboratorio = ".$_GET['id']."
ORDER BY laboratorio_observaciones.idObservacion ASC ";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Laboratorio', $rowData['Nombre'], 'Observaciones'); ?>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'laboratorio_listado_observaciones.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-tasks" aria-hidden="true"></i> Observaciones</a></li>
					</ul>
                </li>
			</ul>
		</header>
