...
/**********************************************/
//formulario para crear
if ( !empty($_GET['bod_arriendo_add']) )  { 
	//nuevas ubicaciones
	$location = $new_location;
	$location.='&id='.$_GET['id'];
	//Llamamos al formulario
	$form_trabajo= 'bod_arriendo_add';
	require_once 'A1XRXS_sys/xrxs_form/usuarios_listado.php';
}
//se borra un dato
if ( !empty($_GET['bod_arriendo_del']) )     {
	//nuevas ubicaciones
	$location = $new_location;
	$location.='&id='.$_GET['id'];
	//Llamamos al formulario
	$form_trabajo= 'bod_arriendo_del';
	require_once 'A1XRXS_sys/xrxs_form/usuarios_listado.php';	
}
/**********************************************/
//formulario para crear
if ( !empty($_GET['prm_add_all']) )  { 
	...
	$location.='&id='.$_GET['id'];
	//Llamamos al formulario
	$form_trabajo= 'prm_add_all_bodegas';
	require_once 'A1XRXS_sys/xrxs_form/usuarios_listado.php';
}
//se borra un dato
if ( !empty($_GET['prm_del_all']) )     {
	...
	$location.='&id='.$_GET['id'];
	//Llamamos al formulario
	$form_trabajo= 'prm_del_all_bodegas';
	require_once 'A1XRXS_sys/xrxs_form/usuarios_listado.php';	
}
/**********************************************************************************************************************************/
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Permisos de acceso a Bodegas</span>
			</div>
		</div>
	</div>
</div>
        ...
        <div class="table-responsive">
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				<thead>
					...
					<tr role="row">
						<th colspan="3"><input class="form-control" id="InputTableFilter" type="text" placeholder="Filtrar.."></th>
					</tr>
				</thead>
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all" id="TableFiltered">
					...
					if($insumos!=0){
						...
						<tr class="odd">
							<td><?php echo '<strong>Bodega Insumos: </strong>'.$ins['Nombre']; ?></td>
					...
					if($productos!=0){
						...
						echo '<tr class="odd"><td colspan="3">No tiene permisos relacionados a Bodega de Productos</td></tr>';
					}
					/*******************************************************/
					if($arriendos!=0){
