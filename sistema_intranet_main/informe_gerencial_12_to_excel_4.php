...
//sololas del mismo sistema
$SIS_where_1.=" GROUP BY bodegas_arriendos_facturacion.idCliente, bodegas_arriendos_facturacion.Creacion_mes";
$SIS_where_2.=" GROUP BY bodegas_insumos_facturacion.idCliente, bodegas_insumos_facturacion.Creacion_mes";
$SIS_where_3.=" GROUP BY bodegas_productos_facturacion.idCliente, bodegas_productos_facturacion.Creacion_mes";
$SIS_where_4.=" GROUP BY bodegas_servicios_facturacion.idCliente, bodegas_servicios_facturacion.Creacion_mes";
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Ventas Clientes por mes');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Ventas Clientes por mes';
