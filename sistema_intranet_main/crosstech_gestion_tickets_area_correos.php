...
$query = "SELECT idArea, idUsuario
FROM `crosstech_gestion_tickets_area_correos`
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'categoria_asc':  $order_by = 'ORDER BY crosstech_gestion_tickets_area.Nombre ASC ';      $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Area Ascendente';break;
		case 'categoria_desc': $order_by = 'ORDER BY crosstech_gestion_tickets_area.Nombre DESC ';     $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Area Descendente';break;
		...
		default: $order_by = 'ORDER BY crosstech_gestion_tickets_area.Nombre ASC, usuarios_listado.email ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Area, Email Ascendente';
	}
}else{
	$order_by = 'ORDER BY crosstech_gestion_tickets_area.Nombre ASC, usuarios_listado.email ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Area, Email Ascendente';
}
/**********************************************************/
//Verifico el tipo de usuario que esta ingresando
$usrfil = 'usuarios_listado.idEstado=1 AND usuarios_listado.idTipoUsuario!=1';	
...
$z = "WHERE crosstech_gestion_tickets_area_correos.idCorreos!=0";
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['idArea']) && $_GET['idArea'] != ''){         $z .= " AND crosstech_gestion_tickets_area_correos.idArea=".$_GET['idArea'];}
if(isset($_GET['idUsuario']) && $_GET['idUsuario'] != ''){   $z .= " AND crosstech_gestion_tickets_area_correos.idUsuario=".$_GET['idUsuario'];}
/**********************************************************/
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT crosstech_gestion_tickets_area_correos.idCorreos FROM `crosstech_gestion_tickets_area_correos` 
