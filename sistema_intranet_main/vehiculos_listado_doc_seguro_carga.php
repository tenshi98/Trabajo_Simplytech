	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Seguro Carga</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_doc_seguro_carga.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Archivo - Seguro Carga</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				...
				<?php }else{?>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
						...
						echo '<h3>Seguro Carga</h3>';
						$Form_Imputs->form_multiple_upload('Seleccionar archivo','doc_seguro_carga', 1, '"doc","docx","pdf","jpg", "png", "gif", "jpeg"');
						$Form_Imputs->form_date('Fecha Vencimiento','doc_fecha_seguro_carga', $x1, 2);
