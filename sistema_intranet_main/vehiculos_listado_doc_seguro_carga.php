...
$location = $original;
$new_location = "vehiculos_listado_doc_seguro_carga.php";
...
if (!empty($_POST['submit_edit'])){
	...
	$form_trabajo= 'submit_doc_seguro_carga';
	require_once 'A1XRXS_sys/xrxs_form/vehiculos_listado.php';
}
//se borra un dato
if (!empty($_GET['del_doc_seguro_carga'])){
	//Nueva ubicacion
	$location = $new_location;
	$location.='&id='.$_GET['id'];
	//Llamamos al formulario
	$form_trabajo= 'del_doc_seguro_carga';
	require_once 'A1XRXS_sys/xrxs_form/vehiculos_listado.php';
}
/**********************************************************************************************************************************/
...
idOpciones_6, idOpciones_7, idOpciones_8,doc_seguro_carga, doc_fecha_seguro_carga
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	echo widget_title('bg-aqua', 'fa-cog', 100, 'Vehiculo', $vehiculo, 'Editar Seguro Carga'); ?>
</div>
	...
	<div class="box">
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_doc_seguro_carga.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-files-o" aria-hidden="true"></i> Archivo - Seguro Carga</a></li>
        ...
        <div class="table-responsive">
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php if(isset($rowData['doc_seguro_carga'])&&$rowData['doc_seguro_carga']!=''){ ?>

					<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 fcenter">
						<h3>Archivo</h3>
						<p>Fecha de Vencimiento: <?php echo fecha_estandar($rowData['doc_fecha_seguro_carga']); ?></p>
						<?php echo preview_docs(DB_SITE_REPO.DB_SITE_MAIN_PATH, 'upload/'.$rowData['doc_seguro_carga'], ''); ?>
						<br/>
						<a href="<?php echo $new_location.'&id='.$_GET['id'].'&del_doc_seguro_carga='.$_GET['id']; ?>" class="btn btn-danger pull-right margin_form_btn" style="margin-top:10px;margin-bottom:10px;"><i class="fa fa-trash-o" aria-hidden="true"></i> Borrar Archivo</a>
					</div>
					<div class="clearfix"></div>
				...
				<?php }else{ ?>
					...
					<form class="form-horizontal" method="post" id="form1" name="form1" enctype="multipart/form-data" autocomplete="off" novalidate>
						...
						if(isset($doc_fecha_seguro_carga)){   $x1  = $doc_fecha_seguro_carga;    }else{$x1  = '';}

						//se dibujan los inputs
						$Form_Inputs = new Form_Inputs();
						$Form_Inputs->form_tittle(3, 'Seguro Carga');
						$Form_Inputs->form_multiple_upload('Seleccionar archivo','doc_seguro_carga', 1, '"doc","docx","pdf","jpg", "png", "gif", "jpeg"');
						$Form_Inputs->form_date('Fecha Vencimiento','doc_fecha_seguro_carga', $x1, 2);
