...
/*******************************************************/
$arrBodega = array();
$arrBodega = db_select_array (false, 'idBodega, Nombre', 'bodegas_insumos_listado', '', '', 0, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], basename($_SERVER["REQUEST_URI"], ".php"), 'arrBodega');
...
//Egreso
$SIS_where.= " AND bodegas_insumos_facturacion_existencias.Cantidad_ing=0 AND bodegas_insumos_facturacion_existencias.Cantidad_eg!=0";
...
$SIS_join  = 'LEFT JOIN `insumos_listado` ON insumos_listado.idProducto = bodegas_insumos_facturacion_existencias.idProducto';
$SIS_order = 'bodegas_insumos_facturacion_existencias.Creacion_ano ASC, bodegas_insumos_facturacion_existencias.Creacion_mes ASC, insumos_listado.idCategoria ASC';
$arrExistenciasMain = array();
$arrExistenciasMain = db_select_array (false, $SIS_query, 'bodegas_insumos_facturacion_existencias', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], basename($_SERVER["REQUEST_URI"], ".php"), 'arrExistenciasMain');
...
$SIS_order = 'bodegas_insumos_facturacion.idBodegaDestino ASC, bodegas_insumos_facturacion_existencias.Creacion_ano ASC, bodegas_insumos_facturacion_existencias.Creacion_mes ASC, insumos_listado.idCategoria ASC';
$arrExistencias = array();
$arrExistencias = db_select_array (false, $SIS_query, 'bodegas_insumos_facturacion_existencias', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], basename($_SERVER["REQUEST_URI"], ".php"), 'arrExistencias');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Bodega Insumos - Traspasos por Categorias x Empresas';
