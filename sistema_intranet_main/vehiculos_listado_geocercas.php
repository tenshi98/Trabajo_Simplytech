...
$location = $original;
$new_location = "vehiculos_listado_geocercas.php";
...
if (isset($_GET['del_doc_vehi'])) {$error['usuario']  = 'sucess/Geocerca borrada correctamente';}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
				...
				$Form_Inputs->form_select_filter('Geocercas Disponibles','idZona', $x1, 2, 'idZona', 'Nombre', 'vehiculos_geocercas', $w, '', $dbConn);
...
vehiculos_geocercas.Nombre AS Geocerca
FROM `vehiculos_listado_geocercas`
LEFT JOIN `vehiculos_geocercas`   ON vehiculos_geocercas.idZona     = vehiculos_listado_geocercas.idZona
WHERE vehiculos_listado_geocercas.idVehiculo = ".$_GET['id']."
ORDER BY vehiculos_geocercas.Nombre ASC ";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
<div class="col-sm-12">
	...
	echo widget_title('bg-aqua', 'fa-cog', 100, 'Vehiculo', $vehiculo, 'Editar Geocercas');?>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_geocercas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-map-o" aria-hidden="true"></i> GeoCercas</a></li>
