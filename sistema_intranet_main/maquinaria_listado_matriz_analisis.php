...
$location = $original;
$new_location = "maquinaria_listado_matriz_analisis.php";
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('idMatriz', simpleDecode($_GET['clone_idMatriz'], fecha_actual()), 2);
					?>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Armo cadena
	$SIS_query  = 'PuntoNombre_'.simpleDecode($_GET['mod'], fecha_actual()).' AS Nombre';
	$SIS_query .= ',PuntoMedAceptable_'.simpleDecode($_GET['mod'], fecha_actual()).' AS Aceptable';
	$SIS_query .= ',PuntoMedAlerta_'.simpleDecode($_GET['mod'], fecha_actual()).' AS Alerta';
	$SIS_query .= ',PuntoMedCondenatorio_'.simpleDecode($_GET['mod'], fecha_actual()).' AS Condenatorio';
	$SIS_query .= ',PuntoUniMed_'.simpleDecode($_GET['mod'], fecha_actual()).' AS UniMed';
	$SIS_query .= ',PuntoidTipo_'.simpleDecode($_GET['mod'], fecha_actual()).' AS Tipo';
	$SIS_query .= ',PuntoidGrupo_'.simpleDecode($_GET['mod'], fecha_actual()).' AS Grupo';

	// consulto los datos
	$SIS_join  = '';
	$SIS_where = 'idMatriz ='.simpleDecode($_GET['idMatriz'], fecha_actual());
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('idMatriz', simpleDecode($_GET['idMatriz'], fecha_actual()), 2);
					$Form_Inputs->form_input_hidden('mod', simpleDecode($_GET['mod'], fecha_actual()), 2);
							...
							<tr class="odd">
								...
								<td>
									<div class="btn-group" style="width: 35px;" >
										<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&idMatriz='.$_GET['idMatriz'].'&mod='.simpleEncode($i, fecha_actual()); ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
									</div>
								</td>
							</tr>
						<?php } ?>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_join  = '';
	$SIS_where = 'idMatriz ='.simpleDecode($_GET['idMatriz_2'], fecha_actual());
	$rowData = db_select_data (false, $SIS_query, 'maquinas_listado_matriz', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('idMatriz', simpleDecode($_GET['idMatriz_2'], fecha_actual()), 2);
					?>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							if(isset($rowData['idConfig_2'])&&$rowData['idConfig_2']==1){ ?>
								<li class="active"><a href="<?php echo 'maquinaria_listado_matriz_analisis.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-microchip" aria-hidden="true"></i> Matriz Analisis</a></li>
							<?php } ?>
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 140px;" >
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&idMatriz_2='.simpleEncode($maq['idMatriz'], fecha_actual()); ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&clone_idMatriz='.simpleEncode($maq['idMatriz'], fecha_actual()).'&nombre_matriz='.$maq['Nombre']; ?>" title="Clonar Matriz" class="btn btn-primary btn-sm tooltip"><i class="fa fa-files-o" aria-hidden="true"></i></a><?php } ?>
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&idMatriz='.simpleEncode($maq['idMatriz'], fecha_actual()); ?>" title="Editar Matriz" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
