	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="<?php echo 'ubicacion_listado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-bars" aria-hidden="true"></i> Resumen</a></li>
				<li class=""><a href="<?php echo 'ubicacion_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-list-alt" aria-hidden="true"></i> Datos Basicos</a></li>
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		default: $order_by = 'ORDER BY ubicacion_listado.idEstado ASC, ubicacion_listado.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Estado Ascendente, Nombre Ascendente';
	}
}else{
	$order_by = 'ORDER BY ubicacion_listado.idEstado ASC, ubicacion_listado.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Estado Ascendente, Nombre Ascendente';
}
/**********************************************************/ 
...
if(isset($_GET['idEstado']) && $_GET['idEstado'] != ''){   $z .= " AND ubicacion_listado.idEstado='".$_GET['idEstado']."'";}
/**********************************************************/ 
