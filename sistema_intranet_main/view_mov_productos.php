...
WHERE pagos_facturas_proveedores.idFacturacion = ".$X_Puntero." AND idTipo=2
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
WHERE pagos_facturas_clientes.idFacturacion = ".$X_Puntero." AND idTipo=2
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
$arrArchivo = array();
$query = "SELECT Nombre
FROM `bodegas_productos_facturacion_archivos` 
WHERE idFacturacion = ".$X_Puntero;
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
FROM `bodegas_productos_facturacion_historial` 
...
WHERE bodegas_productos_facturacion_historial.idFacturacion = ".$X_Puntero." 
ORDER BY bodegas_productos_facturacion_historial.idHistorial ASC";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
WHERE bodegas_productos_facturacion.idFacturacion = ".$X_Puntero." 
...
LEFT JOIN `core_documentos_mercantiles`  ON core_documentos_mercantiles.idDocumentos     = bodegas_productos_facturacion.idDocumentos
LEFT JOIN `usuarios_listado`             ON usuarios_listado.idUsuario                   = bodegas_productos_facturacion.idUsuario
WHERE bodegas_productos_facturacion.idFacturacionRelacionado = ".$X_Puntero;
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
