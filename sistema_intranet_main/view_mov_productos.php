...
WHERE pagos_facturas_proveedores.idFacturacion = {$_GET['view']} AND idTipo=2
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
WHERE pagos_facturas_clientes.idFacturacion = {$_GET['view']} AND idTipo=2
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
WHERE bodegas_productos_facturacion_historial.idFacturacion = {$_GET['view']} 
...
WHERE bodegas_productos_facturacion.idFacturacion = {$_GET['view']} 
...
LEFT JOIN `core_documentos_mercantiles`  ON core_documentos_mercantiles.idDocumentos     = bodegas_productos_facturacion.idDocumentos
LEFT JOIN `usuarios_listado`             ON usuarios_listado.idUsuario                   = bodegas_productos_facturacion.idUsuario
WHERE bodegas_productos_facturacion.idFacturacionRelacionado = {$_GET['view']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
