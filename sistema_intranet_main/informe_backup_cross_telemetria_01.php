							...
							<tr class="odd">
								...
								<td>
									<div class="btn-group" style="width: 70px;" >
										...
										<?php if ($rowlevel['level']>=1){ ?><a href="<?php echo 'informe_backup_cross_telemetria_01_view.php?bla=bla'.$search; ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
									</div>
								</td>
							</tr>
						<?php } ?>
