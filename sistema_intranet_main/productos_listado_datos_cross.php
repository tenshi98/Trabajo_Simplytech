...
$location = $original;
$new_location = "productos_listado_datos_cross.php";
...
$query = "SELECT Nombre, idCalidad,idOpciones_1, idOpciones_2
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, $x_column_producto_nombre_plur, $rowdata['Nombre'], 'Editar Datos Sistema Cross');?>
</div>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if(isset($rowdata['idOpciones_2'])&&$rowdata['idOpciones_2']==1){ ?>
							<li class="active"><a href="<?php echo 'productos_listado_datos_cross.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-wrench" aria-hidden="true"></i> Sistema CROSS</a></li>
						<?php } ?>
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post"  id="form1" name="form1" novalidate>		
					...
					if(isset($idCalidad)) {         $x1  = $idCalidad;           }else{$x1  = $rowdata['idCalidad'];}
					
					//se dibujan los inputs
					$Form_Inputs = new Form_Inputs();
					$Form_Inputs->form_select_filter('Tipo Planilla de Calidad','idCalidad', $x1, 1, 'idMatriz', 'Nombre', 'cross_quality_calidad_matriz', 0, '', $dbConn);
