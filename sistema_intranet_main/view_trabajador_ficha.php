...
core_sistemas.Rubro AS Empleador_Giro,
...
trabajadores_listado.email AS Trabajador_Mail,
trabajadores_listado.F_Inicio_Contrato AS Trabajador_FechaIngreso,
trabajadores_listado.SueldoLiquido AS Trabajador_Sueldo,
(SELECT COUNT(idCarga) FROM trabajadores_listado_cargas WHERE idTrabajador = '.$X_Puntero.') AS Trabajador_Cargas,
core_tipos_contrato.Nombre AS Trabajador_TipoContrato,
core_bancos.Nombre AS Trabajador_Banco,
core_tipo_cuenta.Nombre AS Trabajador_TipoCuenta,
trabajadores_listado.N_Cuenta AS Trabajador_NCuenta';
$SIS_join  = '
...
?>
    ...
    <script>
		...
		function generate() {
			loadFile("templates/Ficha_Contrato.docx",function(error,content){
				...
				doc.setData({
					...
					Empleador_Giro: '<?php echo $Empleador_Giro; ?>',
					Empleador_Contrato: '<?php echo $Empleador_Contrato; ?>',
					...
					Trabajador_FechaNacimiento: '<?php echo Fecha_estandar($Trabajador_FechaNacimiento); ?>',
					...
					Trabajador_Mail: '<?php echo $Trabajador_Mail; ?>',
					Trabajador_Movilizacion: '<?php echo $Trabajador_Movilizacion; ?>',
					Trabajador_FechaIngreso: '<?php echo Fecha_estandar($Trabajador_FechaIngreso); ?>',
					Trabajador_Sueldo: '<?php echo valores($Trabajador_Sueldo, 0); ?>',
					Trabajador_Cargas: '<?php echo $Trabajador_Cargas; ?>',
					Trabajador_TipoContrato: '<?php echo $Trabajador_TipoContrato; ?>',
					Trabajador_Banco: '<?php echo $Trabajador_Banco; ?>',
					Trabajador_TipoCuenta: '<?php echo $Trabajador_TipoCuenta; ?>',
					Trabajador_NCuenta: '<?php echo $Trabajador_NCuenta; ?>',
				});
				...
				saveAs(out,"<?php echo 'Ficha Trabajador '.$Trabajador_Nombre; ?>.docx")
			})
		}
    </script>
