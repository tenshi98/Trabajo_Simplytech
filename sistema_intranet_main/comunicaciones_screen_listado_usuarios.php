...
$location = $original;
$new_location = "comunicaciones_screen_listado_usuarios.php";
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/comunicaciones_screen_listado_usuarios.php';
}
...
if(!empty($_GET['edit'])){
	...
	$rowdata = db_select_data (false, $SIS_query, 'comunicaciones_screen_listado_usuarios', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowdata');
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('idScreen', $_GET['id'], 2);
					?>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// consulto los datos
	$SIS_query = '
	comunicaciones_screen_listado_usuarios.idUsers,
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Screen Sharing', $rowdata['Nombre'], 'Usuarios Participantes'); ?>
		...
		<div class="box">
			<header>
				<ul class="nav nav-tabs pull-right">
					<li class=""><a href="<?php echo 'comunicaciones_screen_listado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-bars" aria-hidden="true"></i> Resumen</a></li>
					...
					<li class="active"><a href="<?php echo 'comunicaciones_screen_listado_usuarios.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Usuarios</a></li>         
				</ul>
			</header>
