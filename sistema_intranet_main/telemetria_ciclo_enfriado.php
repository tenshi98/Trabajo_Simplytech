...
if(isset($_GET['CantidadPallet']) && $_GET['CantidadPallet'] != ''){  $SIS_where .= " AND telemetria_ciclo_enfriado.CantidadPallet LIKE '%".$_GET['CantidadPallet']."%'";}
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Ciclo Enfriado</a><?php } ?>
