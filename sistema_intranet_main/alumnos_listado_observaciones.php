...
$location = $original;
$new_location = "alumnos_listado_observaciones.php";
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/alumnos_observaciones.php';
}
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// consulto los datos
	$SIS_query = '
	alumnos_listado.Nombre AS nombre_cliente,
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// consulto los datos
	$SIS_query = '
	alumnos_observaciones.idObservacion,
	alumnos_listado.Nombre AS nombre_cliente,
	usuarios_listado.Nombre AS nombre_usuario,
	alumnos_observaciones.Fecha,
	alumnos_observaciones.Observacion';
	...
	LEFT JOIN `alumnos_listado`   ON alumnos_listado.idAlumno     = alumnos_observaciones.idAlumno
	LEFT JOIN `usuarios_listado`  ON usuarios_listado.idUsuario   = alumnos_observaciones.idUsuario';
	$SIS_where = 'alumnos_observaciones.idAlumno ='.$_GET['id'];
	$SIS_order = 'alumnos_observaciones.idObservacion ASC';
	$arrObservaciones = array();
	$arrObservaciones = db_select_array (false, $SIS_query, 'alumnos_observaciones', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrObservaciones');
				...
				<ul class="nav nav-tabs pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="active"><a href="<?php echo 'alumnos_listado_observaciones.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-tasks" aria-hidden="true"></i> Observaciones</a></li>
