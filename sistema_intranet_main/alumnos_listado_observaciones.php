...
WHERE alumnos_observaciones.idObservacion = ".$_GET['view']."
...
LEFT JOIN `alumnos_listado`   ON alumnos_listado.idAlumno     = alumnos_observaciones.idAlumno
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario     = alumnos_observaciones.idUsuario
WHERE alumnos_observaciones.idAlumno = ".$_GET['id']."
ORDER BY alumnos_observaciones.idObservacion ASC ";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
?>
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Alumno', $rowdata['Nombre'], 'Observaciones');?>
