		...
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<?php if($todos!=0 OR $idTipoUsuario==1){ ?>
					<li class="active"><a href="<?php echo 'vehiculos_listado_configuracion.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-wrench" aria-hidden="true"></i> Configuracion</a></li>
				<?php } ?>
				<li class="dropdown">
			...
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if($telemetria!=0 OR $idTipoUsuario==1) {
						$Form_Inputs->form_select('Utilizar Telemetria','idOpciones_1', $x1, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);
					}
					if($bodega!=0 OR $idTipoUsuario==1) {
						$Form_Inputs->form_select('Utilizar Bodega','idOpciones_2', $x2, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);
					}
					if($ruta!=0 OR $idTipoUsuario==1) {
						$Form_Inputs->form_select('Utilizar Ruta','idOpciones_3', $x3, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);
					}
					if($trabajador!=0 OR $idTipoUsuario==1) {
						$Form_Inputs->form_select('Utilizar Trabajador','idOpciones_4', $x4, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);
					}
					if($pasajeros!=0 OR $idTipoUsuario==1) {
						$Form_Inputs->form_select('Utilizar Pasajeros','idOpciones_5', $x5, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);
						$Form_Inputs->form_select('Utilizar APP','idOpciones_6', $x6, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);
					}
					if($peonetas!=0 OR $idTipoUsuario==1) {
						$Form_Inputs->form_select('Utilizar Peonetas','idOpciones_7', $x7, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);
					}
