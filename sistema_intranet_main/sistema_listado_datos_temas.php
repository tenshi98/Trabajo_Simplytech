...
if ( !empty($_GET['edit_theme']) )  { 
	...
	$location.='&id='.$_GET['id'];
	$location.='&idTheme='.$_GET['idTheme'];
	//Llamamos al formulario
	$form_trabajo= 'update_theme';
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Cambiar tema</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'sistema_listado_datos_temas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id'];?>" >Temas</a></li>
				...
				<?php foreach ($arrTemas as $temas) { ?>
					<div class="col-sm-4">
						<div class="theme-box <?php if($rowdata['Config_idTheme']==$temas['idTheme']){echo 'selected';} ?>"> 
							<img src="<?php echo DB_SITE ?>/LIB_assets/img/themes_preview/<?php echo $temas['img']; ?>" alt="Tema" class="img-responsive2">
							<div class="theme-info">
								<div class="clearfix">
									<h2><?php echo $temas['Nombre']; ?></h2>
								</div>
								<div class="buttons"> 
									<a href="<?php echo 'view_tema.php?idTheme='.$temas['idTheme']; ?>" class="iframe"><i class="fa fa-eye"></i> &nbsp;Ver</a> 
									<a href="<?php echo $new_location.'&idTheme='.$temas['idTheme'].'&idSistema='.$_SESSION['usuario']['basic_data']['idSistema'].'&edit_theme=true'; ?>"><i class="fa fa-check"></i> &nbsp;Seleccionar</a> 
								</div>
							</div>
						</div>
					</div>
