	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			...
			//verifico que sea un administrador
				...
				$Form_Inputs->form_select_depend5($x_column_ubicacion, 'idUbicacion',  $x3,  1,  'idUbicacion',  'Nombre',  'ubicacion_listado',  'idEstado=1 AND idSistema='.$_SESSION['usuario']['basic_data']['idSistema'],   0,
