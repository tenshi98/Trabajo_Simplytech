...
$location = $original;
$new_location = "vehiculos_listado_doc_padron.php";
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	$form_trabajo= 'submit_doc_padron';
	require_once 'A1XRXS_sys/xrxs_form/vehiculos_listado.php';
}
//se borra un dato
if ( !empty($_GET['del_doc_padron']) )     {
	//Nueva ubicacion
	$location = $new_location;
	$location.='&id='.$_GET['id'];
	//Llamamos al formulario
	$form_trabajo= 'del_doc_padron';
	require_once 'A1XRXS_sys/xrxs_form/vehiculos_listado.php';	
}
/**********************************************************************************************************************************/
...
idOpciones_6, idOpciones_7, idOpciones_8,doc_padron, doc_fecha_padron
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Padron</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_doc_padron.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Archivo - Padron</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				...
				<?php if(isset($rowdata['doc_padron'])&&$rowdata['doc_padron']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						<h3>Archivo</h3>
						<p>Fecha de Vencimiento: <?php echo fecha_estandar($rowdata['doc_fecha_padron']); ?></p>
						<?php echo preview_docs('upload', $rowdata['doc_padron'], ''); ?>
					</div>
					<a href="<?php echo $new_location.'&id='.$_GET['id'].'&del_doc_padron='.$_GET['id']; ?>" class="btn btn-danger fright margin_width" style="margin-top:10px;margin-bottom:10px;"><i class="fa fa-trash-o" aria-hidden="true"></i> Borrar Archivo</a>
					<div class="clearfix"></div>
				...
				<?php }else{?>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
						...
						if(isset($doc_fecha_padron)) {  $x1  = $doc_fecha_padron;   }else{$x1  = '';}
				
						//se dibujan los inputs
						$Form_Imputs = new Form_Inputs();
						echo '<h3>Padron</h3>';
						$Form_Imputs->form_multiple_upload('Seleccionar archivo','doc_padron', 1, '"doc","docx","pdf","jpg", "png", "gif", "jpeg"');
						$Form_Imputs->form_date('Fecha Vencimiento','doc_fecha_padron', $x1, 2);
