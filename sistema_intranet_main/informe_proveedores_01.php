...
//Filtros
if(isset($_GET['idTipo'])&&$_GET['idTipo']!=''){             $z.=" AND proveedor_listado.idTipo=".$_GET['idTipo'];                    $search.= '&idTipo='.$_GET['idTipo'];}
if(isset($_GET['Nombre'])&&$_GET['Nombre']!=''){             $z.=" AND proveedor_listado.Nombre LIKE '%".$_GET['Nombre']."%'";        $search.= '&Nombre='.$_GET['Nombre'];}
if(isset($_GET['Rut'])&&$_GET['Rut']!=''){                   $z.=" AND proveedor_listado.Rut LIKE '%".$_GET['Rut']."%'";              $search.= '&Rut='.$_GET['Rut'];}
if(isset($_GET['fNacimiento'])&&$_GET['fNacimiento']!=''){   $z.=" AND proveedor_listado.fNacimiento='".$_GET['fNacimiento']."'";     $search.= '&fNacimiento='.$_GET['fNacimiento'];}
...
if(isset($_GET['Direccion'])&&$_GET['Direccion']!=''){       $z.=" AND proveedor_listado.Direccion LIKE '%".$_GET['Direccion']."%'";  $search.= '&Direccion='.$_GET['Direccion'];}
