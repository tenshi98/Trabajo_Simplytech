...
if(isset($_GET['Nombre'])&&$_GET['Nombre']!=''){     $z.=" AND proveedor_listado.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";        $search.= '&Nombre='.$_GET['Nombre'];}
if(isset($_GET['Rut'])&&$_GET['Rut']!=''){           $z.=" AND proveedor_listado.Rut LIKE '%".EstandarizarInput($_GET['Rut'])."%'";              $search.= '&Rut='.$_GET['Rut'];}
