...
$location = $original;
$new_location = "seg_vecinal_clientes_listado_verificacion.php";
...
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Verificacion cambiado correctamente';}
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'seg_vecinal_clientes_listado_verificacion.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-check-square-o" aria-hidden="true"></i> Verificacion</a></li>
