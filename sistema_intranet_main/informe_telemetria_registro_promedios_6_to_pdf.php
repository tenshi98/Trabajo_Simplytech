...
function crear_data($INT_cantsens, $INT_filtro, $INT_idTelemetria, $INT_f_inicio, $INT_f_termino, $INT_desde, $INT_hasta, $dbConn ) {
	...
	telemetria_listado_tablarelacionada_".$INT_idTelemetria.".FechaSistema
	".$consql."
	FROM `telemetria_listado_tablarelacionada_".$INT_idTelemetria."`
	LEFT JOIN `telemetria_listado`    ON telemetria_listado.idTelemetria   = telemetria_listado_tablarelacionada_".$INT_idTelemetria.".idTelemetria
	WHERE idTabla!=0
	".$INT_filtro.$subfiltro." 
	GROUP BY telemetria_listado_tablarelacionada_".$INT_idTelemetria.".FechaSistema
	ORDER BY telemetria_listado_tablarelacionada_".$INT_idTelemetria.".FechaSistema ASC";
	//Consulta
