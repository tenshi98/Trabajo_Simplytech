...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'fecha_asc':        $order_by = 'trabajadores_inasistencias_horas.Creacion_fecha ASC ';                                                              $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Facturacion Ascendente';break;
		case 'fecha_desc':       $order_by = 'trabajadores_inasistencias_horas.Creacion_fecha DESC ';                                                             $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';break;
		...
		case 'horas_asc':        $order_by = 'usuarios_listado.Horas ASC ';                                                                                       $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Horas Ascendente'; break;
		case 'horas_desc':       $order_by = 'usuarios_listado.Horas DESC ';                                                                                      $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Horas Descendente';break;
		
		default: $order_by = 'trabajadores_inasistencias_horas.Creacion_fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';
	}
}else{
	$order_by = 'trabajadores_inasistencias_horas.Creacion_fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';
}
/**********************************************************/
//Variable de busqueda
$SIS_where = "trabajadores_inasistencias_horas.idInasistenciaHora!=0";
//Verifico el tipo de usuario que esta ingresando
$w = "idSistema=".$_SESSION['usuario']['basic_data']['idSistema']." AND idEstado=1";
//Verifico el tipo de usuario que esta ingresando
...
if(isset($_GET['idTrabajador']) && $_GET['idTrabajador'] != ''){      $SIS_where .= " AND trabajadores_inasistencias_horas.idTrabajador=".$_GET['idTrabajador'];}
...
$arrInasHoras = array();
$arrInasHoras = db_select_array (false, $SIS_query, 'trabajadores_inasistencias_horas', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrInasHoras');
