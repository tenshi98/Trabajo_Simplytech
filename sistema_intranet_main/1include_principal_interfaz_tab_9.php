						...
						<div class="tab-pane fade <?php echo $xactive; ?>" id="res_id_<?php echo $idOficina; ?>">
							<div class="wmd-panel">
								...
								<div class="col-sm-12 breadcrumb-bar">
									<a href="gestion_reserva_oficinas.php?pagina=1&new=true&idOficina=<?php echo $idOficina; ?>" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Reserva</a>
								</div>
