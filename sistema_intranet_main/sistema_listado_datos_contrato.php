	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Datos de Contrato</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li class="active"><a href="<?php echo 'sistema_listado_datos_contrato.php?pagina='.$_GET['pagina'].'&id='.$_GET['id'];?>" >Datos Contrato</a></li>
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_input_text( 'Nombre Contrato', 'Contrato_Nombre', $x1, 1);
					$Form_Imputs->form_input_text( 'Numero de Contrato', 'Contrato_Numero', $x2, 1);
					$Form_Imputs->form_date('Fecha inicio Contrato','Contrato_Fecha', $x3, 1);
					$Form_Imputs->form_select_n_auto('Duracion Contrato(Meses)','Contrato_Duracion', $x4, 1, 1, 72);	
