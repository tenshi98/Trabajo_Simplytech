...
/*******************************************************************************************************************/		
		case 'insert':
			...
			if ( empty($error) ) {
				...
				//filtros
				if(isset($idUsuario_observado) && $idUsuario_observado != ''){  $a = "'".$idUsuario_observado."'" ;   }else{$a ="''";}
...
/*******************************************************************************************************************/		
		case 'update':	
			...
			if ( empty($error) ) {
				...
				if(isset($idUsuario_observado) && $idUsuario_observado != ''){   $a .= ",idUsuario_observado='".$idUsuario_observado."'" ;}
				...
				$resultado = db_update_data (false, $a, 'usuarios_observaciones', 'idObservacion = "'.$idObservacion.'"', $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
				//Si ejecuto correctamente la consulta
				if($resultado==true){
