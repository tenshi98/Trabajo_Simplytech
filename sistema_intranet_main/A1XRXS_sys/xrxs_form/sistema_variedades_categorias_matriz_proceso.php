...
/*******************************************************************************************************************/		
		case 'insert_matriz':
			...
			if ( empty($error) ) {
				...
				$query  = "INSERT INTO `sistema_variedades_categorias_matriz_proceso` (idCategoria, idMatriz, idProceso, idSistema) 
				VALUES (".$a.")";
				//Consulta
...
/*******************************************************************************************************************/		
		case 'update_matriz':	
			...
			if ( empty($error) ) {
				...
				$resultado = db_update_data (false, $a, 'sistema_variedades_categorias_matriz_proceso', 'idVarMatriz = "'.$idVarMatriz.'"', $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
				//Si ejecuto correctamente la consulta
				if($resultado==true){
