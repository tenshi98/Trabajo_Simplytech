...
/*******************************************************************************************************************/		
		case 'insert':
			...
			if(isset($Nombre)&&isset($idSistema)){
				$ndata_1 = db_select_nrows ('Nombre', 'bodegas_arriendos_listado', '', "Nombre='".$Nombre."' AND idSistema='".$idSistema."'", $dbConn);
			}
			...
			if ( empty($error) ) {
				...
				$query  = "INSERT INTO `bodegas_arriendos_listado` (idSistema, Nombre) VALUES ({$a} )";
				//Consulta
...
/*******************************************************************************************************************/		
		case 'update':	
			...
			if(isset($Nombre)&&isset($idSistema)&&isset($idBodega)){
				$ndata_1 = db_select_nrows ('Nombre', 'bodegas_arriendos_listado', '', "Nombre='".$Nombre."' AND idSistema='".$idSistema."' AND idBodega!='".$idBodega."'", $dbConn);
			}
			//generacion de errores
			if($ndata_1 > 0) {$error['ndata_1'] = 'error/El nombre de la bodega ya existe';}
			/*******************************************************************/
			...
			if ( empty($error) ) {
				...
				// inserto los datos de registro en la db
				$query  = "UPDATE `bodegas_arriendos_listado` SET ".$a." WHERE idBodega = '$idBodega'";
				//Consulta
				$resultado = mysqli_query ($dbConn, $query);
				//Si ejecuto correctamente la consulta
				if($resultado){
...
/*******************************************************************************************************************/
		case 'del_img':	
			...
			$rowdata = db_select_data ('Direccion_img', 'bodegas_arriendos_listado', '', "idBodega = ".$_GET['del_img'], $dbConn);

			//se borra el dato de la base de datos
			$query  = "UPDATE `bodegas_arriendos_listado` SET Direccion_img='' WHERE idBodega = '{$_GET['del_img']}'";
			//Consulta
			$resultado = mysqli_query ($dbConn, $query);
			//Si ejecuto correctamente la consulta
			if($resultado){
...
/*******************************************************************************************************************/
		case 'del_file':	
			...
			// Se obtiene el nombre del logo
			$rowdata = db_select_data ('FichaTecnica', 'bodegas_arriendos_listado', '', "idBodega = ".$_GET['del_file'], $dbConn);

			//se borra el dato de la base de datos
			$query  = "UPDATE `bodegas_arriendos_listado` SET FichaTecnica='' WHERE idBodega = '{$_GET['del_file']}'";
			//Consulta
			$resultado = mysqli_query ($dbConn, $query);
			//Si ejecuto correctamente la consulta
			if($resultado){
...
/*******************************************************************************************************************/
		case 'del':	
			...
			// Se obtiene el nombre del logo
			$rowdata = db_select_data ('Direccion_img, FichaTecnica', 'bodegas_arriendos_listado', '', "idBodega = ".$_GET['del'], $dbConn);

			//se borra el dato de la base de datos
			$query  = "DELETE FROM `bodegas_arriendos_listado` WHERE idBodega = {$_GET['del']}";
			//Consulta
			$resultado = mysqli_query ($dbConn, $query);
			//Si ejecuto correctamente la consulta
			if($resultado){
