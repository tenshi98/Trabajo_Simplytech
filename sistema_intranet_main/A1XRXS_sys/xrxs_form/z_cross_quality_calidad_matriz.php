	...
	switch ($form_trabajo) {
		...
		case 'insert_matriz':	
			...
			if ( empty($error) ) {
				...
				$query  = "INSERT INTO `cross_quality_calidad_matriz` (Nombre, cantPuntos, idTipo, idEstado,
...
/*******************************************************************************************************************/
		case 'clone_Matriz':
			...
			if ( empty($error) ) {
				...
				// inserto los datos de registro en la db
				$query  = "INSERT INTO `cross_quality_calidad_matriz` (cantPuntos,idTipo,idSistema, idEstado, Nombre,
