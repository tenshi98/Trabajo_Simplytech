...
/*******************************************************************************************************************/		
		case 'new_ingreso':
			...
			if ( empty($error) ) {
				...
				if(isset($Creacion_fecha)&&$Creacion_fecha!=''){  $_SESSION['cross_quality_ana_cali_basicos']['Creacion_fecha']  = $Creacion_fecha;  }else{$_SESSION['cross_quality_ana_cali_basicos']['Creacion_fecha']  = '';}
				if(isset($idTipo)&&$idTipo!=''){                  $_SESSION['cross_quality_ana_cali_basicos']['idTipo']          = $idTipo;          }else{$_SESSION['cross_quality_ana_cali_basicos']['idTipo']          = '';}
				if(isset($Temporada)&&$Temporada!=''){            $_SESSION['cross_quality_ana_cali_basicos']['Temporada']       = $Temporada;       }else{$_SESSION['cross_quality_ana_cali_basicos']['Temporada']       = '';}
				if(isset($idCategoria)&&$idCategoria!=''){        $_SESSION['cross_quality_ana_cali_basicos']['idCategoria']     = $idCategoria;     }else{$_SESSION['cross_quality_ana_cali_basicos']['idCategoria']     = '';}
				if(isset($idProducto)&&$idProducto!=''){          $_SESSION['cross_quality_ana_cali_basicos']['idProducto']      = $idProducto;      }else{$_SESSION['cross_quality_ana_cali_basicos']['idProducto']      = '';}
				if(isset($idUbicacion)&&$idUbicacion!=''){        $_SESSION['cross_quality_ana_cali_basicos']['idUbicacion']     = $idUbicacion;     }else{$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion']     = '';}
				if(isset($Observaciones)&&$Observaciones!=''){    $_SESSION['cross_quality_ana_cali_basicos']['Observaciones']   = $Observaciones;   }else{$_SESSION['cross_quality_ana_cali_basicos']['Observaciones']   = '';}
				if(isset($idSistema)&&$idSistema!=''){            $_SESSION['cross_quality_ana_cali_basicos']['idSistema']       = $idSistema;       }else{$_SESSION['cross_quality_ana_cali_basicos']['idSistema']       = '';}
				if(isset($idUsuario)&&$idUsuario!=''){            $_SESSION['cross_quality_ana_cali_basicos']['idUsuario']       = $idUsuario;       }else{$_SESSION['cross_quality_ana_cali_basicos']['idUsuario']       = '';}
				if(isset($fecha_auto)&&$fecha_auto!=''){          $_SESSION['cross_quality_ana_cali_basicos']['fecha_auto']      = $fecha_auto;      }else{$_SESSION['cross_quality_ana_cali_basicos']['fecha_auto']      = '';}
				
				if(isset($idUbicacion_lvl_1)&&$idUbicacion_lvl_1!=''){$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_1']    = $idUbicacion_lvl_1;}
				if(isset($idUbicacion_lvl_2)&&$idUbicacion_lvl_2!=''){$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_2']    = $idUbicacion_lvl_2;}
				if(isset($idUbicacion_lvl_3)&&$idUbicacion_lvl_3!=''){$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_3']    = $idUbicacion_lvl_3;}
				if(isset($idUbicacion_lvl_4)&&$idUbicacion_lvl_4!=''){$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_4']    = $idUbicacion_lvl_4;}
				if(isset($idUbicacion_lvl_5)&&$idUbicacion_lvl_5!=''){$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_5']    = $idUbicacion_lvl_5;}
				
				/********************************************************************************/
				if(isset($idTipo) && $idTipo != ''){ 
					$rowTipo = db_select_data (false, 'Nombre', 'core_cross_quality_analisis_calidad', '', 'idTipo ='.$idTipo, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
					//se guarda dato
					$_SESSION['cross_quality_ana_cali_basicos']['Tipo'] = $rowTipo['Nombre'];
				}else{
				...
				if(isset($idProducto) && $idProducto != ''){ 
					...
					$_SESSION['cross_quality_ana_cali_basicos']['ProductoPuntos']  = $rowProducto['cantPuntos'];
					$_SESSION['cross_quality_ana_cali_basicos']['ProductoCalidad'] = $rowProducto['idCalidad'];
				}else{
					$_SESSION['cross_quality_ana_cali_basicos']['ProductoNombre']  = '';
					$_SESSION['cross_quality_ana_cali_basicos']['ProductoPuntos']  = '';
				...
				if(isset($idUbicacion_lvl_5) && $idUbicacion_lvl_5 != ''){ 
					...
					$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_5'] = '';
				}
...
/*******************************************************************************************************************/		
		case 'addTrab':
			...
			$_SESSION['cross_quality_ana_cali_trabajadores'][$idTrabajador]['idTrabajador']  = $idTrabajador;
			$_SESSION['cross_quality_ana_cali_trabajadores'][$idTrabajador]['Nombre']        = $rowTrabajadores['Nombre'].' '.$rowTrabajadores['ApellidoPat'].' '.$rowTrabajadores['ApellidoMat'];
			$_SESSION['cross_quality_ana_cali_trabajadores'][$idTrabajador]['Cargo']         = $rowTrabajadores['Cargo'];
			$_SESSION['cross_quality_ana_cali_trabajadores'][$idTrabajador]['Rut']           = $rowTrabajadores['Rut'];
...
/*******************************************************************************************************************/		
		case 'del_trab':
			...
			//Borro todas las sesiones
			unset($_SESSION['cross_quality_ana_cali_trabajadores'][$_GET['del_trab']]);
...
/*******************************************************************************************************************/		
		case 'addMaq':
			...
			//Se guarda el trabajador asignado
			$_SESSION['cross_quality_ana_cali_maquinas'][$idMaquina]['idMaquina']     = $idMaquina;
			$_SESSION['cross_quality_ana_cali_maquinas'][$idMaquina]['Nombre']        = $rowMaquina['Nombre'];
...
/*******************************************************************************************************************/		
		case 'del_maq':
			...
			//Borro todas las sesiones
			unset($_SESSION['cross_quality_ana_cali_maquinas'][$_GET['del_maq']]);
...
/*******************************************************************************************************************/		
		case 'new_file_ing':
			...
			if(isset($_SESSION['cross_quality_ana_cali_archivos'])){
				foreach ($_SESSION['cross_quality_ana_cali_archivos'] as $key => $trabajos){
						...
						if (in_array($_FILES['exFile']['type'], $permitidos) && $_FILES['exFile']['size'] <= $limite_kb * 1024){
							...
							if (!file_exists($ruta)){
								...
								if ($move_result){
									...
									$_SESSION['cross_quality_ana_cali_archivos'][$idInterno]['idFile'] = $idInterno;
									$_SESSION['cross_quality_ana_cali_archivos'][$idInterno]['Nombre'] = $sufijo.$_FILES['exFile']['name'];
...
/*******************************************************************************************************************/
		case 'del_file_ing':	
			...
			try {
				if(!is_writable('upload/'.$_SESSION['cross_quality_ana_cali_archivos'][$_GET['del_file']]['Nombre'])){
					//throw new Exception('File not writable');
				}else{
					unlink('upload/'.$_SESSION['cross_quality_ana_cali_archivos'][$_GET['del_file']]['Nombre']);
					unset($_SESSION['cross_quality_ana_cali_archivos'][$_GET['del_file']]);
				}
			}catch(Exception $e) { 
					//guardar el dato en un archivo log
			}
...
/*******************************************************************************************************************/		
		case 'new_muestra':
			...
			if(isset($_SESSION['cross_quality_ana_cali_muestras'])){
				foreach ($_SESSION['cross_quality_ana_cali_muestras'] as $key => $trabajos){
			...
			if ( empty($error) ) {
				...
				$idInterno = $idInterno+1;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['idMuestra']       = $idInterno;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['idProductor']     = $idProductor;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['ProductorNombre'] = $rowProductor['Nombre'];
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['n_folio_pallet']  = $n_folio_pallet;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['idTipo']          = $idTipo;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['lote']            = $lote;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['f_embalaje']      = $f_embalaje;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['f_cosecha']       = $f_cosecha;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['H_inspeccion']    = $H_inspeccion;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['cantidad']        = $cantidad;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['peso']            = $peso;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['Resolucion_1']    = $Resolucion_1;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['Resolucion_2']    = $Resolucion_2;
				$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['Resolucion_3']    = $Resolucion_3;
				
				for ($i = 1; $i <= 100; $i++) {
					if(isset($Medida[$i])){
						$_SESSION['cross_quality_ana_cali_muestras'][$idInterno]['Medida_'.$i]   = $Medida[$i];
					}
				}
...
/*******************************************************************************************************************/		
		case 'edit_muestra':
			...
			if ( empty($error) ) {
				...
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['idProductor']       = $idProductor;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['ProductorNombre']   = $rowProductor['Nombre'];
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['n_folio_pallet']    = $n_folio_pallet;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['idTipo']            = $idTipo;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['lote']              = $lote;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['f_embalaje']        = $f_embalaje;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['f_cosecha']         = $f_cosecha;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['H_inspeccion']      = $H_inspeccion;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['cantidad']          = $cantidad;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['peso']              = $peso;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['Resolucion_1']      = $Resolucion_1;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['Resolucion_2']      = $Resolucion_2;
				$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['Resolucion_3']      = $Resolucion_3;
				
				for ($i = 1; $i <= 100; $i++) {
					if(isset($Medida[$i])){
						$_SESSION['cross_quality_ana_cali_muestras'][$oldidProducto]['Medida_'.$i]   = $Medida[$i];
					}
				}
...
/*******************************************************************************************************************/
		case 'del_muestra':	
			...
			unset($_SESSION['cross_quality_ana_cali_muestras'][$_GET['del_muestra']]);
...
/*******************************************************************************************************************/		
		case 'ing_Doc':
			...
			if (isset($_SESSION['cross_quality_ana_cali_basicos'])){
				...
				if(!isset($_SESSION['cross_quality_ana_cali_basicos']['idProducto']) OR $_SESSION['cross_quality_ana_cali_basicos']['idProducto']=='' ){         $error['idProducto']       = 'error/No ha seleccionado el producto';}
				if(!isset($_SESSION['cross_quality_ana_cali_basicos']['idUbicacion']) OR $_SESSION['cross_quality_ana_cali_basicos']['idUbicacion']=='' ){       $error['idUbicacion']      = 'error/No ha seleccionado la ubicacion';}
...
/*******************************************************************************************************************/		
		case 'modBase_edit':
			...
			if ( empty($error) ) {
				...
				// inserto los datos de registro en la db
				$query  = "UPDATE `cross_quality_analisis_calidad` SET ".$a." WHERE idAnalisis = '$idAnalisis'";
				//Consulta
				$resultado = mysqli_query ($dbConn, $query);
				//Si ejecuto correctamente la consulta
				if($resultado){
...
/*******************************************************************************************************************/		
		case 'addTrab_edit':
			...
			if(isset($idAnalisis)&&isset($idTrabajador)){
				$ndata_1 = db_select_nrows (false, 'idTrabajador', 'cross_quality_analisis_calidad_trabajador', '', "idAnalisis='".$idAnalisis."' AND idTrabajador='".$idTrabajador."'", $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
			}
			//generacion de errores
...
/*******************************************************************************************************************/		
		case 'del_trab_edit':
			...
			if($errorn==0){
				//se borran los datos
				$resultado = db_delete_data (false, 'cross_quality_analisis_calidad_trabajador', 'idTrabajadores = "'.$indice.'"', $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
				//Si ejecuto correctamente la consulta
				if($resultado==true){
...
/*******************************************************************************************************************/		
		case 'addMaq_edit':
			...
			if(isset($idAnalisis)&&isset($idMaquina)){
				$ndata_1 = db_select_nrows (false, 'idMaquina', 'cross_quality_analisis_calidad_maquina', '', "idAnalisis='".$idAnalisis."' AND idMaquina='".$idMaquina."'", $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
			}
			//generacion de errores
...
/*******************************************************************************************************************/		
		case 'del_maq_edit':
			...
			if($errorn==0){
				//se borran los datos
				$resultado = db_delete_data (false, 'cross_quality_analisis_calidad_maquina', 'idMaquinas = "'.$indice.'"', $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
				//Si ejecuto correctamente la consulta
				if($resultado==true){
...
/*******************************************************************************************************************/
		case 'del_file_ing_edit':	
			...
			if($errorn==0){
				...
				//se borran los datos
				$resultado = db_delete_data (false, 'cross_quality_analisis_calidad_archivo', 'idArchivo = "'.$indice.'"', $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
				//Si ejecuto correctamente la consulta
				if($resultado==true){
...
/*******************************************************************************************************************/		
		case 'edit_muestra_edit':
			...
			if ( empty($error) ) {
				...
				// inserto los datos de registro en la db
				$query  = "UPDATE `cross_quality_analisis_calidad_muestras` SET ".$a." WHERE idMuestras = '$idMuestras'";
				//Consulta
				$resultado = mysqli_query ($dbConn, $query);
				//Si ejecuto correctamente la consulta
				if($resultado){
...
/*******************************************************************************************************************/
		case 'del_muestra_edit':	
			...
			if($errorn==0){
				//se borran los datos
				$resultado = db_delete_data (false, 'cross_quality_analisis_calidad_muestras', 'idMuestras = "'.$indice.'"', $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
				//Si ejecuto correctamente la consulta
				if($resultado==true){
