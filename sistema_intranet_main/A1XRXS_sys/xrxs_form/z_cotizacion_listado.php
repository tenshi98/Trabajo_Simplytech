...
/*******************************************************************************************************************/		
		case 'new_cotizacion':
			...
			if ( empty($error) ) {
				...
				$_SESSION['cotizacion_basicos']['idSistema']       = $idSistema;
				$_SESSION['cotizacion_basicos']['idUsuario']       = $idUsuario;
				$_SESSION['cotizacion_basicos']['Creacion_fecha']  = $Creacion_fecha;
				$_SESSION['cotizacion_basicos']['Observaciones']   = $Observaciones;
				$_SESSION['cotizacion_basicos']['idCliente']       = $idCliente;
				$_SESSION['cotizacion_basicos']['fecha_auto']      = $fecha_auto;
...
/*******************************************************************************************************************/		
		case 'add_obs_cotizacion':
			...
			if ( empty($error) ) {
				//Datos a actualizar
				$_SESSION['cotizacion_basicos']['Observaciones'] = $Observacion;
...
/*******************************************************************************************************************/		
		case 'del_obs_cotizacion':
			...
			$_SESSION['cotizacion_temporal'] = $_SESSION['cotizacion_basicos']['Observaciones'];
			$_SESSION['cotizacion_basicos']['Observaciones'] = '';
