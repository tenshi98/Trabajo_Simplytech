...
/*******************************************************************************************************************/		
		case 'insert':
			...
			if(isset($Nombre)&&isset($idSistema)){
				$ndata_1 = db_select_nrows ('Nombre', 'proveedor_listado', '', "Nombre='".$Nombre."' AND idSistema='".$idSistema."'", $dbConn);
			}
			if(isset($Rut)&&isset($idSistema)){
				$ndata_2 = db_select_nrows ('Rut', 'proveedor_listado', '', "Rut='".$Rut."' AND idSistema='".$idSistema."'", $dbConn);
			}
			if(isset($email)&&isset($idSistema)){
				$ndata_3 = db_select_nrows ('email', 'proveedor_listado', '', "email='".$email."' AND idSistema='".$idSistema."'", $dbConn);
			}
...
/*******************************************************************************************************************/		
		case 'update':	
			...
			if(isset($Nombre)&&isset($idSistema)&&isset($idProveedor)){
				$ndata_1 = db_select_nrows ('Nombre', 'proveedor_listado', '', "Nombre='".$Nombre."' AND idSistema='".$idSistema."' AND idProveedor!='".$idProveedor."'", $dbConn);
			}
			if(isset($Rut)&&isset($idSistema)&&isset($idProveedor)){
				$ndata_2 = db_select_nrows ('Rut', 'proveedor_listado', '', "Rut='".$Rut."' AND idSistema='".$idSistema."' AND idProveedor!='".$idProveedor."'", $dbConn);
			}
			if(isset($email)&&isset($idSistema)&&isset($idProveedor)){
				$ndata_3 = db_select_nrows ('email', 'proveedor_listado', '', "email='".$email."' AND idSistema='".$idSistema."' AND idProveedor!='".$idProveedor."'", $dbConn);
			}
			//generacion de errores
			if($ndata_1 > 0) {$error['ndata_1'] = 'error/El nombre ingresado ya existe en el sistema';}
			if($ndata_2 > 0) {$error['ndata_2'] = 'error/El Rut ya existe en el sistema';}
