...
if(!empty($_GET['edit'])){
	...
	$rowData = db_select_data (false, $SIS_query, 'comunicaciones_streaming_listado_usuarios', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
	/*******************************************************/
