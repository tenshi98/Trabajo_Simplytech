		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['arriendos_egr_nc_productos'][$_GET['editProd']]['ValorIngreso']));
					$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x4, 2);
					$Form_Inputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['arriendos_egr_nc_productos'][$_GET['editProd']]['ValorIngreso']), 2);
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['arriendos_egr_nc_otros'][$_GET['editOtros']]['idOtros'], 2);
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idDocumentos = '.$_SESSION['arriendos_egr_nc_basicos']['idDocumentos'];
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idTipo = '.$_SESSION['arriendos_egr_nc_basicos']['idTipo'];
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idCliente = '.$_SESSION['arriendos_egr_nc_basicos']['idCliente'];
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idBodega = '.$_SESSION['arriendos_egr_nc_basicos']['idBodega'];
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<table id="meta" class="pull-left otdata">
					<tbody>
						...
						<tr>
							...
							<td><?php echo $rowDocumento['Nombre'].' N°'.n_doc($_SESSION['arriendos_egr_nc_basicos']['N_Doc'], 8); ?></td>
						</tr>
						<tr>
		...
		<div class="col-xs-12">
			<div class="row">
				...
				<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['arriendos_egr_nc_basicos']['Observaciones']; ?></p>
			</div>
		</div>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = "bodegas_arriendos_facturacion.idTipo=13";//Solo egresos
		...
		<div class="well">
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
				<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_select_join_filter('Bodega destino','idBodega', $x6, 1, 'idBodega', 'Nombre', 'bodegas_arriendos_listado', 'usuarios_bodegas_arriendos', $v, $dbConn);
