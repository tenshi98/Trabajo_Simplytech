...
$original = "informe_backup_telemetria_errores_6.php";
$location = $original;
/********************************************************************/
//Variables para filtro y paginacion
$search  = '?pagina='.$_GET['pagina'];
...
if ( !empty($_GET['idErrores']) )     {
	...
	require_once 'A1XRXS_sys/xrxs_form/backup_telemetria_listado_errores.php';	
}
//se borra un dato
if ( !empty($_GET['all']) )     {
	//Llamamos al formulario
...
if(isset($_GET['idLeido'])&&$_GET['idLeido']!=''){
	$z.=" AND backup_telemetria_listado_errores.idLeido='".$_GET['idLeido']."'";
}
...
<div class="col-sm-12 clearfix">		
	<a target="new" href="<?php echo 'informe_backup_telemetria_errores_6_to_excel.php'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
	<a target="new" href="<?php echo 'informe_backup_telemetria_errores_6_to_pdf.php'.$search ; ?>"   class="btn btn-sm btn-metis-3 pull-right margin_width"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar a PDF</a>
</div>
