...
if(isset($_GET['idLeido'])&&$_GET['idLeido']!=''){
	$SIS_where.= " AND backup_telemetria_listado_errores.idLeido='".$_GET['idLeido']."'";
}
						...
						<tr>
							...
							<td>
								<div class="btn-group" style="width: 105px;" >
									<a href="<?php echo 'informe_backup_telemetria_errores_6_view.php?view='.simpleEncode($error['idErrores'], fecha_actual()); ?>" title="Ver Ubicación" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a>
