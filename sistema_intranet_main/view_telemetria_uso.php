										...
										<tr class="odd">
											...
											<td>
												<div class="btn-group" style="width: 105px;" >
													<?php if ($rowlevel['level']>=1&&$fecha==''){?><a href="<?php echo 'view_telemetria_historial.php?view='.simpleEncode($con['idTelemetria'], fecha_actual()).'&dia='.simpleEncode($fecha, fecha_actual()).'&return=true'; ?>" title="Ver Informacion" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
