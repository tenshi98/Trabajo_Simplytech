...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'fprog_asc':        $order_by = 'cross_solicitud_aplicacion_listado.f_programacion ASC ';                      $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Solicitud Ascendente';break;
		case 'fprog_desc':       $order_by = 'cross_solicitud_aplicacion_listado.f_programacion DESC ';                     $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Solicitud Descendente';break;
		...
		case 'feje_asc':         $order_by = 'cross_solicitud_aplicacion_listado.f_ejecucion ASC ';                         $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Programacion Ascendente'; break;
		case 'feje_desc':        $order_by = 'cross_solicitud_aplicacion_listado.f_ejecucion DESC ';                        $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Programacion Descendente';break;
		...
		case 'fcierre_asc':      $order_by = 'cross_solicitud_aplicacion_listado.f_termino ASC ';                           $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Cierre Ascendente'; break;
		case 'fcierre_desc':     $order_by = 'cross_solicitud_aplicacion_listado.f_termino DESC ';                          $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Cierre Descendente';break;
