...
if (isset($_GET['created'])){ $error['created'] = 'sucess/Subcuenta Creada correctamente';}
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Subcuenta Modificada correctamente';}
if (isset($_GET['deleted'])){ $error['deleted'] = 'sucess/Subcuenta Borrada correctamente';}
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/*******************************************************/
	// consulto los datos
	$SIS_query = 'idSubcuenta, Nombre,Usuario, Password, email';
	$SIS_join  = '';
	$SIS_where = 'idApoderado = '.$_GET['id'];
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 105px;" >
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&edit='.$sub['idSubcuenta']; ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
