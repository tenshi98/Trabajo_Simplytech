...
$original = "cross_shipping_puerto_destino.php";
$location = $original;
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/cross_shipping_puerto_destino.php';
}
...
if(!empty($_GET['id'])){
	...
	$SIS_join  = '';
	$SIS_where = 'idPuertoDestino = '.$_GET['id'];
	$rowData = db_select_data (false, $SIS_query, 'cross_shipping_puerto_destino', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('idPuertoDestino', $_GET['id'], 2);
					?>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){  $SIS_where .= " AND cross_shipping_puerto_destino.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
	if(isset($_GET['Codigo']) && $_GET['Codigo']!=''){  $SIS_where .= " AND cross_shipping_puerto_destino.Codigo LIKE '%".EstandarizarInput($_GET['Codigo'])."%'";}
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 70px;" >
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $location.'&id='.$cat['idPuertoDestino']; ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
									<?php if ($rowlevel['level']>=4){
										$ubicacion = $location.'&del='.simpleEncode($cat['idPuertoDestino'], fecha_actual());
