	...
	<div class="box noborderbox">
		<header class="header">
			<ul class="nav nav-tabs nav-center">
				...
				<?php if($Tab_1!=0){ ?><li class="active"> <a href="principal_6_1.php"><?php echo $arrOrderTabMenu[1]; ?></a></li><?php } ?>
		...
		<div class="tab-content">
			...
			<div class="">
				<div class="box noborderbox">
					<header class="header">
						<ul class="nav nav-tabs nav-center">
							<li class="active"><a href="#gestion"   aria-controls="gestion"   role="tab" data-toggle="tab"><i class="fa fa-truck" aria-hidden="true"></i> Gestion de Flota</a></li>
							<li>               <a href="#online"    aria-controls="online"    role="tab" data-toggle="tab"><i class="fa fa-toggle-on" aria-hidden="true"></i> Tiempo Real</a></li>
							<li>               <a href="#solicitud" aria-controls="solicitud" role="tab" data-toggle="tab"><i class="fa fa-check-square-o" aria-hidden="true"></i> Solicitud Finalizada</a></li>
							<li>               <a href="#estado"    aria-controls="estado"    role="tab" data-toggle="tab"><i class="fa fa-map-pin" aria-hidden="true"></i> Seguimiento Cuarteles</a></li>
							<li>               <a href="#resumen"   aria-controls="resumen"   role="tab" data-toggle="tab"><i class="fa fa-file-text" aria-hidden="true"></i> Resumen</a></li>
						</ul>
					</header>
					<div class="tab-content">
						...
						<?php
							...
							//contenido en tabs
							include '1include_principal_interfaz_6_1_tab_1.php';
							include '1include_principal_interfaz_6_1_tab_2.php';
							include '1include_principal_interfaz_6_1_tab_3.php';
							include '1include_principal_interfaz_6_1_tab_4.php';
							include '1include_principal_interfaz_6_1_tab_5.php';
