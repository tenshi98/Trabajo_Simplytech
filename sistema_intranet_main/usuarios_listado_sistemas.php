...
(SELECT COUNT(idPermisoSistema) FROM usuarios_sistemas WHERE idSistema = core_sistemas.idSistema AND idUsuario = {$_GET['id']} LIMIT 1) AS contar,
(SELECT idPermisoSistema FROM usuarios_sistemas WHERE idSistema = core_sistemas.idSistema AND idUsuario = {$_GET['id']} LIMIT 1) AS idpermiso
FROM `core_sistemas`
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Permisos de acceso a Sistemas</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li class="active"><a href="<?php echo 'usuarios_listado_sistemas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Acceso Sistemas</a></li>
        ...
        <div class="table-responsive">
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				<thead>
					...
					<tr role="row">
						<th <?php if($_SESSION['usuario']['basic_data']['idTipoUsuario']==1){echo 'colspan="2"';}else{echo 'colspan="3"';} ?>><input class="form-control" id="InputTableFilter" type="text" placeholder="Filtrar.."></th>
					</tr>
				</thead>
						...
						<td>
							<div class="btn-group" style="width: 100px;" id="toggle_event_editing">	
								<?php if ( isset($equipos['contar'])&&$equipos['contar']!='0' ) {?>    
									<a title="Quitar Permiso" class="btn btn-sm btn-default unlocked_inactive tooltip" href="<?php echo $new_location.'&id='.$_GET['id'].'&sistema_del='.$equipos['idpermiso']; ?>">OFF</a>
