...
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Colegio Modificado correctamente';}
...
if(!empty($_GET['id'])){
	...
	$SIS_where = 'colegios_listado.idColegio = '.$_GET['id'];
	$rowdata = db_select_data (false, $SIS_query, 'colegios_listado', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowdata');
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_select_depend1('Región','idCiudad', $x2, 1, 'idCiudad', 'Nombre', 'core_ubicacion_ciudad', 0, 0,
											...
											$dbConn, 'form1');
					$Form_Inputs->form_input_icon('Dirección', 'Direccion', $x4, 1,'fa fa-map');
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){       $SIS_where .= " AND colegios_listado.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
	...
	if(isset($_GET['Direccion']) && $_GET['Direccion']!=''){ $SIS_where .= " AND colegios_listado.Direccion LIKE '%".EstandarizarInput($_GET['Direccion'])."%'";}
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb-bar">
		...
		<?php if ($rowlevel['level']>=3){ ?><a href="<?php echo $location; ?>&new=true" class="btn btn-default pull-right margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Colegio</a><?php } ?>
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 105px;" >
									<?php if ($rowlevel['level']>=1){ ?><a href="<?php echo 'view_colegio.php?view='.simpleEncode($usuarios['idColegio'], fecha_actual()); ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $location.'&id='.$usuarios['idColegio']; ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
