...
if(isset($_GET['idTelemetria'])&&$_GET['idTelemetria']!=''){
	...
	for ($i = 1; $i <= $total_files; $i++) { 
		...
		<div class="alert alert-info" role="alert">
			...
			<a target="new" href="informe_telemetria_registro_sensores_10_to_excel.php'.$datosx.'" class="btn btn-sm btn-metis-2 fright "><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
