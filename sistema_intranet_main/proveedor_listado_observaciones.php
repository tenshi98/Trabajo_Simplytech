...
$location = $original;
$new_location = "proveedor_listado_observaciones.php";
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/proveedor_observaciones.php';
}
...
LEFT JOIN `proveedor_listado`   ON proveedor_listado.idProveedor     = proveedor_observaciones.idProveedor
LEFT JOIN `usuarios_listado`    ON usuarios_listado.idUsuario      = proveedor_observaciones.idUsuario
WHERE proveedor_observaciones.idProveedor = {$_GET['id']}
ORDER BY proveedor_observaciones.idObservacion ASC ";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'proveedor_listado_observaciones.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Observaciones</a></li>
					</ul>
                </li>           
			</ul>	
		</header>
