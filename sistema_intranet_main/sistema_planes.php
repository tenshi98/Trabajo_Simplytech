...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){               $SIS_where .= " AND sistema_planes.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
	if(isset($_GET['Valor']) && $_GET['Valor']!=''){                 $SIS_where .= " AND sistema_planes.Valor LIKE '%".EstandarizarInput($_GET['Valor'])."%'";}
