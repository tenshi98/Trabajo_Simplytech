...
$location = $original;
$new_location = "apoderados_listado_password.php";
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						if(isset($rowdata['idOpciones_1'])&&$rowdata['idOpciones_1']==1){
							...
							<?php }else{ ?>
								<li class="active"><a href="<?php echo 'apoderados_listado_password.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Password</a></li>
							<?php } ?>
						<?php } ?>
