	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idTipo)) {          $x3  = $idTipo;          }else{$x3  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['cloneMuestra']]['idTipo'];}
				if(isset($lote)) {            $x4  = $lote;            }else{$x4  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['cloneMuestra']]['lote'];}
				if(isset($f_embalaje)) {      $x5  = $f_embalaje;      }else{$x5  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['cloneMuestra']]['f_embalaje'];}
				if(isset($f_cosecha)) {       $x6  = $f_cosecha;       }else{$x6  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['cloneMuestra']]['f_cosecha'];}
				if(isset($H_inspeccion)) {    $x7  = $H_inspeccion;    }else{$x7  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['cloneMuestra']]['H_inspeccion'];}
				if(isset($cantidad)) {        $x8  = $cantidad;        }else{$x8  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['cloneMuestra']]['cantidad'];}
				if(isset($peso)) {            $x9  = $peso;            }else{$x9  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['cloneMuestra']]['peso'];}
				...
				$Form_Imputs->form_input_number('N° Folio / Pallet', 'n_folio_pallet', $x2, 2);
				$Form_Imputs->form_select('Tipo Embalaje','idTipo', $x3, 2, 'idTipo', 'Nombre', 'sistema_cross_analisis_embalaje', $z, '', $dbConn);	
				$Form_Imputs->form_input_number('Lote', 'lote', $x4, 2);
						...
						for ($i = 1; $i <= $_GET['cantPuntos']; $i++) {
							if($grupo['idGrupo']==$rowdata['PuntoidGrupo_'.$i]){
								...
								switch ($rowdata['PuntoidTipo_'.$i]) {
									...
									case 1:
										$Form_Imputs->form_input_number($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, '', 2);
										break;
									...
									case 3:
										$Form_Imputs->form_input_number_integer($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, '', 2);
										break;
									...
									//Fecha
									case 5:
										$Form_Imputs->form_date($rowdata['PuntoNombre_'.$i],'Medida_'.$i, '', 2);
										break;
									//Hora
									case 6:
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idTipo)) {          $x3  = $idTipo;          }else{$x3  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['idTipo'];}
				if(isset($lote)) {            $x4  = $lote;            }else{$x4  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['lote'];}
				if(isset($f_embalaje)) {      $x5  = $f_embalaje;      }else{$x5  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['f_embalaje'];}
				if(isset($f_cosecha)) {       $x6  = $f_cosecha;       }else{$x6  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['f_cosecha'];}
				if(isset($H_inspeccion)) {    $x7  = $H_inspeccion;    }else{$x7  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['H_inspeccion'];}
				if(isset($cantidad)) {        $x8  = $cantidad;        }else{$x8  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['cantidad'];}
				if(isset($peso)) {            $x9  = $peso;            }else{$x9  = $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['peso'];}
				...
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['idMuestra'], 2);
						...
						for ($i = 1; $i <= $_GET['cantPuntos']; $i++) {
							if($grupo['idGrupo']==$rowdata['PuntoidGrupo_'.$i]){
								...
								switch ($rowdata['PuntoidTipo_'.$i]) {
									//Medicion (Decimal) con parametros limitantes
									case 1:
										$Form_Imputs->form_input_number($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 2);
										break;
									//Medicion (Decimal) sin parametros limitantes
									case 2:
										$Form_Imputs->form_input_number($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 2);
									...
									//Medicion (Enteros) con parametros limitantes
									case 3:
										$Form_Imputs->form_input_number_integer($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 2);
										break;
									//Medicion (Enteros) sin parametros limitantes
									case 4:
										$Form_Imputs->form_input_number_integer($rowdata['PuntoNombre_'.$i], 'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 2);
									...
									//Fecha
									case 5:
										$Form_Imputs->form_date($rowdata['PuntoNombre_'.$i],'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 2);
										break;
									//Hora
									case 6:
										$Form_Imputs->form_time_popover($rowdata['PuntoNombre_'.$i],'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 1, 1, 24);
										break;
									//Texto Libre
									case 7:
										$Form_Imputs->form_textarea($rowdata['PuntoNombre_'.$i],'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 1, 160);
										break;
									//Seleccion 1 a 3
									case 8:
										$Form_Imputs->form_select_n_auto($rowdata['PuntoNombre_'.$i],'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 1, 1, 3);
										break;
									//Seleccion 1 a 5
									case 9:
										$Form_Imputs->form_select_n_auto($rowdata['PuntoNombre_'.$i],'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 1, 1, 5);
										break;
									//Seleccion 1 a 10
									case 10:
										$Form_Imputs->form_select_n_auto($rowdata['PuntoNombre_'.$i],'Medida_'.$i, $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Medida_'.$i], 1, 1, 10);
										break;
				...
				//Verifico esta activo el dato 2
				if(isset($rowdata['idNota_2'])&&$rowdata['idNota_2']==1){
					echo print_select($rowdata['idNotaTipo_2'], 'Nota Condicion', 'Resolucion_2', $_SESSION['cross_quality_ana_cali_muestras'][$_GET['editMuestra']]['Resolucion_2']);
				}
				//Verifico esta activo el dato 3
				if(isset($rowdata['idNota_3'])&&$rowdata['idNota_3']==1){
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				//se dibujan los inputs
				$Form_Imputs = new Form_Inputs();
				$Form_Imputs->form_select_filter($x_column_maquina_sing,'idMaquina', $x1, 2, 'idMaquina', 'Nombre', 'maquinas_listado', $z, '', $dbConn);
				?>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($Temporada)) {           $x3  = $Temporada;         }else{$x3  = $_SESSION['cross_quality_ana_cali_basicos']['Temporada'];}
				if(isset($idCategoria)) {         $x4  = $idCategoria;       }else{$x4  = $_SESSION['cross_quality_ana_cali_basicos']['idCategoria'];}
				if(isset($idProducto)) {          $x5  = $idProducto;        }else{$x5  = $_SESSION['cross_quality_ana_cali_basicos']['idProducto'];}
				if(isset($idUbicacion)) {         $x6  = $idUbicacion;       }else{$x6  = $_SESSION['cross_quality_ana_cali_basicos']['idUbicacion'];}
				
				if(isset($_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_1'])&&$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_1']!=''){if(isset($idUbicacion_lvl_1)) {   $x7  = $idUbicacion_lvl_1; }else{$x7  = $_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_1'];}}else{$x7  = '';}
				if(isset($_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_2'])&&$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_2']!=''){if(isset($idUbicacion_lvl_2)) {   $x8  = $idUbicacion_lvl_2; }else{$x8  = $_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_2'];}}else{$x8  = '';}
				if(isset($_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_3'])&&$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_3']!=''){if(isset($idUbicacion_lvl_3)) {   $x9  = $idUbicacion_lvl_3; }else{$x9  = $_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_3'];}}else{$x9  = '';}
				if(isset($_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_4'])&&$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_4']!=''){if(isset($idUbicacion_lvl_4)) {   $x10 = $idUbicacion_lvl_4; }else{$x10 = $_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_4'];}}else{$x10 = '';}
				if(isset($_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_5'])&&$_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_5']!=''){if(isset($idUbicacion_lvl_5)) {   $x11 = $idUbicacion_lvl_5; }else{$x11 = $_SESSION['cross_quality_ana_cali_basicos']['idUbicacion_lvl_5'];}}else{$x11 = '';}
				...
				$Form_Imputs->form_select_depend1('Categoria','idCategoria', $x4, 2, 'idCategoria', 'Nombre', 'sistema_productos_categorias', 0, 0,
										 'Producto','idProducto', $x5, 2, 'idProducto', 'Nombre', 'productos_listado', 'idEstado=1 AND idCalidad!=0', 0, 
										 $dbConn, 'form1');
				$Form_Imputs->form_select_depend5($x_column_ubicacion, 'idUbicacion',  $x6,  2,  'idUbicacion',  'Nombre',  'ubicacion_listado',  'idEstado=1',   0,
...
<div class="col-sm-12 fcenter">
	...
	<div id="page-wrap">
		<div id="header"> <?php echo $_SESSION['cross_quality_ana_cali_basicos']['Tipo']; ?></div>
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $_SESSION['cross_quality_ana_cali_basicos']['Categoria'].' '.$_SESSION['cross_quality_ana_cali_basicos']['ProductoNombre']; ?></td>
					</tr>
					<tr>
						<td class="meta-head"><?php echo $x_column_ubicacion; ?></td>
						<td>
							<?php echo $_SESSION['cross_quality_ana_cali_basicos']['Ubicacion']; 
							if(isset($_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_1'])&&$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_1']!=''){echo ' - '.$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_1'];}
							if(isset($_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_2'])&&$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_2']!=''){echo ' - '.$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_2'];}
							if(isset($_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_3'])&&$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_3']!=''){echo ' - '.$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_3'];}
							if(isset($_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_4'])&&$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_4']!=''){echo ' - '.$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_4'];}
							if(isset($_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_5'])&&$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_5']!=''){echo ' - '.$_SESSION['cross_quality_ana_cali_basicos']['UbicacionLVL_5'];}
							?>
						</td>
					</tr>
				</tbody>
			...
			<table id="meta" class="otdata2">
				<tbody>
					<tr>
						...
						<td colspan="2"><?php echo Fecha_estandar($_SESSION['cross_quality_ana_cali_basicos']['Creacion_fecha']) ?></td>
					</tr>
					<tr>
						<td class="meta-head">Temporada</td>
						<td colspan="2"><?php echo $_SESSION['cross_quality_ana_cali_basicos']['Temporada'] ?></td>
					</tr>
		...
		<table id="items">
			<tbody>
				...
				<tr class="item-row fact_tittle">
					...
					<td>
						<a href="<?php echo $location.'&addMuestra=true&cantPuntos='.$_SESSION['cross_quality_ana_cali_basicos']['ProductoPuntos'].'&idCalidad='.$_SESSION['cross_quality_ana_cali_basicos']['ProductoCalidad'] ?>" title="Agregar Muestra" class="btn btn-xs btn-primary tooltip" style="position: initial;"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Muestra</a>
					</td>
				</tr>
				<tr class="item-row fact_tittle">
						...
						<tr class="item-row linea_punteada">
							...
							<td>
								<div class="btn-group" style="width: 105px;" >
									<a href="<?php echo $location.'&cloneMuestra='.$producto['idMuestra'].'&cantPuntos='.$_SESSION['cross_quality_ana_cali_basicos']['ProductoPuntos'].'&idCalidad='.$_SESSION['cross_quality_ana_cali_basicos']['ProductoCalidad']; ?>" title="Clonar Registro" class="btn btn-primary btn-sm tooltip"><i class="fa fa-files-o"></i></a>
									<a href="<?php echo $location.'&editMuestra='.$producto['idMuestra'].'&cantPuntos='.$_SESSION['cross_quality_ana_cali_basicos']['ProductoPuntos'].'&idCalidad='.$_SESSION['cross_quality_ana_cali_basicos']['ProductoCalidad']; ?>" title="Editar Registro" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a>
									<?php 
				...
				<tr>
					<?php if(isset($_SESSION['cross_quality_ana_cali_basicos']['Observaciones'])&&$_SESSION['cross_quality_ana_cali_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['cross_quality_ana_cali_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
							<div class="btn-group" style="width: 35px;" >
								<?php 
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['cross_quality_ana_cali_temporal'])&&$_SESSION['cross_quality_ana_cali_temporal']!=''){
								$non = $_SESSION['cross_quality_ana_cali_temporal'];
							}	
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_select_temporada_2('Temporada','Temporada', $x3, 2, ano_actual());
				$Form_Imputs->form_select_depend1('Categoria','idCategoria', $x4, 2, 'idCategoria', 'Nombre', 'sistema_productos_categorias', 0, 0,
										 'Producto','idProducto', $x5, 2, 'idProducto', 'Nombre', 'productos_listado', 'idEstado=1 AND idCalidad!=0 AND idOpciones_2=1', 0, 
										 $dbConn, 'form1');
				$Form_Imputs->form_select_depend5($x_column_ubicacion, 'idUbicacion',  $x6,  2,  'idUbicacion',  'Nombre',  'ubicacion_listado',  'idEstado=1',   0,
							                 $x_column_ubicacion_lvl_1, 'idUbicacion_lvl_1',  $x7,  1,  'idLevel_1',  'Nombre',  'ubicacion_listado_level_1',  0,   0, 
							                 $x_column_ubicacion_lvl_2, 'idUbicacion_lvl_2',  $x8,  1,  'idLevel_2',  'Nombre',  'ubicacion_listado_level_2',  0,   0,
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'fecha_asc':      $order_by = 'ORDER BY cross_quality_analisis_calidad.Creacion_fecha ASC ';                        $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ingreso Ascendente';break;
		case 'fecha_desc':     $order_by = 'ORDER BY cross_quality_analisis_calidad.Creacion_fecha DESC ';                       $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Ingreso Descendente';break;
		case 'temporada_asc':  $order_by = 'ORDER BY cross_quality_analisis_calidad.Temporada ASC ';                             $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Temporada Ascendente';break;
		case 'temporada_desc': $order_by = 'ORDER BY cross_quality_analisis_calidad.Temporada DESC ';                            $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Temporada Descendente';break;
		case 'producto_asc':   $order_by = 'ORDER BY sistema_productos_categorias.Nombre ASC, productos_listado.Nombre ASC ';    $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> '.$x_column_producto_nombre_sing.' Ascendente';break;
		case 'producto_desc':  $order_by = 'ORDER BY sistema_productos_categorias.Nombre DESC, productos_listado.Nombre DESC ';  $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> '.$x_column_producto_nombre_sing.' Descendente';break;
		...
		default: $order_by = 'ORDER BY cross_quality_analisis_calidad.Creacion_fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Ingreso Descendente';
	}
}else{
	$order_by = 'ORDER BY cross_quality_analisis_calidad.Creacion_fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Ingreso Descendente';
}
/**********************************************************/
//Variable con la ubicacion
$z="WHERE cross_quality_analisis_calidad.idAnalisis!=0";
//Verifico el tipo de usuario que esta ingresando
$z.=" AND cross_quality_analisis_calidad.idSistema={$_SESSION['usuario']['basic_data']['idSistema']}";	
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['Creacion_fecha']) && $_GET['Creacion_fecha'] != ''){        $z .= " AND cross_quality_analisis_calidad.Creacion_fecha='".$_GET['Creacion_fecha']."'";}
if(isset($_GET['idTipo']) && $_GET['idTipo'] != ''){                        $z .= " AND cross_quality_analisis_calidad.idTipo=".$_GET['idTipo'];}
if(isset($_GET['Temporada']) && $_GET['Temporada'] != ''){                  $z .= " AND cross_quality_analisis_calidad.Temporada=".$_GET['Temporada'];}
if(isset($_GET['idCategoria']) && $_GET['idCategoria'] != ''){              $z .= " AND cross_quality_analisis_calidad.idCategoria=".$_GET['idCategoria'];}
if(isset($_GET['idProducto']) && $_GET['idProducto'] != ''){                $z .= " AND cross_quality_analisis_calidad.idProducto=".$_GET['idProducto'];}
if(isset($_GET['idUbicacion']) && $_GET['idUbicacion'] != ''){              $z .= " AND cross_quality_analisis_calidad.idUbicacion=".$_GET['idUbicacion'];}
if(isset($_GET['idUbicacion_lvl_1']) && $_GET['idUbicacion_lvl_1'] != ''){  $z .= " AND cross_quality_analisis_calidad.idUbicacion_lvl_1=".$_GET['idUbicacion_lvl_1'];}
if(isset($_GET['idUbicacion_lvl_2']) && $_GET['idUbicacion_lvl_2'] != ''){  $z .= " AND cross_quality_analisis_calidad.idUbicacion_lvl_2=".$_GET['idUbicacion_lvl_2'];}
if(isset($_GET['idUbicacion_lvl_3']) && $_GET['idUbicacion_lvl_3'] != ''){  $z .= " AND cross_quality_analisis_calidad.idUbicacion_lvl_3=".$_GET['idUbicacion_lvl_3'];}
if(isset($_GET['idUbicacion_lvl_4']) && $_GET['idUbicacion_lvl_4'] != ''){  $z .= " AND cross_quality_analisis_calidad.idUbicacion_lvl_4=".$_GET['idUbicacion_lvl_4'];}
if(isset($_GET['idUbicacion_lvl_5']) && $_GET['idUbicacion_lvl_5'] != ''){  $z .= " AND cross_quality_analisis_calidad.idUbicacion_lvl_5=".$_GET['idUbicacion_lvl_5'];}
/**********************************************************/
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idAnalisis FROM `cross_quality_analisis_calidad` ".$z;
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				//se dibujan los inputs
				$Form_Imputs = new Form_Inputs();
				$Form_Imputs->form_date('Fecha Ingreso','Creacion_fecha', $x1, 1);
				$Form_Imputs->form_select('Tipo Planilla','idTipo', $x2, 1, 'idTipo', 'Nombre', 'core_cross_quality_analisis_calidad', 0, '', $dbConn);
				$Form_Imputs->form_select_temporada_2('Temporada','Temporada', $x3, 1, ano_actual());
				$Form_Imputs->form_select_depend1('Categoria','idCategoria', $x4, 1, 'idCategoria', 'Nombre', 'sistema_productos_categorias', 0, 0,
										 'Producto','idProducto', $x5, 1, 'idProducto', 'Nombre', 'productos_listado', 'idEstado=1 AND idCalidad!=0', 0, 
										 $dbConn, 'form1');
				$Form_Imputs->form_select_depend5($x_column_ubicacion, 'idUbicacion',  $x6,  1,  'idUbicacion',  'Nombre',  'ubicacion_listado',  'idEstado=1',   0,
											 $x_column_ubicacion_lvl_1, 'idUbicacion_lvl_1',  $x7,  1,  'idLevel_1',  'Nombre',  'ubicacion_listado_level_1',  0,   0, 
							                 $x_column_ubicacion_lvl_2, 'idUbicacion_lvl_2',  $x8,  1,  'idLevel_2',  'Nombre',  'ubicacion_listado_level_2',  0,   0,
							                 $x_column_ubicacion_lvl_3, 'idUbicacion_lvl_3',  $x9,  1,  'idLevel_3',  'Nombre',  'ubicacion_listado_level_3',  0,   0,
							                 $x_column_ubicacion_lvl_4, 'idUbicacion_lvl_4',  $x10,  1,  'idLevel_4',  'Nombre',  'ubicacion_listado_level_4',  0,   0,
...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Inspecciones</h5>
			<div class="toolbar">
				<?php 
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				<thead>
					<tr role="row">
						...
						<th>
							...
							<div class="btn-group pull-right" style="width: 50px;" >
								<a href="<?php echo $location.'&order_by=temporada_asc'; ?>" title="Ascendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-asc"></i></a>
								<a href="<?php echo $location.'&order_by=temporada_desc'; ?>" title="Descendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-desc"></i></a>
							</div>
						</th>
						<th>
						...
						<th>
							...
							<div class="btn-group pull-right" style="width: 50px;" >
								<a href="<?php echo $location.'&order_by=zona_asc'; ?>" title="Ascendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-asc"></i></a>
								<a href="<?php echo $location.'&order_by=zona_desc'; ?>" title="Descendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-desc"></i></a>
							</div>
						</th>
						<th>
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group" style="width: 70px;" >
								<?php if ($rowlevel['level']>=1){?><a href="<?php echo 'view_cross_quality_calidad_analisis.php?view='.$tipo['idAnalisis']; ?>" title="Ver Informacion" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list"></i></a><?php } ?>
								<?php if ($rowlevel['level']>=2){?><a href="<?php echo 'cross_quality_analisis_calidad_edit.php?edit='.$tipo['idAnalisis']; ?>" title="Editar Inspeccion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a><?php } ?>
							</div>
						</td>
					</tr>
					<?php } ?>                    
