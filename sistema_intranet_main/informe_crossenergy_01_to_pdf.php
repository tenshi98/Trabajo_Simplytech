...
if(isset($ndata_1)&&$ndata_1>=10001){
	...
	$arrEquipos = array();
	$arrEquipos = db_select_array (false, $SIS_query, 'telemetria_listado_crossenergy_dia', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], basename($_SERVER["REQUEST_URI"], ".php"), 'test_logo');
	...
	$pdf_file       = 'Informe Resumen Dia grupo '.$rowGrupo['Nombre'].' del equipo '.$rowEquipo['NombreEquipo'].'.pdf';
	$OpcDom         = "'A4', 'landscape'";
