	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Papel de Antecedentes</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'admin_trabajadores_listado_antecedentes.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Archivo - Antecedentes</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				...
				<?php }else{?>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
						...
						$Form_Imputs->form_multiple_upload('Seleccionar archivo','File_Antecedentes', 1, '"doc","docx","pdf","jpg", "png", "gif", "jpeg"');
