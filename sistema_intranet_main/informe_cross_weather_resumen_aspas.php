...
$original = "informe_cross_weather_resumen_aspas.php";
$location = $original;
...
$z = "WHERE telemetria_listado_tablarelacionada_".$idTelemetria.".idTabla!=0";
if(isset($_GET['f_inicio']) && $_GET['f_inicio'] != ''&&isset($_GET['f_termino']) && $_GET['f_termino'] != ''){ 
	$z.=" AND telemetria_listado_tablarelacionada_".$idTelemetria.".FechaSistema BETWEEN '".$_GET['f_inicio']."' AND '".$_GET['f_termino']."'";
}
...
".$z."
ORDER BY telemetria_listado_tablarelacionada_".$idTelemetria.".idTabla ASC
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
