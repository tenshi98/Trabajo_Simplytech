...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'fing_asc':         $order_by = 'bodegas_servicios_facturacion.Creacion_fecha ASC ';                        $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ingreso Ascendente';break;
		case 'fing_desc':        $order_by = 'bodegas_servicios_facturacion.Creacion_fecha DESC ';                       $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Ingreso Descendente';break;
		case 'fpag_asc':         $order_by = 'bodegas_servicios_facturacion.Pago_fecha ASC ';                            $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Pago Ascendente';break;
		case 'fpag_desc':        $order_by = 'bodegas_servicios_facturacion.Pago_fecha DESC ';                           $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Pago Descendente';break;
		case 'tipo_asc':         $order_by = 'bodegas_servicios_facturacion_tipo.Nombre ASC ';                           $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Tipo Movimiento Ascendente';break;
		case 'tipo_desc':        $order_by = 'bodegas_servicios_facturacion_tipo.Nombre DESC ';                          $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Tipo Movimiento Descendente';break;
	...
	$order_by = 'bodegas_servicios_facturacion.Pago_fecha ASC, proveedor_listado.Nombre ASC, bodegas_servicios_facturacion.N_Doc ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Pago, Proveedor, N° Doc Pago Ascendente';
}
/**********************************************************/
//Variable de busqueda
$SIS_where = "bodegas_servicios_facturacion.idFacturacion!=0";
//Verifico el tipo de usuario que esta ingresando
$SIS_where.= " AND bodegas_servicios_facturacion.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];

if(isset($_GET['idTipo'])&&$_GET['idTipo']!=''){     $SIS_where.= " AND bodegas_servicios_facturacion.idTipo=".$_GET['idTipo'];}
...
if(isset($_GET['N_Doc'])&&$_GET['N_Doc']!=''){       $SIS_where.= " AND bodegas_servicios_facturacion.N_Doc=".$_GET['N_Doc'];}
if(isset($_GET['idEstado'])&&$_GET['idEstado']!=''){ $SIS_where.= " AND bodegas_servicios_facturacion.idEstado=".$_GET['idEstado'];}
if(isset($_GET['idDocPago'])&&$_GET['idDocPago']!=''){      $SIS_where.= " AND bodegas_servicios_facturacion.idDocPago=".$_GET['idDocPago'];}
if(isset($_GET['N_DocPago'])&&$_GET['N_DocPago']!=''){      $SIS_where.= " AND bodegas_servicios_facturacion.N_DocPago=".$_GET['N_DocPago'];}

if(isset($_GET['f_creacion_inicio'], $_GET['f_creacion_termino'])&&$_GET['f_creacion_inicio']!=''&&$_GET['f_creacion_termino']!=''){
	$SIS_where.= " AND bodegas_servicios_facturacion.Creacion_fecha BETWEEN '".$_GET['f_creacion_inicio']."' AND '".$_GET['f_creacion_termino']."'";
}
if(isset($_GET['f_pago_inicio'], $_GET['f_pago_termino'])&&$_GET['f_pago_inicio']!=''&&$_GET['f_pago_termino']!=''){
	$SIS_where.= " AND bodegas_servicios_facturacion.Pago_fecha BETWEEN '".$_GET['f_pago_inicio']."' AND '".$_GET['f_pago_termino']."'";
}
if(isset($_GET['f_inicio_p'], $_GET['f_termino_p'])&&$_GET['f_inicio_p']!=''&&$_GET['f_termino_p']!=''){
