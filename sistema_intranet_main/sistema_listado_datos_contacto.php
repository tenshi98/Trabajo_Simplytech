	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'sistema_listado_datos_contacto.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos Contacto</a></li>
				<li class="dropdown">
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_input_icon( 'Nombre Contacto', 'Contacto_Nombre', $x1, 1,'fa fa-address-card-o');
					$Form_Imputs->form_input_phone('Fono 1', 'Contacto_Fono1', $x2, 1);
					$Form_Imputs->form_input_phone('Fono 2', 'Contacto_Fono2', $x3, 1);
					$Form_Imputs->form_input_fax('Fax', 'Contacto_Fax', $x4, 1);
					$Form_Imputs->form_input_icon( 'Web', 'Contacto_Web', $x5, 1,'fa fa-internet-explorer');
					$Form_Imputs->form_input_icon( 'Email', 'Contacto_Email', $x6, 1,'fa fa-envelope-o');
