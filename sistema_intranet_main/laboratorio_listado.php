...
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){             $SIS_where .= " AND laboratorio_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['Rut']) && $_GET['Rut'] != ''){                   $SIS_where .= " AND laboratorio_listado.Rut LIKE '%".$_GET['Rut']."%'";}
...
if(isset($_GET['Direccion']) && $_GET['Direccion'] != ''){       $SIS_where .= " AND laboratorio_listado.Direccion LIKE '%".$_GET['Direccion']."%'";}
if(isset($_GET['Giro']) && $_GET['Giro'] != ''){                 $SIS_where .= " AND laboratorio_listado.Giro LIKE '%".$_GET['Giro']."%'";}
