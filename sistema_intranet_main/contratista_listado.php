...
<div class="col-sm-8 fcenter">
	<div class="box dark">	
		...
		<div id="div-1" class="body" style="min-height:500px;">	
...
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){           $SIS_where .= " AND contratista_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['Rut']) && $_GET['Rut'] != ''){                 $SIS_where .= " AND contratista_listado.Rut LIKE '%".$_GET['Rut']."%'";}
...
if(isset($_GET['Direccion']) && $_GET['Direccion'] != ''){     $SIS_where .= " AND contratista_listado.Direccion LIKE '%".$_GET['Direccion']."%'";}
if(isset($_GET['Giro']) && $_GET['Giro'] != ''){               $SIS_where .= " AND contratista_listado.Giro LIKE '%".$_GET['Giro']."%'";}
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Contratista</a><?php }?>
