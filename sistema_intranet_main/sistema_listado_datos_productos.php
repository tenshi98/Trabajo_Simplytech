...
$location = $original;
$new_location = "sistema_listado_datos_productos.php";
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Productos Usados</span>
			</div>
		</div>
	</div>
</div>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if(isset($Count_productos)&&$Count_productos!=0){?>
							<li class="active"><a href="<?php echo 'sistema_listado_datos_productos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id'];?>" >Productos Usados</a></li>
						<?php } ?>
						...
						<td>
							<div class="btn-group" style="width: 100px;" id="toggle_event_editing">	
								<?php if ( isset($productos['contar'])&&$productos['contar']!='0' ) {?>    
									<a title="Quitar Permiso" class="btn btn-sm btn-default unlocked_inactive tooltip" href="<?php echo $new_location.'&id='.$_GET['id'].'&sis_prod_del='.$productos['idpermiso']; ?>">OFF</a>
								...
								<?php } else {?>
									...
									<a title="Dar Permiso" class="btn btn-sm btn-default unlocked_inactive tooltip" href="<?php echo $new_location.'&id='.$_GET['id'].'&sis_prod_add='.$productos['idProducto']; ?>">ON</a>
								<?php }?>    
							</div> 
						</td>
					</tr>
