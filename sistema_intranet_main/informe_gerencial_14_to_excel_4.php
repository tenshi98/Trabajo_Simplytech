...
//sololas del mismo sistema
$SIS_where_1.=" GROUP BY bodegas_arriendos_facturacion.idProveedor, bodegas_arriendos_facturacion.Creacion_mes";
$SIS_where_2.=" GROUP BY bodegas_insumos_facturacion.idProveedor, bodegas_insumos_facturacion.Creacion_mes";
$SIS_where_3.=" GROUP BY bodegas_productos_facturacion.idProveedor, bodegas_productos_facturacion.Creacion_mes";
$SIS_where_4.=" GROUP BY bodegas_servicios_facturacion.idProveedor, bodegas_servicios_facturacion.Creacion_mes";
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Compras Proveedor por mes');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Compras Proveedor por mes';
