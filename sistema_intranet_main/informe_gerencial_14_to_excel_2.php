...
//sololas del mismo sistema
$SIS_where_1.=" GROUP BY bodegas_arriendos_facturacion.idProveedor, bodegas_arriendos_facturacion.Creacion_Semana";
$SIS_where_2.=" GROUP BY bodegas_insumos_facturacion.idProveedor, bodegas_insumos_facturacion.Creacion_Semana";
$SIS_where_3.=" GROUP BY bodegas_productos_facturacion.idProveedor, bodegas_productos_facturacion.Creacion_Semana";
$SIS_where_4.=" GROUP BY bodegas_servicios_facturacion.idProveedor, bodegas_servicios_facturacion.Creacion_Semana";
...
$SIS_order = 'bodegas_arriendos_facturacion.Creacion_Semana DESC';
$arrTemporal_1 = array();
...
$SIS_order = 'bodegas_insumos_facturacion.Creacion_Semana DESC';
$arrTemporal_2 = array();
...
$SIS_order = 'bodegas_productos_facturacion.Creacion_Semana DESC';
$arrTemporal_3 = array();
...
$SIS_order = 'bodegas_servicios_facturacion.Creacion_Semana DESC';
$arrTemporal_4 = array();
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Compras Proveedor por semana');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Compras Proveedor por semana';
