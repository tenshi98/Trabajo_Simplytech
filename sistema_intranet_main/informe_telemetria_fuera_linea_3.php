...
$original = "informe_telemetria_fuera_linea_3.php";
$location = $original;
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
	...
	$search .= '&idSistema='.$_SESSION['usuario']['basic_data']['idSistema'];
	?>		
	<a target="new" href="<?php echo 'informe_telemetria_fuera_linea_3_to_excel.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
	<a target="new" href="<?php echo 'informe_telemetria_fuera_linea_3_to_pdf.php?bla=bla'.$search ; ?>"   class="btn btn-sm btn-metis-3 pull-right margin_width"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar a PDF</a>
</div>
