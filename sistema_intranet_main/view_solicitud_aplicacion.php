...
<div class="row no-print">
	<div class="col-xs-12">
		<a target="new" href="view_solicitud_aplicacion_to_print.php?view=<?php echo $_GET['view'] ?>" class="btn btn-default pull-right" style="margin-right: 5px;">
			<i class="fa fa-print" aria-hidden="true"></i> Imprimir
		</a>
		<a target="new" href="view_solicitud_aplicacion_to_pdf.php?view=<?php echo $_GET['view'].'&idSistema='.simpleEncode($_SESSION['usuario']['basic_data']['idSistema'], fecha_actual());  ?>" class="btn btn-primary pull-right" style="margin-right: 5px;">
