...
WHERE insumos_listado.idProducto='".$_SESSION['insumos_ing_manual_productos'][$_GET['editProd']]['idProducto']."'
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['insumos_ing_manual_productos'][$_GET['editProd']]['ValorIngreso']), 1);
...
$z="WHERE bodegas_insumos_facturacion.idTipo=9";//Solo ingresos manuales
//Verifico el tipo de usuario que esta ingresando
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select_filter('Mes Documento','Creacion_mes', $x4, 1, 'idMes', 'Nombre', 'core_tiempo_meses', 0, 'ORDER BY idMes ASC', $dbConn);
