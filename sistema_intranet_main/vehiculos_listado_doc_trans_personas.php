...
if ( !empty($_POST['submit_edit']) )  { 
	...
	$form_trabajo= 'submit_doc_cert_trans_personas';
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Certificado Transporte Personas</span>
			</div>
		</div>
	</div>
	
	<div class="col-md-6 col-sm-6 col-xs-12">
		<a target="_blank" rel="noopener noreferrer" href="http://apps.mtt.cl/consultaweb/" class="btn btn-default fright margin_width" ><i class="fa fa-search" aria-hidden="true"></i> Registro Nacional de Transporte Publico</a>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class=""><a href="<?php echo 'vehiculos_listado_doc_cert_trans_personas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Archivo - Seguro Carga</a></li>
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_doc_trans_personas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Archivo - Cert. Transporte Personas</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				...
				<?php if(isset($rowdata['doc_cert_trans_personas'])&&$rowdata['doc_cert_trans_personas']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						...
						<?php echo preview_docs('upload', $rowdata['doc_cert_trans_personas'], ''); ?>
					</div>
				...
				<?php }else{?>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
						...
						echo '<h3>Certificado Transporte Personas</h3>';
						$Form_Imputs->form_multiple_upload('Seleccionar archivo','doc_cert_trans_personas', 1, '"doc","docx","pdf","jpg", "png", "gif", "jpeg"');
						$Form_Imputs->form_date('Fecha Vencimiento','doc_fecha_cert_trans_personas', $x1, 2);
