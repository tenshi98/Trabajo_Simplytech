			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class=""><a href="<?php echo 'vehiculos_listado_doc_cert_trans_personas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-files-o" aria-hidden="true"></i> Archivo - Seguro Carga</a></li>
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_doc_trans_personas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-files-o" aria-hidden="true"></i> Archivo - Cert. Transporte Personas</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php }else{?>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
						...
						$Form_Inputs->form_multiple_upload('Seleccionar archivo','doc_cert_trans_personas', 1, '"doc","docx","pdf","jpg", "png", "gif", "jpeg"');
