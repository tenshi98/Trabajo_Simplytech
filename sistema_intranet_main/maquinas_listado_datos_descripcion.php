...
$query = "SELECT Nombre,Descripcion, idConfig_1, idConfig_2, idConfig_3
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, $x_column_maquina_plur, $rowdata['Nombre'], 'Editar Descripcion');?>
</div>
