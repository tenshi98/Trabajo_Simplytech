...
$location = $original;
$new_location = "clientes_contab_listado_datos_contacto.php";
...
/*******************************************************/
// consulto los datos
$SIS_query = 'Fono1,Fono2, Fax, email, Web, Nombre, idTipo';
$SIS_join  = '';
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'clientes_contab_listado_datos_contacto.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-address-book-o" aria-hidden="true"></i> Datos Contacto</a></li>
				<li class="dropdown">
