...
if(!empty($_GET['id'])){
	...
	$SIS_join  = 'LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario = comunicaciones_videoconferencia_listado_usuarios.idUsuario';
	$SIS_where = 'comunicaciones_videoconferencia_listado_usuarios.idVideoConferencia = '.$_GET['id'];
	$SIS_order = 'usuarios_listado.Nombre ASC';
	$arrUsuarios = array();
	$arrUsuarios = db_select_array (false, $SIS_query, 'comunicaciones_videoconferencia_listado_usuarios', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrUsuarios');
		...
		<div class="box">
			<header>
				<ul class="nav nav-tabs pull-right">
					...
					<li class=""><a href="<?php echo 'comunicaciones_videoconferencia_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-list-alt" aria-hidden="true"></i> Datos Básicos</a></li>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = "comunicaciones_videoconferencia_listado.idEstado!=0";
	//Verifico el tipo de usuario que esta ingresando
	$SIS_where.=" AND comunicaciones_videoconferencia_listado.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];
	/**********************************************************/
	//Se aplican los filtros
	if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){        $SIS_where .= " AND comunicaciones_videoconferencia_listado.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
	if(isset($_GET['Fecha']) && $_GET['Fecha']!=''){          $SIS_where .= " AND comunicaciones_videoconferencia_listado.Fecha='".$_GET['Fecha']."'";}
	if(isset($_GET['idEstado']) && $_GET['idEstado']!=''){    $SIS_where .= " AND comunicaciones_videoconferencia_listado.idEstado='".$_GET['idEstado']."'";}
	if(isset($_GET['idTipo']) && $_GET['idTipo']!=''){        $SIS_where .= " AND comunicaciones_videoconferencia_listado.idTipo='".$_GET['idTipo']."'";}
	if(isset($_GET['idUsuario']) && $_GET['idUsuario']!=''){  $SIS_where .= " AND comunicaciones_videoconferencia_listado.idUsuario='".$_GET['idUsuario']."'";}
	/*******************************************************/
	// consulto los datos
	$SIS_query = '
	...
	$SIS_order = 'comunicaciones_videoconferencia_listado.idEstado ASC, comunicaciones_videoconferencia_listado.Fecha ASC';
	$arrVideoConferencia = array();
	$arrVideoConferencia = db_select_array (false, $SIS_query, 'comunicaciones_videoconferencia_listado', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrVideoConferencia');
