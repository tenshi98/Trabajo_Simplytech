...
$original = "informe_telemetria_registro_sensores_16.php";
$location = $original;
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Comparacion Grupos Sensores', $_SESSION['usuario']['basic_data']['RazonSocial'], 'Informe del equipo '.$arrEquipos[0]['NombreEquipo']);?>
	<div class="col-md-6 col-sm-6 col-xs-12 clearfix">
		...
		<?php }else{ ?>
			<a target="new" href="<?php echo 'informe_telemetria_registro_sensores_16_to_pdf.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-3 pull-right margin_width"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar a PDF</a>
		<?php } ?>
