...
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Persona editada correctamente';}
...
if(isset($_GET['Rut']) && $_GET['Rut'] != ''){                          $SIS_where .= " AND personas_listado.Rut LIKE '%".$_GET['Rut']."%'";}
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){                    $SIS_where .= " AND personas_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['ApellidoPaterno']) && $_GET['ApellidoPaterno'] != ''){  $SIS_where .= " AND personas_listado.ApellidoPaterno LIKE '%".$_GET['ApellidoPaterno']."%'";}
if(isset($_GET['ApellidoMaterno']) && $_GET['ApellidoMaterno'] != ''){  $SIS_where .= " AND personas_listado.ApellidoMaterno LIKE '%".$_GET['ApellidoMaterno']."%'";}
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Persona</a><?php }?>
					...
					<tr class="odd">		
						...
						<td>
							<div class="btn-group" style="width: 105px;" >
								<?php if ($rowlevel['level']>=1){?><a href="<?php echo 'view_productor.php?view='.simpleEncode($usuarios['idPersona'], fecha_actual()); ?>" title="Ver Informacion" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
