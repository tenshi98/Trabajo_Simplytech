...
FROM `seg_vecinal_clientes_observaciones`
LEFT JOIN `seg_vecinal_clientes_listado`   ON seg_vecinal_clientes_listado.idCliente     = seg_vecinal_clientes_observaciones.idCliente
LEFT JOIN `usuarios_listado`               ON usuarios_listado.idUsuario                 = seg_vecinal_clientes_observaciones.idUsuario
WHERE seg_vecinal_clientes_observaciones.idObservacion = ".$_GET['view']."
...
<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
	<div class="box">
        ...
        <div class="body">
            ...
            <p class="text-muted">
				<strong>Vecino : </strong><?php echo $rowData['nombre_cliente']; ?><br/>
...
$query = "SELECT 
seg_vecinal_clientes_observaciones.idObservacion,
seg_vecinal_clientes_listado.Nombre AS nombre_cliente,
usuarios_listado.Nombre AS nombre_usuario,
seg_vecinal_clientes_observaciones.Fecha,
seg_vecinal_clientes_observaciones.Observacion
...
LEFT JOIN `seg_vecinal_clientes_listado`   ON seg_vecinal_clientes_listado.idCliente     = seg_vecinal_clientes_observaciones.idCliente
LEFT JOIN `usuarios_listado`               ON usuarios_listado.idUsuario                 = seg_vecinal_clientes_observaciones.idUsuario
WHERE seg_vecinal_clientes_observaciones.idCliente = ".$_GET['id']."
ORDER BY seg_vecinal_clientes_observaciones.idObservacion ASC ";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
