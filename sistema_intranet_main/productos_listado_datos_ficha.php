...
$location = $original;
$new_location = "productos_listado_datos_ficha.php";
...
$query = "SELECT Nombre,FichaTecnica, idTipoProducto, idTipoReceta,idOpciones_1, idOpciones_2
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, $x_column_producto_nombre_plur, $rowdata['Nombre'], 'Editar Ficha Tecnica');?>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'productos_listado_datos_ficha.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Ficha</a></li>
