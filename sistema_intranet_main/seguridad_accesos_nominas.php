...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Nomina</a><?php } ?>
		...
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select_depend5('Destino', 'idUbicacion',  $x8,  1,  'idUbicacion',  'Nombre',  'ubicacion_listado',  'idEstado=1 AND idSistema='.$_SESSION['usuario']['basic_data']['idSistema'],   0,
												  $x_column_ubicacion_lvl_1, 'idUbicacion_lvl_1',  $x9,  1,  'idLevel_1',  'Nombre',  'ubicacion_listado_level_1',  0,   0, 
												  $x_column_ubicacion_lvl_2, 'idUbicacion_lvl_2',  $x10,  1,  'idLevel_2',  'Nombre',  'ubicacion_listado_level_2',  0,   0,
												  $x_column_ubicacion_lvl_3, 'idUbicacion_lvl_3',  $x11,  1,  'idLevel_3',  'Nombre',  'ubicacion_listado_level_3',  0,   0,
												  $x_column_ubicacion_lvl_4, 'idUbicacion_lvl_4',  $x12,  1,  'idLevel_4',  'Nombre',  'ubicacion_listado_level_4',  0,   0,
												  $x_column_ubicacion_lvl_5, 'idUbicacion_lvl_5',  $x13,  1,  'idLevel_5',  'Nombre',  'ubicacion_listado_level_5',  0,   0,
												  $dbConn, 'form1');
							...
							<td>
								<div class="btn-group" style="width: 105px;" >
									...
									<?php if ($tipo['FechaProgramada']==fecha_actual()){?>
										<?php if ($rowlevel['level']>=2){?><a href="<?php echo 'seguridad_accesos_nominas_editar.php?id='.$tipo['idAcceso']; ?>" title="Editar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
									<?php } ?>
