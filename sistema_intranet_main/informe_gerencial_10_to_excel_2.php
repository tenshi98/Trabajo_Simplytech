...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Ventas Vendedores por semana');
...
header('Content-Disposition: attachment;filename="Ventas Vendedores por semana Resumen.xls"');
