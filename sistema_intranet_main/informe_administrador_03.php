...
if(!empty($_GET['submit_filter'])){
	...
	$arrCarga = array();
	$arrCarga = db_select_array (false, $SIS_query, 'transportes_checkbrute', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrCarga');
