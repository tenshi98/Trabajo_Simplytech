...
$original = "informe_administrador_03.php";
$location = $original;
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'email_asc':     $order_by = 'ORDER BY email ASC ';       $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Email Ascendente'; break;
...
FROM `transportes_checkbrute`
".$z."
GROUP BY Fecha, usuario, email, IP_Client
".$order_by;
//Consulta
...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Bloqueos</h5>
		</header>
				...
				<thead>
					<tr role="row">
						...
						<th>
							...
							<div class="btn-group pull-right" style="width: 50px;" >
								<a href="<?php echo $location.'&order_by=ip_asc'; ?>" title="Ascendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-asc"></i></a>
								<a href="<?php echo $location.'&order_by=ip_desc'; ?>" title="Descendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-desc"></i></a>
							</div>
						</th>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Imputs->form_date('Fecha','Fecha', $x1, 1);
				$Form_Imputs->form_input_text( 'Usuario', 'usuario', $x2, 1);
				$Form_Imputs->form_input_text( 'Email', 'email', $x3, 1);
				$Form_Imputs->form_input_text( 'Direccion IP', 'IP_Client', $x4, 1);
