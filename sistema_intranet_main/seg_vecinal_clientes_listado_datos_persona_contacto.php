...
if (isset($_GET['created'])) {$error['Cliente'] 	  = 'sucess/Vecino creado correctamente';}
if (isset($_GET['edited']))  {$error['Cliente'] 	  = 'sucess/Vecino editado correctamente';}
if (isset($_GET['deleted'])) {$error['Cliente'] 	  = 'sucess/Vecino borrado correctamente';}
