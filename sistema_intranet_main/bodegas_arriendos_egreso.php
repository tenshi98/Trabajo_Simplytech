	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['arriendos_egr_descuentos'][$_GET['editDescuentos']]['idDescuento'], 2);
				?>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['arriendos_egr_productos'][$_GET['editProd']]['ValorIngreso']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'ValorTotal', $x4, 2);
				$Form_Imputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['arriendos_egr_productos'][$_GET['editProd']]['ValorIngreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				//se dibujan los inputs
				$Form_Imputs = new Form_Inputs();
				$Form_Imputs->form_select_filter('Guias disponibles','idGuia', $x1, 2, 'idFacturacion', 'N_Doc', 'bodegas_arriendos_facturacion', $z, 'N_Doc ASC', '', $dbConn);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($Devolucion_fecha)) {   $x5  = $Devolucion_fecha; }else{$x5  = $_SESSION['arriendos_egr_basicos']['Devolucion_fecha'];}
				if(isset($idTrabajador)) {       $x6  = $idTrabajador;     }else{$x6  = $_SESSION['arriendos_egr_basicos']['idTrabajador'];}
				if(isset($idBodega)) {           $x7  = $idBodega;         }else{$x7  = $_SESSION['arriendos_egr_basicos']['idBodega'];}
				if(isset($OC_Ventas)) {          $x8  = $OC_Ventas;        }else{$x8  = $_SESSION['arriendos_egr_basicos']['OC_Ventas'];}
				...
				$Form_Imputs->form_select_join_filter('Bodega origen','idBodega', $x7, 2, 'idBodega', 'Nombre', 'bodegas_arriendos_listado', 'usuarios_bodegas_arriendos', $z, $dbConn);
...
WHERE idDocumentos = {$_SESSION['arriendos_egr_basicos']['idDocumentos']}";
//Consulta
...
WHERE idTipo = {$_SESSION['arriendos_egr_basicos']['idTipo']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
WHERE idCliente = {$_SESSION['arriendos_egr_basicos']['idCliente']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
// Se trae el vendedor relacionado
$query = "SELECT Nombre, ApellidoPat, ApellidoMat
FROM `trabajadores_listado`
WHERE idTrabajador = {$_SESSION['arriendos_egr_basicos']['idTrabajador']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
WHERE idBodega = {$_SESSION['arriendos_egr_basicos']['idBodega']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
	...
	<div id="page-wrap">
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $rowDocumento['Nombre'].' N°'.$_SESSION['arriendos_egr_basicos']['N_Doc']?></td>
					</tr>
					<tr>
						<td class="meta-head">Vendedor</td>
						<td><?php echo $rowVendedor['Nombre'].' '.$rowVendedor['ApellidoPat'].' '.$rowVendedor['ApellidoMat']?></td>
					</tr>
					<tr>
		...
		<table id="items">
			<tbody>
				...
				<tr>
					<?php if(isset($_SESSION['arriendos_egr_basicos']['Observaciones'])&&$_SESSION['arriendos_egr_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['arriendos_egr_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
							<div class="btn-group" style="width: 35px;" >
								<?php 
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['arriendos_egr_temporal'])&&$_SESSION['arriendos_egr_temporal']!=''){
								$non = $_SESSION['arriendos_egr_temporal'];
							}	
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_text('OC Relacionada','OC_Ventas', $x9, 1);
