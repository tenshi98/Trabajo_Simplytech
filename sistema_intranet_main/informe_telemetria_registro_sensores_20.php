...
if(isset($ndata_1)&&$ndata_1>=10001){
	...
	$rowEquipo = db_select_data (false, 'Nombre AS NombreEquipo,cantSensores'.$consql, 'telemetria_listado', '', 'idTelemetria='.$_GET['idTelemetria'], $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowEquipo');
