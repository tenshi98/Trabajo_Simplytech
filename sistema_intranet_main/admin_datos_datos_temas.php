...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// consulto los datos
$SIS_query = 'Nombre,Config_idTheme';
$SIS_join  = '';
...
$SIS_query = 'idTheme, Nombre,img';
$SIS_join  = '';
$SIS_where = 'idTheme!=0';
$SIS_order = 'Nombre ASC';
$arrTemas = array();
$arrTemas = db_select_array (false, $SIS_query, 'core_theme_colors', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrTemas');
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'admin_datos_datos_temas.php'; ?>" ><i class="fa fa-tags" aria-hidden="true"></i> Temas</a></li>
