...
$original = "sistema_planes_transporte.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/sistema_planes_transporte.php';
}
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'nombre_asc':        $order_by = 'ORDER BY sistema_planes_transporte.Nombre ASC ';           $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente'; break;
		case 'nombre_desc':       $order_by = 'ORDER BY sistema_planes_transporte.Nombre DESC ';          $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Nombre Descendente';break;
		case 'valormensual_asc':  $order_by = 'ORDER BY sistema_planes_transporte.Valor_Mensual ASC ';    $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Valor Mensual Ascendente';break;
		case 'valormensual_desc': $order_by = 'ORDER BY sistema_planes_transporte.Valor_Mensual DESC ';   $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Valor Mensual Descendente';break;
		case 'valoranual_asc':    $order_by = 'ORDER BY sistema_planes_transporte.Valor_Anual ASC ';      $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Valor Anual Ascendente';break;
		case 'valoranual_desc':   $order_by = 'ORDER BY sistema_planes_transporte.Valor_Anual DESC ';     $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Valor Anual Descendente';break;
		case 'nhijos_asc':        $order_by = 'ORDER BY sistema_planes_transporte.N_Hijos ASC ';          $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Numero de Hijos Ascendente';break;
		case 'nhijos_desc':       $order_by = 'ORDER BY sistema_planes_transporte.N_Hijos DESC ';         $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Numero de Hijos Descendente';break;
		
		default: $order_by = 'ORDER BY sistema_planes_transporte.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';
	}
}else{
	$order_by = 'ORDER BY sistema_planes_transporte.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';
}
/**********************************************************/
//Variable de busqueda
$z = "WHERE sistema_planes_transporte.idPlan!=0";
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){               $z .= " AND sistema_planes_transporte.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['Valor_Mensual']) && $_GET['Valor_Mensual'] != ''){ $z .= " AND sistema_planes_transporte.Valor_Mensual LIKE '%".$_GET['Valor_Mensual']."%'";}
if(isset($_GET['Valor_Anual']) && $_GET['Valor_Anual'] != ''){     $z .= " AND sistema_planes_transporte.Valor_Anual LIKE '%".$_GET['Valor_Anual']."%'";}
/**********************************************************/
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idPlan FROM `sistema_planes_transporte` ".$z;
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Plan</a><?php } ?>
