...
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){               $SIS_where .= " AND sistema_planes_transporte.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['Valor_Mensual']) && $_GET['Valor_Mensual'] != ''){ $SIS_where .= " AND sistema_planes_transporte.Valor_Mensual LIKE '%".$_GET['Valor_Mensual']."%'";}
if(isset($_GET['Valor_Anual']) && $_GET['Valor_Anual'] != ''){     $SIS_where .= " AND sistema_planes_transporte.Valor_Anual LIKE '%".$_GET['Valor_Anual']."%'";}
