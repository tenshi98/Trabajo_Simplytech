...
$original = "informe_bodega_insumos_01.php";
$location = $original;
...
if(!empty($_GET['idBodega'])){
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
		...
		?>
		<a target="new" href="<?php echo 'informe_bodega_insumos_01_to_excel.php?bla=bla'.$zz ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
		<a target="new" href="<?php echo 'informe_bodega_insumos_01_to_pdf.php?bla=bla'.$zz ; ?>"   class="btn btn-sm btn-metis-3 pull-right margin_width"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar a PDF</a>
		<a target="new" href="<?php echo 'informe_bodega_insumos_01_to_print.php?bla=bla'.$zz ; ?>" class="btn btn-sm btn-metis-5 pull-right margin_width"><i class="fa fa-print" aria-hidden="true"></i> Imprimir</a>
	</div>
