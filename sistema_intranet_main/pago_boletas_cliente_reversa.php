...
/**********************************************************************************************/
//datos 
$filter   = 'WHERE pagos_boletas_clientes.idPago!=0';
if(isset($_GET['idDocPago'])&&$_GET['idDocPago']!=''){
	$filter .= ' AND pagos_boletas_clientes.idDocPago='.$_GET['idDocPago'];
}
if(isset($_GET['N_DocPago'])&&$_GET['N_DocPago']!=''){
	$filter .= ' AND pagos_boletas_clientes.N_DocPago='.$_GET['N_DocPago'];
}
if(isset($_GET['idCliente'])&&$_GET['idCliente']!=''){
	$filter .= ' AND pagos_boletas_clientes.idCliente='.$_GET['idCliente'];
}
