...
$location = $original;
$new_location = "clientes_contab_listado_datos_persona_contacto.php";
...
/*******************************************************/
// consulto los datos
$SIS_query = 'Nombre,PersonaContacto, PersonaContacto_Fono, PersonaContacto_email, idTipo, PersonaContacto_Cargo';
$SIS_join  = '';
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Cliente', $rowData['Nombre'], 'Editar Persona de contacto'); ?>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li class="active"><a href="<?php echo 'clientes_contab_listado_datos_persona_contacto.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-volume-control-phone" aria-hidden="true"></i> Persona Contacto</a></li>
