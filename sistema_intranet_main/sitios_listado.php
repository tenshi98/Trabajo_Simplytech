				...
				<div class="wmd-panel">
					...
					<div class="col-sm-4">
						...
						<?php if (isset($rowdata['Config_Logo_Archivo'])&&$rowdata['Config_Logo_Archivo']!='') { ?>
							<img style="margin-top:10px;" class="media-object img-thumbnail user-img width100" alt="User Picture" src="<?php echo DB_SITE_REPO.'/'.$rowdata['Config_Root_Folder'].'/upload/'.$rowdata['Config_Logo_Archivo'] ?>">
						<?php } ?>
...
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){            $SIS_where .= " AND sitios_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
