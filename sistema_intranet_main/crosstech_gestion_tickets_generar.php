...
$original = "crosstech_gestion_tickets_generar.php";
$location = $original;
...
// consulto los datos
$query = "SELECT idCliente,idArea,idTipoTicket,idPrioridad,Titulo,Descripcion
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_select_filter('Cliente Creador','idCliente', $x1, 2, 'idCliente', 'Nombre', 'clientes_listado', $clientfil, '', $dbConn);
...
if(isset($_GET['idEstado']) && $_GET['idEstado'] != ''){                    $SIS_where .= " AND crosstech_gestion_tickets.idEstado=".$_GET['idEstado'];}
...
$SIS_where.= " GROUP BY crosstech_gestion_tickets.idTicket";
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select('Area Ticket','idArea', $x3, 1, 'idArea', 'Nombre', 'crosstech_gestion_tickets_area', 0, '', $dbConn);
