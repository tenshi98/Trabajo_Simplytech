...
/**********************************************************************************************************************************/
//Config
$pdf_titulo     = 'Stock Critico Bodega: '.DeSanitizar($arrProductos[0]['NombreBodega']);
$pdf_subtitulo  = 'Stock al '.fecha_actual();
$pdf_file       = 'Stock Critico Bodega '.DeSanitizar($arrProductos[0]['NombreBodega']).' al '.fecha_actual().'.pdf';
$OpcDom         = "'A4', 'landscape'";
