...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'fecha_asc':        $order_by = 'ORDER BY trabajadores_descuentos_anticipos.Creacion_fecha ASC ';                                                             $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Facturacion Ascendente';break;
		case 'fecha_desc':       $order_by = 'ORDER BY trabajadores_descuentos_anticipos.Creacion_fecha DESC ';                                                            $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';break;
		...
		case 'monto_asc':        $order_by = 'ORDER BY trabajadores_descuentos_anticipos.Monto ASC ';                                                                      $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Monto Ascendente'; break;
		case 'monto_desc':       $order_by = 'ORDER BY trabajadores_descuentos_anticipos.Monto DESC ';                                                                     $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Monto Descendente';break;
		
		default: $order_by = 'ORDER BY trabajadores_descuentos_anticipos.Creacion_fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';
	}
}else{
	$order_by = 'ORDER BY trabajadores_descuentos_anticipos.Creacion_fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';
}
/**********************************************************/
//Variable de busqueda
$z = "WHERE trabajadores_descuentos_anticipos.idAnticipos!=0";
//Verifico el tipo de usuario que esta ingresando
$w = "idSistema={$_SESSION['usuario']['basic_data']['idSistema']} AND idEstado=1";
...
if(isset($_GET['idTrabajador']) && $_GET['idTrabajador'] != ''){      $z .= " AND trabajadores_descuentos_anticipos.idTrabajador=".$_GET['idTrabajador'];}
if(isset($_GET['idUsuario']) && $_GET['idUsuario'] != ''){            $z .= " AND trabajadores_descuentos_anticipos.idUsuario=".$_GET['idUsuario'];}
if(isset($_GET['Creacion_fecha']) && $_GET['Creacion_fecha'] != ''){  $z .= " AND trabajadores_descuentos_anticipos.Creacion_fecha='".$_GET['Creacion_fecha']."'";}
if(isset($_GET['Ano']) && $_GET['Ano'] != ''){                        $z .= " AND trabajadores_descuentos_anticipos.Creacion_ano=".$_GET['Ano'];}
if(isset($_GET['idMes']) && $_GET['idMes'] != ''){                    $z .= " AND trabajadores_descuentos_anticipos.Creacion_mes=".$_GET['idMes'];}
/**********************************************************/
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idAnticipos FROM `trabajadores_descuentos_anticipos` 
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Anticipo</a><?php } ?>
...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Anticipos</h5>
			<div class="toolbar">
				<?php 
