...
//filtros
$z  = "WHERE telemetria_listado_error_fuera_linea.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];   //Sistema
$z .= " AND telemetria_listado.id_Geo=2";                                                                  //Geolocalizacion activa
