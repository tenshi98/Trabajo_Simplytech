...
$original = "seg_vecinal_clientes_infracciones.php";
$location = $original;
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Infraccion Creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Infraccion Modificada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Infraccion borrada correctamente';}
...
// consulto los datos
$query = "SELECT Fecha, Descripcion, idCliente
FROM `seg_vecinal_clientes_infracciones`
WHERE idInfraccion = ".$_GET['id'];
//Consulta
...
<div class="col-sm-8 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de Infraccion</h5>
		</header>
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Infraccion</a><?php }?>
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select_filter('Vecino','idCliente', $x2, 1, 'idCliente', 'Nombre', 'seg_vecinal_clientes_listado', $z, '', $dbConn);
...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table" aria-hidden="true"></i></div><h5>Listado de Infracciones</h5>
			<div class="toolbar">
				<?php 
				//paginacion
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				...
				<?php foreach ($arrBloqueo as $bloqueo) { ?>
					<tr class="odd">
						...
						<td><?php echo $bloqueo['Vecino']; ?></td>
						<td class="word_break"><?php echo $bloqueo['Descripcion']; ?></td>
						<td>
							<div class="btn-group" style="width: 70px;" >
								<a href="<?php echo $location.'&id='.$bloqueo['idInfraccion']; ?>" title="Editar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
								<?php 
								$ubicacion = $location.'&del='.simpleEncode($bloqueo['idInfraccion'], fecha_actual());
