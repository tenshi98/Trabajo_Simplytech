...
if(!empty($_GET['pagar'])){
	/*******************************************************/
	// consulto los datos
	$SIS_query = 'Nombre,Identificador';
	$SIS_join  = '';
	$SIS_where = 'idCliente ='.$_GET['idCliente'];
	$rowCliente = db_select_data (false, $SIS_query, 'aguas_clientes_listado', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowCliente');
	...
	$SIS_join  = '';
	$SIS_where = 'idCliente = '.$_GET['idCliente'].' AND idEstado = 1 ORDER BY Ano DESC, idMes DESC';
	$rowFacturacion = db_select_data (false, $SIS_query, 'aguas_facturacion_listado_detalle', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowFacturacion');
				...
				<ul class="list-group inbox-options">
					<form class="form-horizontal" method="post" id="form1" name="form1" novalidate >
						...
						<li class="list-group-item">
							...
							<a href="<?php echo $location.'&idCliente='.$_GET['idCliente'].'&submit_filter=Filtrar'; ?>" class="btn btn-danger pull-right margin_form_btn"><i class="fa fa-arrow-left" aria-hidden="true"></i> Cancelar y Volver</a>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_join  = 'LEFT JOIN `aguas_facturacion_listado_detalle_estado` ON aguas_facturacion_listado_detalle_estado.idEstado = aguas_facturacion_listado_detalle.idEstado';
	$SIS_where = 'aguas_facturacion_listado_detalle.idCliente = '.$_GET['idCliente'];
	$SIS_where.= ' AND aguas_facturacion_listado_detalle.idEstado = 1';
	$SIS_order = 'aguas_facturacion_listado_detalle.Ano ASC, aguas_facturacion_listado_detalle.idMes DESC';
	$arrFacturaciones = array();
	$arrFacturaciones = db_select_array (false, $SIS_query, 'aguas_facturacion_listado_detalle', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrFacturaciones');
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
		switch ($_GET['order_by']) {
			case 'numero_asc':          $order_by = 'aguas_clientes_pago.idPago ASC ';                           $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Numero Evento Ascendente'; break;
			case 'numero_desc':         $order_by = 'aguas_clientes_pago.idPago DESC ';                          $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Numero Evento Descendente';break;
			...
			case 'fecha_asc':           $order_by = 'aguas_clientes_pago.fechaPago ASC ';                        $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ascendente'; break;
			case 'fecha_desc':          $order_by = 'aguas_clientes_pago.fechaPago DESC ';                       $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Descendente';break;
			case 'documento_asc':       $order_by = 'aguas_facturacion_listado_detalle_tipo_pago.Nombre ASC ';   $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Documento Ascendente';break;
			case 'documento_desc':      $order_by = 'aguas_facturacion_listado_detalle_tipo_pago.Nombre DESC ';  $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Documento Descendente';break;
			case 'monto_asc':           $order_by = 'aguas_clientes_pago.montoPago ASC ';                        $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Monto Ascendente';break;
			case 'monto_desc':          $order_by = 'aguas_clientes_pago.montoPago DESC ';                       $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Monto Descendente';break;
			...
			default: $order_by = 'aguas_clientes_pago.fechaPago DESC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Descendente';
		}
	}else{
		$order_by = 'aguas_clientes_pago.fechaPago DESC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Descendente';
	}
	/**********************************************************/
	...
	if(isset($_GET['fechaPago']) && $_GET['fechaPago']!=''){            $SIS_where .= " AND aguas_clientes_pago.fechaPago='".$_GET['fechaPago']."'";}

	/**********************************************************/
	//Realizo una consulta para saber el total de elementos existentes
	$cuenta_registros = db_select_nrows (false, 'aguas_clientes_pago.idPago', 'aguas_clientes_pago', '', $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'cuenta_registros');
