...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'fpag_asc':         $order_by = 'bodegas_productos_facturacion.Pago_fecha ASC ';                             $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Pago Programado Ascendente';break;
		case 'fpag_desc':        $order_by = 'bodegas_productos_facturacion.Pago_fecha DESC ';                            $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Pago Programado Descendente';break;
	...
	$order_by = 'bodegas_productos_facturacion.Creacion_fecha ASC, proveedor_listado.Nombre ASC, bodegas_productos_facturacion.N_Doc ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ingreso, Proveedor, N° Doc Pago Ascendente';
}
/**********************************************************/
