...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'fpag_asc':         $order_by = 'ORDER BY bodegas_productos_facturacion.Pago_fecha ASC ';                             $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Pago Programado Ascendente';break;
		case 'fpag_desc':        $order_by = 'ORDER BY bodegas_productos_facturacion.Pago_fecha DESC ';                            $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Pago Programado Descendente';break;
		...
		default: $order_by = 'ORDER BY bodegas_productos_facturacion.Creacion_fecha ASC, proveedor_listado.Nombre ASC, bodegas_productos_facturacion.N_Doc ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ingreso, Proveedor, N° Doc Pago Ascendente';
	}
}else{
	$order_by = 'ORDER BY bodegas_productos_facturacion.Creacion_fecha ASC, proveedor_listado.Nombre ASC, bodegas_productos_facturacion.N_Doc ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ingreso, Proveedor, N° Doc Pago Ascendente';
}
/**********************************************************/
//Variable de busqueda
$z="WHERE bodegas_productos_facturacion.idEstado=1"; //solo documentos no pagados
//Verifico el tipo de usuario que esta ingresando
$z.=" AND bodegas_productos_facturacion.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];	
$z.=" AND bodegas_productos_facturacion.idTipo=1"; //solo compras
$z.=" AND bodegas_productos_facturacion.Pago_fecha<'".fecha_actual()."'"; //fecha actual
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select_filter('Vendedor','idTrabajador', $x2, 1, 'idTrabajador', 'Rut,Nombre,ApellidoPat,ApellidoMat', 'trabajadores_listado', $z, '', $dbConn);
