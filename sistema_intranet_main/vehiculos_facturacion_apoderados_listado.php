...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'fechacreacion_asc':  $order_by = 'ORDER BY vehiculos_facturacion_apoderados_listado.fCreacion ASC ';  $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Creacion Ascendente'; break;
		case 'fechacreacion_desc': $order_by = 'ORDER BY vehiculos_facturacion_apoderados_listado.fCreacion DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Creacion Descendente';break;
		case 'fechafact_asc':      $order_by = 'ORDER BY vehiculos_facturacion_apoderados_listado.Fecha ASC ';      $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Facturacion Ascendente';break;
		case 'fechafact_desc':     $order_by = 'ORDER BY vehiculos_facturacion_apoderados_listado.Fecha DESC ';     $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';break;
		...
		default: $order_by = 'ORDER BY vehiculos_facturacion_apoderados_listado.Fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';
	}
}else{
	$order_by = 'ORDER BY vehiculos_facturacion_apoderados_listado.Fecha DESC '; $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Facturacion Descendente';
}
/**********************************************************/
//Variable de busqueda
$z = "WHERE vehiculos_facturacion_apoderados_listado.idFacturacion!=0";
//Verifico el tipo de usuario que esta ingresando
$z.=" AND vehiculos_facturacion_apoderados_listado.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];	
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['Fecha']) && $_GET['Fecha'] != ''){                  $z .= " AND vehiculos_facturacion_apoderados_listado.Fecha='".$_GET['Fecha']."'";}
if(isset($_GET['Observaciones']) && $_GET['Observaciones'] != ''){  $z .= " AND vehiculos_facturacion_apoderados_listado.Observaciones LIKE '%".$_GET['Observaciones']."%'";}
/**********************************************************/
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idFacturacion FROM `vehiculos_facturacion_apoderados_listado` ".$z;
//Consulta
