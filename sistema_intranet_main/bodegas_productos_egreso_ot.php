...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'ot_asc':       $order_by = 'ORDER BY bodegas_productos_facturacion.idOT ASC ';              $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> OT Ascendente';break;
		case 'ot_desc':      $order_by = 'ORDER BY bodegas_productos_facturacion.idOT DESC ';             $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> OT Descendente';break;
...
$z="WHERE bodegas_productos_facturacion.idTipo=7 AND bodegas_productos_facturacion.idOT!=0";//Solo egresos por OT
