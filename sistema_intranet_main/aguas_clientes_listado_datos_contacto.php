...
$location = $original;
$new_location = "aguas_clientes_listado_datos_contacto.php";
...
$query = "SELECT Identificador, Fono1,Fono2, Fax, email, Web, Nombre,
idTipo 
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'aguas_clientes_listado_datos_contacto.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-address-book-o" aria-hidden="true"></i> Datos Contacto</a></li>
				<li class="dropdown">
