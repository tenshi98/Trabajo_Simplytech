			...
			<table id="meta" class="pull-left otdata">
				<tbody>
					...
					<tr>
						...
						<td><?php echo Fecha_estandar($_SESSION['vehiculos_basicos']['fCreacion']); ?></td>
					</tr>
					<tr>
						<td class="meta-head">Creador</td>
						<td><?php echo $_SESSION['vehiculos_basicos']['Usuario']; ?></td>
					</tr>
					<tr>
						<td class="meta-head">Sistema</td>
						<td><?php echo $_SESSION['vehiculos_basicos']['Sistema']; ?></td>
					</tr>
				</tbody>
			</table>
...
if(isset($_GET['Observaciones']) && $_GET['Observaciones']!=''){  $SIS_where .= " AND vehiculos_facturacion_listado.Observaciones LIKE '%".EstandarizarInput($_GET['Observaciones'])."%'";}
