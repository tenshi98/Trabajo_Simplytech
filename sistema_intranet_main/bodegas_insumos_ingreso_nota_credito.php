	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['insumos_ing_nc_productos'][$_GET['editProd']]['ValorIngreso']), 1);
				$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x3, 2);
				$Form_Inputs->form_input_hidden('ValorIngreso', Cantidades_decimales_justos($_SESSION['insumos_ing_nc_productos'][$_GET['editProd']]['ValorIngreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['insumos_ing_nc_otros'][$_GET['editOtros']]['idOtros'], 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idUsoIVA)) {           $x6  = $idUsoIVA;         }else{$x6  = $_SESSION['insumos_ing_nc_basicos']['idUsoIVA'];}
...
<div class="col-sm-12">
		...
		<div id="customer">
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<?php if(isset($_SESSION['insumos_ing_nc_basicos']['idUsoIVA'])&&$_SESSION['insumos_ing_nc_basicos']['idUsoIVA']==1){ ?>
						<tr>
    ...
    <div class="row">
		<div class="col-xs-12">
			...
			<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['insumos_ing_nc_basicos']['Observaciones'];?></p>
		</div>
	</div>
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select_join_filter('Bodega origen','idBodega', $x6, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $v, $dbConn);
