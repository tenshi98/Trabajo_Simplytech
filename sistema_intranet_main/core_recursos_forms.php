	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_disabled('Input desactivado','form_input_disabled1', $x5, 1);
				$Form_Inputs->form_input_disabled('Input desactivado','form_input_disabled2', $x6, 2);
