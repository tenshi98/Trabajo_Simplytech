	...
	<div class="box dark">
		...
		<div class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
				...
				$Form_Inputs->form_tittle(3, 'Información');
				...
				$Form_Inputs->form_input_number_spinner('input spinner','form_input_number_spinner1', $x19, -10, 10, '0.1', 1, 1);
				$Form_Inputs->form_input_number_spinner('input spinner','form_input_number_spinner2', $x20, -10, 10, '0.1', 1, 2);
