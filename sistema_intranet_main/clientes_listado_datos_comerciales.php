...
$location = $original;
$new_location = "clientes_listado_datos_comerciales.php";
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if(isset($rowdata['idTipo'])&&$rowdata['idTipo']==1){?>
							<li class="active"><a href="<?php echo 'clientes_listado_datos_comerciales.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos Comerciales</a></li>
						<?php } ?>
