...
WHERE bodegas_servicios_facturacion_existencias.idFacturacion = {$_GET['view']} ";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
WHERE pagos_facturas_proveedores.idFacturacion = {$_GET['view']} AND idTipo=3
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
WHERE pagos_facturas_clientes.idFacturacion = {$_GET['view']} AND idTipo=3
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
WHERE bodegas_servicios_facturacion_historial.idFacturacion = {$_GET['view']} 
...
WHERE bodegas_servicios_facturacion.idFacturacion = {$_GET['view']} 
...
LEFT JOIN `core_documentos_mercantiles`  ON core_documentos_mercantiles.idDocumentos     = bodegas_servicios_facturacion.idDocumentos
LEFT JOIN `usuarios_listado`             ON usuarios_listado.idUsuario                   = bodegas_servicios_facturacion.idUsuario
WHERE bodegas_servicios_facturacion.idFacturacionRelacionado = {$_GET['view']}";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
