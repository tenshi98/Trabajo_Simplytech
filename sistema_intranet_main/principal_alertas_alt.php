...
$original = "principal_alertas_alt.php";
$location = $original;
...
if(isset($_GET['nivel']) && $_GET['nivel']!=''){    $location .= "&nivel=".$_GET['nivel'];    } else { $location .= "&nivel=1"; }
/**********************************************************************************************************************************/
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	include '1include_principal_alertas.php';
	?>
</div>
