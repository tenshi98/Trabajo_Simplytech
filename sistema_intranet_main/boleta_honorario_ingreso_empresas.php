	...
	<div class="box dark">
		...
		<div class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
				...
				if(isset($Observaciones)){     $x4  = $Observaciones;   }else{$x4  = $_SESSION['boleta_ing_prov_basicos']['Observaciones'];}
				if(isset($idOcompra)){         $x5  = $idOcompra;       }else{$x5  = $_SESSION['boleta_ing_prov_basicos']['idOcompra'];}

				//se dibujan los inputs
				$Form_Inputs = new Form_Inputs();
				$Form_Inputs->form_select_filter('Proveedor','idProveedor', $x1, 2, 'idProveedor', 'Rut,Nombre', 'proveedor_listado', $w, '', $dbConn);
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<div id="page-wrap">
		...
		<table id="items">
			<tbody>
				...
				$_SESSION['boleta_ing_prov_basicos']['valor_imp']    = $vtotal_neto * ($_SESSION['boleta_ing_prov_basicos']['Porc_Impuesto']/100);
				$_SESSION['boleta_ing_prov_basicos']['valor_total']  = $vtotal_neto - ($vtotal_neto * ($_SESSION['boleta_ing_prov_basicos']['Porc_Impuesto']/100));
				?>
					...
					<tr class="invoice-total" bgcolor="#f1f1f1">
						<td colspan="4" align="right"><strong><?php echo $_SESSION['boleta_ing_prov_basicos']['Porc_Impuesto'].'%'; ?> Impuesto Retenido</strong></td>
    ...
    <div class="col-xs-12">
		<div class="row">
			...
			<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['boleta_ing_prov_basicos']['Observaciones']; ?></p>
		</div>
	</div>
...
$SIS_where = "boleta_honorarios_facturacion.idTipo=3";//Solo empresas
...
if(isset($_GET['idProveedor']) && $_GET['idProveedor']!=''){ $SIS_where .= " AND boleta_honorarios_facturacion.idProveedor=".$_GET['idProveedor'];}
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group" style="width: 70px;" >
								<?php if ($rowlevel['level']>=1){ ?><a href="<?php echo 'view_boleta_honorarios.php?view='.simpleEncode($tipo['idFacturacion'], fecha_actual()); ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
