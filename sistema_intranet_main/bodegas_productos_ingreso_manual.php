...
$original = "bodegas_productos_ingreso_manual.php";
$location = $original;
...
if ( !empty($_POST['submit_prod']) )  { 
	//Llamamos al formulario
	$form_trabajo= 'new_prod_ing_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';
}
//formulario para crear
if ( !empty($_POST['submit_edit_prod']) )  { 
	//Llamamos al formulario
	$form_trabajo= 'edit_prod_ing_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';
}
//se borra un dato
if ( !empty($_GET['del_prod']) )     {
	//Llamamos al formulario
	$form_trabajo= 'del_prod_ing_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';	
}
/**********************************************/
//se borra un dato
if ( !empty($_GET['add_obs']) )     {
	//Llamamos al formulario
	$form_trabajo= 'add_obs_ing_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';	
}
//se borra un dato
if ( !empty($_GET['del_obs']) )     {
	//Llamamos al formulario
	$form_trabajo= 'del_obs_ing_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';	
}
/**********************************************/
//formulario para crear
if ( !empty($_POST['submit_file']) )  { 
	//Llamamos al formulario
	$form_trabajo= 'new_file_ing_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';
}
//se borra un dato
if ( !empty($_GET['del_file']) )     {
	//Llamamos al formulario
	$form_trabajo= 'del_file_ing_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';	
}
/**********************************************/
if ( !empty($_GET['ing_bodega']) )     {
	//Llamamos al formulario
	$form_trabajo= 'ing_bodega_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';	
}
//formulario para crear
if ( !empty($_POST['submit_impuesto']) )  { 
	//Llamamos al formulario
	$form_trabajo= 'new_impuesto_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';
}
//se borra un dato
if ( !empty($_GET['del_impuesto']) )     {
	//Llamamos al formulario
	$form_trabajo= 'del_impuesto_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';	
}
//formulario para crear
if ( !empty($_POST['submit_modFecha']) )  { 
	//Llamamos al formulario
	$form_trabajo= 'modFecha_manual';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_productos.php';
}
/**********************************************************************************************************************************/
...
WHERE productos_listado.idProducto='{$_SESSION['productos_ing_manual_productos'][$_GET['editProd']]['idProducto']}'
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idProducto)) {       $x1  = $idProducto;      }else{$x1  = $_SESSION['productos_ing_manual_productos'][$_GET['editProd']]['idProducto'];}
				if(isset($Number)) {           $x2  = $Number;          }else{$x2  = $_SESSION['productos_ing_manual_productos'][$_GET['editProd']]['Number'];}
				if(isset($ValorTotal)) {       $x3  = $ValorTotal;      }else{$x3  = $_SESSION['productos_ing_manual_productos'][$_GET['editProd']]['ValorTotal'];}
				...
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['productos_ing_manual_productos'][$_GET['editProd']]['ValorIngreso']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'ValorTotal', $x3, 2);
				$Form_Imputs->form_input_hidden('ValorIngreso', Cantidades_decimales_justos($_SESSION['productos_ing_manual_productos'][$_GET['editProd']]['ValorIngreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idCentroCosto)) {  $x1  = $idCentroCosto;  }else{$x1  = $_SESSION['productos_ing_manual_basicos']['idCentroCosto'];}
				if(isset($idLevel_1)) {      $x2  = $idLevel_1;      }else{$x2  = $_SESSION['productos_ing_manual_basicos']['idLevel_1'];}
				if(isset($idLevel_2)) {      $x3  = $idLevel_2;      }else{$x3  = $_SESSION['productos_ing_manual_basicos']['idLevel_2'];}
				if(isset($idLevel_3)) {      $x4  = $idLevel_3;      }else{$x4  = $_SESSION['productos_ing_manual_basicos']['idLevel_3'];}
				if(isset($idLevel_4)) {      $x5  = $idLevel_4;      }else{$x5  = $_SESSION['productos_ing_manual_basicos']['idLevel_4'];}
				if(isset($idLevel_5)) {      $x6  = $idLevel_5;      }else{$x6  = $_SESSION['productos_ing_manual_basicos']['idLevel_5'];}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idProveedor)) {      $x1  = $idProveedor;    }else{$x1  = $_SESSION['productos_ing_manual_basicos']['idProveedor'];}
				if(isset($Creacion_fecha)) {   $x2  = $Creacion_fecha; }else{$x2  = $_SESSION['productos_ing_manual_basicos']['Creacion_fecha'];}
				if(isset($idBodega)) {         $x3  = $idBodega;       }else{$x3  = $_SESSION['productos_ing_manual_basicos']['idBodega'];}
				
				//se dibujan los inputs
				$Form_Imputs = new Form_Inputs();
				$Form_Imputs->form_select_filter('Proveedor','idProveedor', $x1, 2, 'idProveedor', 'Nombre', 'proveedor_listado', $w, '', $dbConn);
				$Form_Imputs->form_date('F Ingreso','Creacion_fecha', $x2, 2);
				$Form_Imputs->form_select_join_filter('Bodega destino','idBodega', $x3, 2, 'idBodega', 'Nombre', 'bodegas_productos_listado', 'usuarios_bodegas_productos', $z, $dbConn);
				
				
				$Form_Imputs->form_input_disabled('Empresa Relacionada','fake_emp', $_SESSION['usuario']['basic_data']['RazonSocial'], 1);
				$Form_Imputs->form_input_hidden('idSistema', $_SESSION['usuario']['basic_data']['idSistema'], 2);
				$Form_Imputs->form_input_hidden('idUsuario', $_SESSION['usuario']['basic_data']['idUsuario'], 2);
				$Form_Imputs->form_input_hidden('idTipo', 9, 2);			
...
<div class="col-sm-12 fcenter">
	...
	<div id="page-wrap">
		<div id="header"> <?php echo $_SESSION['productos_ing_manual_basicos']['TipoDocumento']; ?></div>
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $_SESSION['productos_ing_manual_basicos']['Proveedor']; ?></td>
					</tr>
					<tr>
						<td class="meta-head">Bodega Destino</td>
						<td><?php echo $_SESSION['productos_ing_manual_basicos']['Bodega']; ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo $_SESSION['productos_ing_manual_basicos']['CentroCosto']; ?></td>
					</tr>
				</tbody>
			</table>
			<table id="meta" class="otdata2">
				<tbody>
					<tr>
						...
						<td colspan="2"><?php echo Fecha_estandar($_SESSION['productos_ing_manual_basicos']['Creacion_fecha'])?></td>
					</tr>
				</tbody>
			</table>
		</div>
		<table id="items">
			<tbody>
						...
						<tr class="item-row linea_punteada">
							...
							<td>
								<div class="btn-group" style="width: 70px;" >
									<a href="<?php echo $location.'&editProd='.$producto['idProducto']; ?>" title="Editar Traspaso" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a>
									<?php 
				...
				$_SESSION['productos_ing_manual_basicos']['valor_neto_fact'] = $vtotal_neto;
				?>
					...
					if (isset($_SESSION['productos_ing_manual_impuestos'])){
						...
						$tempa = $vtotal_neto;
						//recorro el lsiatdo entregado por la base de datos
						foreach ($_SESSION['productos_ing_manual_impuestos'] as $key => $producto){
							...
							$_SESSION['productos_ing_manual_impuestos'][$producto['idImpuesto']]['valor'] = $vtotal_IVA;?>
							<tr class="invoice-total" bgcolor="#f1f1f1">
				...
				<tr>
					<?php if(isset($_SESSION['productos_ing_manual_basicos']['Observaciones'])&&$_SESSION['productos_ing_manual_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['productos_ing_manual_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
							<div class="btn-group" style="width: 35px;" >
								<?php 
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['productos_ing_manual_temporal'])&&$_SESSION['productos_ing_manual_temporal']!=''){
								$non = $_SESSION['productos_ing_manual_temporal'];
							}	
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idBodega)) {         $x3  = $idBodega;       }else{$x3  = '';}
...
//Verifico el tipo de usuario que esta ingresando
if($_SESSION['usuario']['basic_data']['idTipoUsuario']==1){
	$y="bodegas_productos_listado.idSistema>=0";
	$w="idSistema>=0 AND idEstado=1";
}else{
	$y="bodegas_productos_listado.idSistema={$_SESSION['usuario']['basic_data']['idSistema']} AND usuarios_bodegas_productos.idUsuario = {$_SESSION['usuario']['basic_data']['idUsuario']}";		
	$w="idSistema={$_SESSION['usuario']['basic_data']['idSistema']} AND idEstado=1";
}
/**********************************************************/
//Variable con la ubicacion
$z="WHERE bodegas_productos_facturacion.idTipo=9";//Solo ingresos manuales
//Verifico el tipo de usuario que esta ingresando
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){
		if (isset($_SESSION['productos_ing_manual_basicos']['idProveedor'])&&$_SESSION['productos_ing_manual_basicos']['idProveedor']!=''){?>
	...
	<?php }else{?>
		<a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Ingreso</a>
	<?php }
	 }?>
</div> 
<div class="clearfix"></div>                    
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Imputs->form_date('F Ingreso','Creacion_fecha', $x2, 1);
				$Form_Imputs->form_select_join_filter('Bodega destino','idBodega', $x3, 1, 'idBodega', 'Nombre', 'bodegas_productos_listado', 'usuarios_bodegas_productos', $y, $dbConn);
