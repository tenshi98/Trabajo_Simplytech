...
if (isset($_GET['created'])){ $error['created'] = 'sucess/IPC Creado correctamente';}
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/IPC Modificado correctamente';}
if (isset($_GET['deleted'])){ $error['deleted'] = 'sucess/IPC Borrado correctamente';}
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){ ?><a href="<?php echo $location; ?>&new=true" class="btn btn-default pull-right margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear IPC</a><?php } ?>
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 70px;" >
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $location.'&id='.$uml['idIPC']; ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
