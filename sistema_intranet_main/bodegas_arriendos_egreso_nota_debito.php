...
$original = "bodegas_arriendos_egreso_nota_debito.php";
$location = $original;
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($Cantidad_eg)){    $x2  = $Cantidad_eg;   }else{$x2  = Cantidades_decimales_justos($_SESSION['arriendos_egr_nd_productos'][$_GET['editProd']]['Cantidad_eg']);}
					if(isset($idFrecuencia)){   $x3  = $idFrecuencia;  }else{$x3  = $_SESSION['arriendos_egr_nd_productos'][$_GET['editProd']]['idFrecuencia'];}
					if(isset($ValorTotal)){     $x4  = $ValorTotal;    }else{$x4  = Cantidades_decimales_justos($_SESSION['arriendos_egr_nd_productos'][$_GET['editProd']]['ValorTotal']);}
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					<?php
					//Se verifican si existen los datos
					if(isset($Nombre)){  $x1  = $Nombre;  }else{$x1  = $_SESSION['arriendos_egr_nd_otros'][$_GET['editOtros']]['Nombre'];}
					if(isset($vTotal)){  $x2  = $vTotal;  }else{$x2  = Cantidades_decimales_justos($_SESSION['arriendos_egr_nd_otros'][$_GET['editOtros']]['vTotal']);}
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($N_Doc)){              $x2  = $N_Doc;            }else{$x2  = $_SESSION['arriendos_egr_nd_basicos']['N_Doc'];}
					if(isset($Creacion_fecha)){     $x3  = $Creacion_fecha;   }else{$x3  = $_SESSION['arriendos_egr_nd_basicos']['Creacion_fecha'];}
					if(isset($idBodega)){           $x4  = $idBodega;         }else{$x4  = $_SESSION['arriendos_egr_nd_basicos']['idBodega'];}
					if(isset($Observaciones)){      $x5  = $Observaciones;    }else{$x5  = $_SESSION['arriendos_egr_nd_basicos']['Observaciones'];}
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idDocumentos = '.$_SESSION['arriendos_egr_nd_basicos']['idDocumentos'];
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idTipo = '.$_SESSION['arriendos_egr_nd_basicos']['idTipo'];
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idCliente = '.$_SESSION['arriendos_egr_nd_basicos']['idCliente'];
	$rowCliente = db_select_data (false, $SIS_query, 'clientes_listado', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowCliente');

	/*******************************************************/
	// consulto los datos
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idBodega = '.$_SESSION['arriendos_egr_nd_basicos']['idBodega'];
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div id="page-wrap">
				...
				<table id="meta" class="otdata2">
					<tbody>
						<tr>
							...
							<td colspan="2"><?php echo Fecha_estandar($_SESSION['arriendos_egr_nd_basicos']['Creacion_fecha']); ?></td>
						</tr>
					</tbody>
				</table>
			</div>
			<table id="items">
				<tbody>
					...
					<?php  //Guardo el neto
					$_SESSION['arriendos_egr_nd_basicos']['valor_neto_fact'] = $vtotal_neto;
					?>
						...
						$_SESSION['arriendos_egr_nd_basicos']['valor_neto_imp'] = $vtotal_neto;
						?>
						<tr class="invoice-total" bgcolor="#f1f1f1">
						...
						if (isset($_SESSION['arriendos_egr_nd_impuestos'])){
							...
							foreach ($arrImpuestos as $impto) {
								foreach ($_SESSION['arriendos_egr_nd_impuestos'] as $key => $producto){
									if($impto['idImpuesto']==$producto['idImpuesto']){
										...
										$_SESSION['arriendos_egr_nd_impuestos'][$producto['idImpuesto']]['valor'] = $vtotal_IVA;
						...
						//guardo el total
						$_SESSION['arriendos_egr_nd_basicos']['valor_total_fact'] = $vtotal_neto; ?>
						<tr class="invoice-total" bgcolor="#f1f1f1">
		...
		<div class="col-xs-12">
			<div class="row">
				...
				<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['arriendos_egr_nd_basicos']['Observaciones']; ?></p>
			</div>
		</div>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
		switch ($_GET['order_by']) {
			case 'proveedor_asc':  $order_by = 'clientes_listado.Nombre ASC ';                        $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Cliente Ascendente'; break;
			case 'proveedor_desc': $order_by = 'clientes_listado.Nombre DESC ';                       $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Cliente Descendente';break;
	...
	$SIS_where = "bodegas_arriendos_facturacion.idTipo=12";//Solo ingresos
		...
		<div class="well">
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
				<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_select_join_filter('Bodega origen','idBodega', $x6, 1, 'idBodega', 'Nombre', 'bodegas_arriendos_listado', 'usuarios_bodegas_arriendos', $y, $dbConn);
