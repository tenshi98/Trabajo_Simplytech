...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Bono Asignado creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Bono Asignado editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Bono Asignado borrado correctamente';}
	...
	<div class="box dark">	
		...
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_select_filter('Bono','idBonoFijo', $x1, 2, 'idBonoFijo', 'Nombre', 'sistema_bonos_fijos', 0, '',$dbConn);
				$Form_Imputs->form_input_number('Monto', 'Monto', $x2, 2);
				
				$Form_Imputs->form_input_hidden('idTrabajador', $_GET['id'], 2);
				$Form_Imputs->form_input_hidden('idBono', $_GET['edit'], 2);
				?>
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Bonos Fijos Asignados</span>
			</div>
		</div>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<?php if ($rowlevel['level']>=3){?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&new=true'; ?>" class="btn btn-default fright margin_width" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Bono Asignado</a><?php }?>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'admin_trabajadores_listado_bonos_fijos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Bonos Fijos Asignados</a></li>
					...
					<tr class="odd">		
						...
						<td>
							<div class="btn-group" style="width: 70px;" >
								<?php if ($rowlevel['level']>=2){?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&edit='.$bon['idBono']; ?>" title="Editar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a><?php } ?>
								<?php if ($rowlevel['level']>=4){
									$ubicacion = $new_location.'&id='.$_GET['id'].'&del='.$bon['idBono'];
