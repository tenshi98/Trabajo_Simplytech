...
$location = $original;
$new_location = "trabajadores_listado_contacto.php";
...
$query = "SELECT Nombre,ApellidoPat,ApellidoMat,ContactoPersona, ContactoFono
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'trabajadores_listado_contacto.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos Contacto</a></li>
				<li class="dropdown">
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_input_icon( 'Persona de Contacto', 'ContactoPersona', $x1, 1,'fa fa-address-card-o');
					$Form_Imputs->form_input_phone('Fono de Persona de Contacto', 'ContactoFono', $x2, 1);
