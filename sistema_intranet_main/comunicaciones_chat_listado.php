...
WHERE comunicaciones_chat_listado.idChat = ".$_GET['id'];
//Consulta
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class=""><a href="<?php echo 'comunicaciones_chat_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-list-alt" aria-hidden="true"></i> Datos Basicos</a></li>
...
$z = "WHERE comunicaciones_chat_listado.idEstado!=0";
//Verifico el tipo de usuario que esta ingresando
$z.=" AND comunicaciones_chat_listado.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){ $z .= " AND comunicaciones_chat_listado.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
if(isset($_GET['Fecha']) && $_GET['Fecha']!=''){   $z .= " AND comunicaciones_chat_listado.Fecha='".$_GET['Fecha']."'";}
if(isset($_GET['idEstado']) && $_GET['idEstado']!=''){    $z .= " AND comunicaciones_chat_listado.idEstado='".$_GET['idEstado']."'";}
if(isset($_GET['idTipo']) && $_GET['idTipo']!=''){ $z .= " AND comunicaciones_chat_listado.idTipo='".$_GET['idTipo']."'";}
if(isset($_GET['idUsuario']) && $_GET['idUsuario']!=''){  $z .= " AND comunicaciones_chat_listado.idUsuario='".$_GET['idUsuario']."'";}
/**********************************************************/
...
".$z."
ORDER BY comunicaciones_chat_listado.idEstado ASC, comunicaciones_chat_listado.Fecha ASC
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
