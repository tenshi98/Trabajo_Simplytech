...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Chat Modificado correctamente';}
...
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){        $z .= " AND comunicaciones_chat_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
