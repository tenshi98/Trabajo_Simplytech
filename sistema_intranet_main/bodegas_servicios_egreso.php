...
$original = "bodegas_servicios_egreso.php";
$location = $original;
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($Nombre)) {      $x1  = $Nombre;     }else{$x1  = $_SESSION['servicios_egr_descuentos'][$_GET['editDescuentos']]['Nombre'];}
				if(isset($vTotal)) {      $x2  = $vTotal;     }else{$x2  = $_SESSION['servicios_egr_descuentos'][$_GET['editDescuentos']]['vTotal'];}
				...
				$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['servicios_egr_descuentos'][$_GET['editDescuentos']]['idDescuento'], 2);
				?>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idServicio)) {     $x1  = $idServicio;    }else{$x1  = $_SESSION['servicios_egr_productos'][$_GET['editProd']]['idServicio'];}
				if(isset($Cantidad_eg)) {    $x2  = $Cantidad_eg;   }else{$x2  = Cantidades_decimales_justos($_SESSION['servicios_egr_productos'][$_GET['editProd']]['Cantidad_eg']);}
				if(isset($idFrecuencia)) {   $x3  = $idFrecuencia;  }else{$x3  = $_SESSION['servicios_egr_productos'][$_GET['editProd']]['idFrecuencia'];}
				if(isset($ValorTotal)) {     $x4  = $ValorTotal;    }else{$x4  = Cantidades_decimales_justos($_SESSION['servicios_egr_productos'][$_GET['editProd']]['ValorTotal']);}
				...
				$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['servicios_egr_productos'][$_GET['editProd']]['ValorIngreso']));
				$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x4, 2);
				$Form_Inputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['servicios_egr_productos'][$_GET['editProd']]['ValorIngreso']), 2);
...
$z=" idDocumentos = 1 AND idEstado = 1 AND idCliente = ".$_SESSION['servicios_egr_basicos']['idCliente'];		 
?>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idCentroCosto)) {  $x1  = $idCentroCosto;  }else{$x1  = $_SESSION['servicios_egr_basicos']['idCentroCosto'];}
				if(isset($idLevel_1)) {      $x2  = $idLevel_1;      }else{$x2  = $_SESSION['servicios_egr_basicos']['idLevel_1'];}
				if(isset($idLevel_2)) {      $x3  = $idLevel_2;      }else{$x3  = $_SESSION['servicios_egr_basicos']['idLevel_2'];}
				if(isset($idLevel_3)) {      $x4  = $idLevel_3;      }else{$x4  = $_SESSION['servicios_egr_basicos']['idLevel_3'];}
				if(isset($idLevel_4)) {      $x5  = $idLevel_4;      }else{$x5  = $_SESSION['servicios_egr_basicos']['idLevel_4'];}
				if(isset($idLevel_5)) {      $x6  = $idLevel_5;      }else{$x6  = $_SESSION['servicios_egr_basicos']['idLevel_5'];}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idCliente)) {          $x1  = $idCliente;        }else{$x1  = $_SESSION['servicios_egr_basicos']['idCliente'];}
				if(isset($idDocumentos)) {       $x2  = $idDocumentos;     }else{$x2  = $_SESSION['servicios_egr_basicos']['idDocumentos'];}
				if(isset($N_Doc)) {              $x3  = $N_Doc;            }else{$x3  = $_SESSION['servicios_egr_basicos']['N_Doc'];}
				if(isset($Creacion_fecha)) {     $x4  = $Creacion_fecha;   }else{$x4  = $_SESSION['servicios_egr_basicos']['Creacion_fecha'];}
				if(isset($fecha_fact_desde)) {   $x5  = $fecha_fact_desde; }else{$x5  = $_SESSION['servicios_egr_basicos']['fecha_fact_desde'];}
				if(isset($fecha_fact_hasta)) {   $x6  = $fecha_fact_hasta; }else{$x6  = $_SESSION['servicios_egr_basicos']['fecha_fact_hasta'];}
				if(isset($idTrabajador)) {       $x7  = $idTrabajador;     }else{$x7  = $_SESSION['servicios_egr_basicos']['idTrabajador'];}
				if(isset($Observaciones)) {      $x8  = $Observaciones;    }else{$x8  = $_SESSION['servicios_egr_basicos']['Observaciones'];}
				if(isset($OC_Ventas)) {          $x9  = $OC_Ventas;        }else{$x9  = $_SESSION['servicios_egr_basicos']['OC_Ventas'];}
				if(isset($idUsoIVA)) {           $x10 = $idUsoIVA;         }else{$x10 = $_SESSION['servicios_egr_basicos']['idUsoIVA'];}
				...
				$Form_Inputs->form_select('Vendedor','idTrabajador', $x7, 2, 'idTrabajador', 'Rut,Nombre,ApellidoPat,ApellidoMat', 'trabajadores_listado', $y, '', $dbConn);
				$Form_Inputs->form_textarea('Observaciones','Observaciones', $x8, 1);
				$Form_Inputs->form_input_text('OC Relacionada','OC_Ventas', $x9, 1);
...
<div class="col-sm-12">
	...
	<div id="page-wrap">
		<div id="header"> <?php echo $_SESSION['servicios_egr_basicos']['TipoDocumento']; ?></div>
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $_SESSION['servicios_egr_basicos']['Cliente']; ?></td>
					</tr>
					<tr>
						<td class="meta-head">Documento</td>
						<td><?php echo $_SESSION['servicios_egr_basicos']['Documento'].' N°'.$_SESSION['servicios_egr_basicos']['N_Doc']?></td>
					</tr>
					<tr>
						<td class="meta-head">Vendedor</td>
						<td><?php echo $_SESSION['servicios_egr_basicos']['Vendedor']; ?></td>
					</tr>
					<?php if(isset($_SESSION['servicios_egr_basicos']['OC_Ventas'])&&$_SESSION['servicios_egr_basicos']['OC_Ventas']!=''){ ?>
						<tr>
							<td class="meta-head">Orden Compra Relacionada</td>
							<td><?php echo 'OC N°'.$_SESSION['servicios_egr_basicos']['OC_Ventas']?></td>
						</tr>
					<?php } ?>
					<tr>
					...
					<tr>
						...
						<td><?php echo $_SESSION['servicios_egr_basicos']['CentroCosto']; ?></td>
					</tr>
					<?php if(isset($_SESSION['servicios_egr_basicos']['idUsoIVA'])&&$_SESSION['servicios_egr_basicos']['idUsoIVA']==1){ ?>
						<tr>
			...
			<table id="meta" class="otdata2">
				<tbody>
					<tr>
						...
						<td colspan="2"><?php echo Fecha_estandar($_SESSION['servicios_egr_basicos']['Creacion_fecha'])?></td>
					</tr>
					<?php if($_SESSION['servicios_egr_basicos']['idDocumentos']==2){?>
						<tr>
							<td class="meta-head">Fecha Vencimiento</td>
							<?php if($_SESSION['servicios_egr_basicos']['Pago_fecha']!='0000-00-00'){?>
								<td><?php echo Fecha_estandar($_SESSION['servicios_egr_basicos']['Pago_fecha']);?></td>
								<td>
						...
						<?php if(isset($_SESSION['servicios_egr_basicos']['fecha_fact_desde'])&&$_SESSION['servicios_egr_basicos']['fecha_fact_desde']!=''&&$_SESSION['servicios_egr_basicos']['fecha_fact_desde']!='0'&&$_SESSION['servicios_egr_basicos']['fecha_fact_desde']!='0000-00-00'){ ?>
							<tr>
								<td class="meta-head">Facturacion Desde</td>
								<td colspan="2"><?php echo Fecha_estandar($_SESSION['servicios_egr_basicos']['fecha_fact_desde'])?></td>
							</tr>
						<?php }?>
						<?php if(isset($_SESSION['servicios_egr_basicos']['fecha_fact_hasta'])&&$_SESSION['servicios_egr_basicos']['fecha_fact_hasta']!=''&&$_SESSION['servicios_egr_basicos']['fecha_fact_hasta']!='0'&&$_SESSION['servicios_egr_basicos']['fecha_fact_hasta']!='0000-00-00'){ ?>
							<tr>
								<td class="meta-head">Facturacion Hasta</td>
								<td colspan="2"><?php echo Fecha_estandar($_SESSION['servicios_egr_basicos']['fecha_fact_hasta'])?></td>
							</tr>
						<?php }?>
					<?php }?>
				</tbody>
		...
		<table id="items">
			<tbody>
				...
				<?php  //Guardo el neto
				$_SESSION['servicios_egr_basicos']['valor_neto_fact'] = $vtotal_neto;
				?>
					...
					$_SESSION['servicios_egr_basicos']['valor_neto_imp'] = $vtotal_neto;
					?>
					<tr class="invoice-total" bgcolor="#f1f1f1">
					...
					if (isset($_SESSION['servicios_egr_impuestos'])){
						...
						$tempa = $vtotal_neto;
						//recorro el lsiatdo entregado por la base de datos 
						foreach ($_SESSION['servicios_egr_impuestos'] as $key => $producto){
							...
							$_SESSION['servicios_egr_impuestos'][$producto['idImpuesto']]['valor'] = $vtotal_IVA;
					...
					//guardo el total
					$_SESSION['servicios_egr_basicos']['valor_total_fact'] = $vtotal_neto;
    ...
    <div class="col-xs-12">
		<div class="row">
			...
			<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['servicios_egr_basicos']['Observaciones'];?></p>
		</div>
	</div>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idTrabajador)) {       $x7  = $idTrabajador;     }else{$x7  = '';}
				if(isset($Observaciones)) {      $x8  = $Observaciones;    }else{$x8  = '';}
				if(isset($OC_Ventas)) {          $x9  = $OC_Ventas;        }else{$x9  = '';}
...
$SIS_where = "bodegas_servicios_facturacion.idTipo=2";//Solo egresos
...
if(isset($_GET['N_Doc']) && $_GET['N_Doc'] != ''){                     $SIS_where .= " AND bodegas_servicios_facturacion.N_Doc LIKE '%".$_GET['N_Doc']."%'";}
...
if(isset($_GET['idTrabajador']) && $_GET['idTrabajador'] != ''){       $SIS_where .= " AND bodegas_servicios_facturacion.idTrabajador=".$_GET['idTrabajador'];}
if(isset($_GET['Observaciones']) && $_GET['Observaciones'] != ''){     $SIS_where .= " AND bodegas_servicios_facturacion.Observaciones LIKE '%".$_GET['Observaciones']."%'";}
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){ ?>
		<?php if (isset($_SESSION['servicios_egr_basicos']['idCliente'])&&$_SESSION['servicios_egr_basicos']['idCliente']!=''){?>
