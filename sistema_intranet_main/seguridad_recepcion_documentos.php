...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Recepcion Documento Creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Recepcion Documento Modificado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Recepcion Documento borrado correctamente';}
...
$query = "SELECT Fecha,Hora,idTipo, De, Para, Observaciones
FROM `seguridad_recepcion_documentos`
WHERE idRecepcion = ".$_GET['id'];
//Consulta
...
<div class="col-sm-8 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de Recepcion Documento</h5>
		</header>
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Recepcion</a><?php } ?>
