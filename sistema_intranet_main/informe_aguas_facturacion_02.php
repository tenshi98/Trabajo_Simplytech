...
if(!empty($_GET['submit_filter'])){
	...
	$SIS_order = 'aguas_facturacion_listado_detalle.Ano DESC, aguas_facturacion_listado_detalle.idMes DESC';
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_select_filter('Cliente','idCliente', $x1, 2, 'idCliente', 'Identificador,Nombre', 'aguas_clientes_listado', $z, 'Identificador ASC', $dbConn);
