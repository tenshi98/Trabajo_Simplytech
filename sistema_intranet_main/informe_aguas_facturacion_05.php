...
if(!empty($_GET['submit_filter'])){
	...
	// consulto los datos
	$SIS_query = '
	idFacturacionDetalle,idCliente,Fecha,ClienteIdentificador,DetalleCargoFijoValor,DetalleConsumoCantidad,DetalleConsumoValor,
	AguasInfMetroAgua,AguasInfMetroRecolecion,DetalleRecoleccionCantidad,DetalleRecoleccionValor,DetalleVisitaCorte,DetalleCorte1Valor,
	DetalleCorte2Valor,DetalleReposicion1Valor,DetalleReposicion2Valor,DetalleSubtotalServicio,DetalleInteresDeuda,DetalleSaldoFavor,
	DetalleTotalVenta,DetalleSaldoAnterior,DetalleOtrosCargos1Valor,DetalleOtrosCargos2Valor,DetalleOtrosCargos3Valor,
	DetalleOtrosCargos4Valor,DetalleOtrosCargos5Valor,DetalleTotalAPagar,AguasInfUltimoPagoFecha,AguasInfUltimoPagoMonto,intAnual,
	(SELECT DetalleTotalAPagar FROM `aguas_facturacion_listado_detalle` AS txt WHERE txt.idCliente = aguas_facturacion_listado_detalle.idCliente AND txt.idMes = '.$mesAnterior.' AND txt.Ano = '.$anoActual.' ORDER BY txt.Fecha DESC LIMIT 1) AS TotalPagarAnterior';
	$SIS_join  = '';
