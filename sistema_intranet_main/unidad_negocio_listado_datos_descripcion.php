...
$location = $original;
$new_location = "unidad_negocio_listado_datos_descripcion.php";
...
$query = "SELECT Nombre,Descripcion, idConfig_1, idConfig_2
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'unidad_negocio_listado_datos_descripcion.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Descripcion</a></li>
