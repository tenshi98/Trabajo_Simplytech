	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				<div class="form-group">
					<input type="submit" class="btn btn-primary fright margin_width fa-input" value="&#xf046; Crear Tarea" name="submit"> 
					<a href="<?php echo $location; ?>" class="btn btn-danger fright margin_width"><i class="fa fa-arrow-left" aria-hidden="true"></i> Cancelar y Volver</a>
				</div>
...
<div class="col-sm-12 breadcrumb-bar">
	...
	if (isset($_SESSION['tareas_basicos']['idMaquina'])&&$_SESSION['tareas_basicos']['idMaquina']!=''){?>
		...
		<a href="<?php echo $location; ?>&view=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-arrow-right" aria-hidden="true"></i> Continuar Tarea Pendiente</a>
	<?php }else{?>
		<a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Tarea Pendiente</a>
	<?php }
	 }?>
</div>
<div class="clearfix"></div> 
