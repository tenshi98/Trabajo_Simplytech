...
$original = "bodegas_insumos_traspaso_empresa_manual.php";
$location = $original;
...
if (!empty($_POST['submit_modBase'])){
	//Llamamos al formulario
	$form_trabajo= 'modBase_traspasomanualempresa';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_insumos.php';
}
//formulario para editar
...
if (!empty($_POST['submit_modCentroCosto'])){
	//Llamamos al formulario
	$form_trabajo= 'modCentroCosto_traspasomanualempresa';
	require_once 'A1XRXS_sys/xrxs_form/z_bodega_insumos.php';
}
/*************************************************/
//formulario para crear
...
if(!empty($_GET['editProd'])){
	...
	(SELECT SUM(Cantidad_ing) FROM `bodegas_insumos_facturacion_existencias` WHERE idProducto = insumos_listado.idProducto AND idBodega='.$_SESSION['insumos_traspasoempresa_basicos']['idBodegaOrigen'].' LIMIT 1) AS ingreso,
	(SELECT SUM(Cantidad_eg)  FROM `bodegas_insumos_facturacion_existencias` WHERE idProducto = insumos_listado.idProducto AND idBodega='.$_SESSION['insumos_traspasoempresa_basicos']['idBodegaOrigen'].' LIMIT 1) AS egreso';
	$SIS_join  = 'LEFT JOIN `sistema_productos_uml` ON sistema_productos_uml.idUml = insumos_listado.idUml';
	$SIS_where = 'insumos_listado.idProducto='.$_SESSION['insumos_traspasomanualempresa_productos'][$_GET['editProd']]['idProducto'];
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($idProducto)){       $x1  = $idProducto;      }else{$x1  = $_SESSION['insumos_traspasomanualempresa_productos'][$_GET['editProd']]['idProducto'];}
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	insumos_listado.ValorIngreso,
	sistema_productos_uml.Nombre AS Unimed,
	(SELECT SUM(Cantidad_ing) FROM `bodegas_insumos_facturacion_existencias` WHERE idProducto = insumos_listado.idProducto AND idBodega='.$_SESSION['insumos_traspasoempresa_basicos']['idBodegaOrigen'].') AS ingreso,
	(SELECT SUM(Cantidad_eg)  FROM `bodegas_insumos_facturacion_existencias` WHERE idProducto = insumos_listado.idProducto AND idBodega='.$_SESSION['insumos_traspasoempresa_basicos']['idBodegaOrigen'].') AS egreso';
	$SIS_join  = 'LEFT JOIN `sistema_productos_uml`   ON sistema_productos_uml.idUml = insumos_listado.idUml';
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					<?php
					//Se verifican si existen los datos
					if(isset($idCentroCosto)){  $x1  = $idCentroCosto;  }else{$x1  = $_SESSION['insumos_traspasomanualempresa_basicos']['idCentroCosto'];}
					if(isset($idLevel_1)){      $x2  = $idLevel_1;      }else{$x2  = $_SESSION['insumos_traspasomanualempresa_basicos']['idLevel_1'];}
					if(isset($idLevel_2)){      $x3  = $idLevel_2;      }else{$x3  = $_SESSION['insumos_traspasomanualempresa_basicos']['idLevel_2'];}
					if(isset($idLevel_3)){      $x4  = $idLevel_3;      }else{$x4  = $_SESSION['insumos_traspasomanualempresa_basicos']['idLevel_3'];}
					if(isset($idLevel_4)){      $x5  = $idLevel_4;      }else{$x5  = $_SESSION['insumos_traspasomanualempresa_basicos']['idLevel_4'];}
				...
				<table id="meta" class="pull-left otdata">
					<tbody>
						...
						<tr>
							...
							<td><?php echo $_SESSION['insumos_traspasomanualempresa_basicos']['BodegaOrigen']; ?></td>
						</tr>
						<tr>
							<td class="meta-head">Empresa Destino</td>
							<td><?php echo $_SESSION['insumos_traspasomanualempresa_basicos']['SistemaDestino']; ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php echo $_SESSION['insumos_traspasomanualempresa_basicos']['CentroCosto']; ?></td>
						</tr>
					</tbody>
				</table>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = "bodegas_insumos_facturacion.idTipo=8";//Solo traspaso a otra empresa
