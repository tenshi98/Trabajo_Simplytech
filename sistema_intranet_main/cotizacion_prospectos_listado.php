...
if ( !empty($_GET['add_obs']) )     {
	//Llamamos al formulario
	$form_trabajo= 'add_obs_cotizacion';
	require_once 'A1XRXS_sys/xrxs_form/z_cotizacion_prospectos_listado.php';	
}
//se borra un dato
if ( !empty($_GET['del_obs']) )     {
	//Llamamos al formulario
	$form_trabajo= 'del_obs_cotizacion';
	require_once 'A1XRXS_sys/xrxs_form/z_cotizacion_prospectos_listado.php';	
}
/**********************************************/
//formulario para crear
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['cotizacion_prospectos_servicios'][$_GET['editServicios']]['idServicio'], 2);
				
				
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['cotizacion_prospectos_servicios'][$_GET['editServicios']]['vUnitario']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'vTotal', $x4, 2);
				$Form_Imputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['cotizacion_prospectos_servicios'][$_GET['editServicios']]['vUnitario']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['cotizacion_prospectos_arriendos'][$_GET['editArriendo']]['idEquipo'], 2);
				
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['cotizacion_prospectos_arriendos'][$_GET['editArriendo']]['vUnitario']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'vTotal', $x4, 2);
				$Form_Imputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['cotizacion_prospectos_arriendos'][$_GET['editArriendo']]['vUnitario']), 2);
...
WHERE insumos_listado.idProducto='{$_SESSION['cotizacion_prospectos_insumos'][$_GET['editIns']]['idProducto']}'";
//Consulta
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_number('Cantidad', 'Cantidad', $x2, 2);
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['cotizacion_prospectos_insumos'][$_GET['editIns']]['idProducto'], 2);
				
				$Form_Imputs->form_input_disabled('Unidad de Medida','unimed', $row_data['Unimed'], 1);
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['cotizacion_prospectos_insumos'][$_GET['editIns']]['vUnitario']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'vTotal', $x3, 2);
				$Form_Imputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['cotizacion_prospectos_insumos'][$_GET['editIns']]['vUnitario']), 2);
...
WHERE productos_listado.idProducto='{$_SESSION['cotizacion_prospectos_productos'][$_GET['editProd']]['idProducto']}'";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_number('Cantidad', 'Cantidad', $x2, 2);
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['cotizacion_prospectos_productos'][$_GET['editProd']]['idProducto'], 2);
				
				$Form_Imputs->form_input_disabled('Unidad de Medida','unimed', $row_data['Unimed'], 1);
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['cotizacion_prospectos_productos'][$_GET['editProd']]['vUnitario']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'vTotal', $x3, 2);
				$Form_Imputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['cotizacion_prospectos_productos'][$_GET['editProd']]['vUnitario']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				//se dibujan los inputs	
				$Form_Imputs = new Form_Inputs();
				$Form_Imputs->form_select_filter('Prospecto Cliente','idProspecto', $x1, 2, 'idProspecto', 'Nombre', 'prospectos_listado', $w, '', $dbConn);
				$Form_Imputs->form_date('Fecha de Cotizacion','Creacion_fecha', $x2, 2);
				$Form_Imputs->form_ckeditor('Condiciones Comerciales','Observaciones', $x3, 1, 2);
        ...
        <table id="meta" class="fleft otdata">
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $_SESSION['cotizacion_prospectos_basicos']['Prospecto']; ?></td>
                </tr>
                <tr>
                    <td class="meta-head">Vendedor</td>
                    <td><?php echo $_SESSION['cotizacion_prospectos_basicos']['Usuario']; ?></td>
                </tr>
            </tbody>
        </table>
        <table id="meta" class="otdata2">
            <tbody>
                <tr>
                    ...
                    <td><?php echo Fecha_estandar($_SESSION['cotizacion_prospectos_basicos']['Creacion_fecha'])?></td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <tbody>
			...
			<tr class="item-row linea_punteada">
				...
				<td><a href="<?php echo $location.'&addImpuesto=true' ?>" title="Agregar Impuesto" class="btn btn-xs btn-primary tooltip" style="position: initial;"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Impuestos</a></td>
					...
					<?php 
					if (isset($_SESSION['cotizacion_prospectos_impuestos'])){
						//recorro el lsiatdo entregado por la base de datos
						foreach ($_SESSION['cotizacion_prospectos_impuestos'] as $key => $producto){
							...
							$_SESSION['cotizacion_prospectos_impuestos'][$producto['idImpuesto']]['valor'] = $iva;?>
							<tr class="invoice-total" bgcolor="#f1f1f1">
            ...
            <tr>
				<td colspan="6" class="blank word_break"> 
					<div class="condiciones"><?php echo $_SESSION['cotizacion_prospectos_basicos']['Observaciones'];?></div>
				</td>
            </tr>
            <tr>
                <td colspan="6" class="blank"><p>Condiciones Comerciales</p></td> 
            </tr>
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				//se dibujan los inputs	
				$Form_Imputs = new Form_Inputs();
				$Form_Imputs->form_select_filter('Prospecto Cliente','idProspecto', $x1, 1, 'idProspecto', 'Nombre', 'prospectos_listado', $w, '', $dbConn);
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					<?php foreach ($arrCotizaciones as $sol) { ?>
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 70px;" >
									<?php if ($rowlevel['level']>=1){?><a href="<?php echo 'view_prospecto_cotizacion.php?view='.$sol['idCotizacion']; ?>" title="Ver Cotizacion" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list"></i></a><?php } ?>
									<?php if ($rowlevel['level']>=4){
										$ubicacion = $location.'&del='.$sol['idCotizacion'];
