...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = 'insumos_listado.idProducto='.$_SESSION['cotizacion_prospectos_insumos'][$_GET['editIns']]['idProducto'];
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = 'productos_listado.idProducto='.$_SESSION['cotizacion_prospectos_productos'][$_GET['editProd']]['idProducto'];
	...
	$SIS_order = 0;
	$arrPermisos = array();
	$arrBorrarrPermisosame = db_select_array (false, $SIS_query, 'core_sistemas_productos', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrPermisos');
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = "cotizacion_prospectos_listado.idCotizacion>0";
	$SIS_where.= " AND cotizacion_prospectos_listado.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];
	...
	$SIS_join  = 'LEFT JOIN `prospectos_listado` ON prospectos_listado.idProspecto = cotizacion_prospectos_listado.idProspecto';
