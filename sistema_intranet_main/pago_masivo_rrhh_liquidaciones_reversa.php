...
/**********************************************************************************************/
//filtro
$z = 'WHERE pagos_rrhh_liquidaciones.idSistema='.$_SESSION['usuario']['basic_data']['idSistema'];
if(isset($_GET['idDocPago'])&&$_GET['idDocPago']!=''){
	$z .= ' AND pagos_rrhh_liquidaciones.idDocPago='.$_GET['idDocPago'];
}
