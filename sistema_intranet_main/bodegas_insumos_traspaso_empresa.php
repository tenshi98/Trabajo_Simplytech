	...
	<div id="page-wrap">
		...
		<table id="items">
			<tbody>
				...
				<tr>
					<?php if(isset($_SESSION['insumos_traspasoempresa_basicos']['Observaciones'])&&$_SESSION['insumos_traspasoempresa_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['insumos_traspasoempresa_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['insumos_traspasoempresa_temporal'])&&$_SESSION['insumos_traspasoempresa_temporal']!=''){
								$non = $_SESSION['insumos_traspasoempresa_temporal'];
							}	
...
$z="WHERE bodegas_insumos_facturacion.idTipo=6";//Solo traspaso a otra empresa
//Verifico el tipo de usuario que esta ingresando
		...
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Imputs->form_select_depend1('Empresa Destino','idSistemaDestino', $x3, 1, 'idSistema', 'Nombre', 'core_sistemas', 0, 0,
								 'Bodega Destino','idBodegaDestino', $x4, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 0, 0, 
								 $dbConn, 'form1');
