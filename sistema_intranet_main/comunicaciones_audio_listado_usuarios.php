...
$location = $original;
$new_location = "comunicaciones_audio_listado_usuarios.php";
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/comunicaciones_audio_listado_usuarios.php';
}
...
if(!empty($_GET['edit'])){
	...
	$rowData = db_select_data (false, $SIS_query, 'comunicaciones_audio_listado_usuarios', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// consulto los datos
	$SIS_query = '
	comunicaciones_audio_listado_usuarios.idUsers,
		...
		<div class="box">
			<header>
				<ul class="nav nav-tabs pull-right">
					<li class=""><a href="<?php echo 'comunicaciones_audio_listado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-bars" aria-hidden="true"></i> Resumen</a></li>
					...
					<li class="active"><a href="<?php echo 'comunicaciones_audio_listado_usuarios.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Usuarios</a></li>         
				</ul>
			</header>
