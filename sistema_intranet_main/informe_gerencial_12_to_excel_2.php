...
//sololas del mismo sistema
$SIS_where_1.=" GROUP BY bodegas_arriendos_facturacion.idCliente, bodegas_arriendos_facturacion.Creacion_Semana";
$SIS_where_2.=" GROUP BY bodegas_insumos_facturacion.idCliente, bodegas_insumos_facturacion.Creacion_Semana";
$SIS_where_3.=" GROUP BY bodegas_productos_facturacion.idCliente, bodegas_productos_facturacion.Creacion_Semana";
$SIS_where_4.=" GROUP BY bodegas_servicios_facturacion.idCliente, bodegas_servicios_facturacion.Creacion_Semana";
...
foreach ($arrCreativo as $datais) {
	$spreadsheet->setActiveSheetIndex(0)->setCellValue('A'.$nn, DeSanitizar($datais[0]['Cliente']));
	$nn++;
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Ventas Clientes por semana');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Ventas Clientes por semana';
