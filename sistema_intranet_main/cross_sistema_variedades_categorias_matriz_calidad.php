...
$location = $original;
$new_location = "cross_sistema_variedades_categorias_matriz_calidad.php";
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once 'A1XRXS_sys/xrxs_form/sistema_variedades_categorias_matriz_calidad.php';
}
...
if (isset($_GET['created'])) {$error['Transporte'] 	  = 'sucess/Matriz creada correctamente';}
if (isset($_GET['edited']))  {$error['Transporte'] 	  = 'sucess/Matriz editada correctamente';}
if (isset($_GET['deleted'])) {$error['Transporte'] 	  = 'sucess/Matriz borrada correctamente';}
	...
	<div class="box dark">	
		...
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_select_depend1('Proceso','idProceso', $x1, 2, 'idTipo', 'Nombre', 'core_cross_quality_analisis_calidad', 0, 0,
				...
				$Form_Imputs->form_input_hidden('idVarMatriz',$_GET['edit'], 2);
...
$arrProductos = array();
$query = "SELECT 
sistema_variedades_categorias_matriz_calidad.idVarMatriz,
...
LEFT JOIN `core_sistemas`                        ON core_sistemas.idSistema                       = sistema_variedades_categorias_matriz_calidad.idSistema
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				<span class="info-box-text">Especies</span>
				<span class="info-box-number"><?php echo $rowdata['Nombre']; ?></span>

				<div class="progress">
					<div class="progress-bar" style="width: 100%"></div>
				</div>
				<span class="progress-description">Editar Matrices</span>
			</div>
		</div>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<?php if ($rowlevel['level']>=3){?><a href="<?php echo $new_location.'&new=true'; ?>" class="btn btn-default fright margin_width" ><i class="fa fa-file-o" aria-hidden="true"></i> Agregar nueva matriz</a><?php }?>
	</div>
</div>
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="<?php echo 'cross_sistema_variedades_categorias.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Resumen</a></li>
				<li class="active"><a href="<?php echo 'cross_sistema_variedades_categorias_matriz_calidad.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Matriz Calidad</a></li>
						...
						<tr class="odd"> 
							...
							<td>
								<div class="btn-group" style="width: 70px;" >
									<a href="<?php echo $new_location.'&edit='.$subprocesos['idVarMatriz']; ?>" title="Editar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a>
									<?php 
										$ubicacion = $new_location.'&del='.$subprocesos['idVarMatriz'];
