...
if(!empty($_GET['edit'])){
	...
	$rowData = db_select_data (false, $SIS_query, 'sistema_variedades_categorias_matriz_calidad', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_order = 0;
	$arrProductos = array();
	$arrProductos = db_select_array (false, $SIS_query, 'sistema_variedades_categorias_matriz_calidad', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrProductos');
