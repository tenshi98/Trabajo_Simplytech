...
$original = "informe_telemetria_registro_sensores_4.php";
$location = $original;
...
if(isset($_GET['idTelemetria'])&&$_GET['idTelemetria']!=''){
	...
	for ($i = 1; $i <= $total_files; $i++) { 
		...
		$Alert_Text .= '<a target="new" href="informe_telemetria_registro_sensores_4_to_excel.php?bla=bla'.$datosx.'" class="btn btn-sm btn-metis-2 fright "><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>';
