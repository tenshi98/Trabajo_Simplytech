...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		...
		case 'fechacancelacion_asc':     $order_by = 'ORDER BY crosstech_gestion_tickets.FechaCancelacion ASC ';     $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Cancelacion Ticket Ascendente';break;
		case 'fechacancelacion_desc':    $order_by = 'ORDER BY crosstech_gestion_tickets.FechaCancelacion DESC ';    $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Cancelacion Ticket Descendente';break;
...
$z.= " AND crosstech_gestion_tickets.idEstado=3";      //solo cancelados
...
if(isset($_GET['FechaCancelacion']) && $_GET['FechaCancelacion'] != ''){    $z .= " AND crosstech_gestion_tickets.FechaCancelacion='".$_GET['FechaCancelacion']."'";}
