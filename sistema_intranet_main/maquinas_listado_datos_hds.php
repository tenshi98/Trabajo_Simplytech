...
$location = $original;
$new_location = "maquinas_listado_datos_hds.php";
...
$query = "SELECT Nombre,HDS, idConfig_1, idConfig_2, idConfig_3
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, $x_column_maquina_plur, $rowdata['Nombre'], 'Editar Hoja de Seguridad');?>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'maquinas_listado_datos_hds.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-calendar-check-o" aria-hidden="true"></i> HDS</a></li>
