...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
	...
	<a target="new" href="<?php echo 'informe_telemetria_errores_1_to_pdf.php?bla=bla'.$search ; ?>"   class="btn btn-sm btn-metis-3 pull-right margin_width"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar a PDF</a>
</div>
						...
						<tr>
							...
							<td>
								<div class="btn-group" style="width: 35px;" >
									<a href="<?php echo 'informe_telemetria_errores_1_view.php?view='.simpleEncode($error['idErrores'], fecha_actual()); ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a>
								</div>
							</td>
						</tr>
                    <?php }  ?>
