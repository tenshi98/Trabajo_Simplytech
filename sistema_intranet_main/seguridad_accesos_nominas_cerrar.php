			...
			<table id="meta" class="pull-left otdata">
				<tbody>
					<tr>
						...
						<td class="meta-head"><a href="<?php echo $location.'&id='.$_GET['id'].'&modBase=true' ?>" title="Modificar Datos Basicos" class="btn btn-xs btn-primary tooltip pull-right" style="position: initial;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modificar</a></td>
					</tr>
					<tr>
