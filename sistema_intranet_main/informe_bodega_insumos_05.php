...
$original = "informe_bodega_insumos_05.php";
$location = $original;
...
if(isset($_GET['N_Doc']) && $_GET['N_Doc']!=''){                  
	$z .= " AND bodegas_insumos_facturacion.N_Doc LIKE '%".EstandarizarInput($_GET['N_Doc'])."%'";
...
if(isset($_GET['N_DocPago']) && $_GET['N_DocPago']!=''){          
	$z .= " AND bodegas_insumos_facturacion.N_DocPago LIKE '%".EstandarizarInput($_GET['N_DocPago'])."%'";
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
	<a target="new" href="<?php echo 'informe_bodega_insumos_05_to_excel.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
</div>

<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table" aria-hidden="true"></i></div><h5>Listado de Insumos de la bodega</h5>
		</header>
	...
	<div class="box">
		...
		<div class="body">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" autocomplete="off" novalidate>
				...
				$Form_Inputs->form_select_join_filter('Bodega Origen','idBodegaOrigen', $x1, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $z1, $dbConn);
				$Form_Inputs->form_select_join_filter('Bodega Destino','idBodegaDestino', $x2, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $z1, $dbConn);
				...
				$Form_Inputs->form_select('Documento de Pago','idTipo', $x9, 1, 'idTipo', 'Nombre', 'bodegas_insumos_facturacion_tipo', 0, '', $dbConn);
				...
				$Form_Inputs->form_select_filter('Insumo','idProducto', $x20, 1, 'idProducto', 'Nombre', 'insumos_listado', $zx2, '', $dbConn);
