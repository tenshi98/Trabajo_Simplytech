...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Insumos de la bodega</h5>
			<div class="toolbar">
				<a target="new" href="informe_bodega_insumos_05_to_excel.php<?php echo $search ?>" class="btn btn-sm btn-metis-2"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
			</div>
		</header>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Imputs->form_select_join_filter('Bodega Origen','idBodegaOrigen', $x1, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $z1, $dbConn);
				$Form_Imputs->form_select_join_filter('Bodega Destino','idBodegaDestino', $x2, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $z1, $dbConn);
				...
				$Form_Imputs->form_select('Tipo Documento','idTipo', $x9, 1, 'idTipo', 'Nombre', 'bodegas_insumos_facturacion_tipo', 0, '', $dbConn);
				...
				$Form_Imputs->form_select_filter('Insumo','idProducto', $x20, 1, 'idProducto', 'Nombre', 'insumos_listado', $zx2, '', $dbConn);
