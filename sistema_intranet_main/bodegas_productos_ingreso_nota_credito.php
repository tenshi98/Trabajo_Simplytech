...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = 'productos_listado.idProducto='.$_SESSION['productos_ing_nc_productos'][$_GET['editProd']]['idProducto'];
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['productos_ing_nc_productos'][$_GET['editProd']]['ValorIngreso']));
					$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x3, 2);
					$Form_Inputs->form_input_hidden('ValorIngreso', Cantidades_decimales_justos($_SESSION['productos_ing_nc_productos'][$_GET['editProd']]['ValorIngreso']), 2);
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['productos_ing_nc_otros'][$_GET['editOtros']]['idOtros'], 2);
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($idUsoIVA)){           $x6  = $idUsoIVA;         }else{$x6  = $_SESSION['productos_ing_nc_basicos']['idUsoIVA'];}
					...
					$Form_Inputs->form_select_join_filter('Bodega origen','idBodega', $x4, 2, 'idBodega', 'Nombre', 'bodegas_productos_listado', 'usuarios_bodegas_productos', $z, $dbConn);
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div id="customer">
				...
				<table id="meta" class="pull-left otdata">
					<tbody>
						...
						<?php if(isset($_SESSION['productos_ing_nc_basicos']['idUsoIVA'])&&$_SESSION['productos_ing_nc_basicos']['idUsoIVA']==1){ ?>
							<tr>
		...
		<div class="col-xs-12">
			<div class="row">
				...
				<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['productos_ing_nc_basicos']['Observaciones']; ?></p>
			</div>
		</div>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = "bodegas_productos_facturacion.idTipo=11";//Solo egresos
	...
	if(isset($_GET['Devolucion_fecha']) && $_GET['Devolucion_fecha']!=''){  $SIS_where .= " AND bodegas_productos_facturacion.Devolucion_fecha='".$_GET['Devolucion_fecha']."'";}
	if(isset($_GET['idTrabajador']) && $_GET['idTrabajador']!=''){          $SIS_where .= " AND bodegas_productos_facturacion.idTrabajador=".$_GET['idTrabajador'];}
	if(isset($_GET['idBodega']) && $_GET['idBodega']!=''){                  $SIS_where .= " AND bodegas_productos_facturacion.idBodega=".$_GET['idBodega'];}
		...
		<div class="well">
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
				<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_select_join_filter('Bodega origen','idBodega', $x6, 1, 'idBodega', 'Nombre', 'bodegas_productos_listado', 'usuarios_bodegas_productos', $v, $dbConn);
