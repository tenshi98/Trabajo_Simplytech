...
$original = "crosstech_gestion_tickets_abiertos.php";
$location = $original;
...
// consulto los datos
$query = "SELECT idEstado, DescripcionCierre, DescripcionCancelacion
...
$SIS_where.= " AND crosstech_gestion_tickets.idEstado=1";      //solo abierto
...
$SIS_where.= " crosstech_gestion_tickets.idTicket";
