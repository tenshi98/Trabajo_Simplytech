	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Permiso de Circulacion</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'vehiculos_listado_doc_permiso_circulacion.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Archivo - Permiso Circulacion</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				...
				<?php if(isset($rowdata['doc_permiso_circulacion'])&&$rowdata['doc_permiso_circulacion']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						...
						<?php echo preview_docs('upload', $rowdata['doc_permiso_circulacion'], ''); ?>
					</div>
					<a href="<?php echo $new_location.'&id='.$_GET['id'].'&del_doc_permiso_circulacion='.$_GET['id']; ?>" class="btn btn-danger fright margin_width" style="margin-top:10px;margin-bottom:10px;"><i class="fa fa-trash-o" aria-hidden="true"></i> Borrar Archivo</a>
					<div class="clearfix"></div>
				...
				<?php }else{?>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
						...
						$Form_Imputs->form_multiple_upload('Seleccionar archivo','doc_permiso_circulacion', 1, '"doc","docx","pdf","jpg", "png", "gif", "jpeg"');
						$Form_Imputs->form_date('Fecha Vencimiento','doc_fecha_permiso_circulacion', $x1, 2);
