			...
			case 11:
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 invoice-col">
					...
					if(isset($rowData['Devolucion_fecha'])&&$rowData['Devolucion_fecha']!=''&&$rowData['Devolucion_fecha']!='0000-00-00'){
						$html .= '<strong>Fecha Devolucion : </strong>'.Fecha_estandar($rowData['Devolucion_fecha']).'<br/>';
					}
					...
					if(isset($rowData['idEstadoDevolucion'])&&$rowData['idEstadoDevolucion']==1){
						$html .= '<strong>Estado Devolucion : </strong>'.$rowData['Devolucion_Estado'].'<br/>';
					}
					if(isset($rowData['idEstadoDevolucion'])&&$rowData['idEstadoDevolucion']==2){
						$html .= '<strong>Estado Devolucion : </strong>'.$rowData['Devolucion_Estado'].'<br/>';
						$html .= '<strong>Usuario Devolucion : </strong>'.$rowData['Devolucion_Usuario'].'<br/>';
						$html .= '<strong>Fecha Real Devolucion : </strong>'.Fecha_estandar($rowData['Devolucion_FechaReal']).'<br/>';
					}
