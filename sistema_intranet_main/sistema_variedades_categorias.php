...
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Especie editada correctamente';}
...
// consulto los datos
$query = "SELECT  
Nombre,Temp_optima_min, Temp_optima_max, Temp_optima_margen_critico
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="<?php echo 'sistema_variedades_categorias.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-bars" aria-hidden="true"></i> Resumen</a></li>
...
$cuenta_registros = db_select_nrows (false, 'idCategoria', 'sistema_variedades_categorias', '', $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'cuenta_registros');
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){ ?><a href="<?php echo $location; ?>&new=true" class="btn btn-default pull-right margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Especie</a><?php } ?>
