...
function crear_data($limite, $idTelemetria, $f_inicio, $f_termino, $dbConn ) {
	...
	telemetria_listado_tablarelacionada_".$idTelemetria.".GeoLatitud AS GeoLatitudEquipo,
	telemetria_listado_tablarelacionada_".$idTelemetria.".GeoLongitud AS GeoLongitudEquipo,
	telemetria_listado_tablarelacionada_".$idTelemetria.".GeoVelocidad AS GeoVelocidadEquipo,
	telemetria_listado_tablarelacionada_".$idTelemetria.".GeoDireccion AS GeoDireccionEquipo,
	telemetria_listado_tablarelacionada_".$idTelemetria.".GeoMovimiento AS GeoMovimientoEquipo
	".$subquery."
