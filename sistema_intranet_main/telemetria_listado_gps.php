...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
// consulto los datos
$rowdata = db_select_data (false, 'Nombre,id_Sensores, id_Geo, idUsoContrato, idUsoGeocerca,idTipo, Marca, Modelo, Patente, Num_serie, AnoFab, idZona, CapacidadPersonas,CapacidadKilos, MCubicos, LimiteVelocidad, TiempoDetencion', 'telemetria_listado', '', 'idTelemetria ='.$_GET['id'], $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowdata');
