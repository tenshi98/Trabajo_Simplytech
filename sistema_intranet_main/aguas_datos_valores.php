...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Valor Creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Valor Modificado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Valor borrado correctamente';}
