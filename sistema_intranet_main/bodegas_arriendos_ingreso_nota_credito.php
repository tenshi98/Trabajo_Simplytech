...
$original = "bodegas_arriendos_ingreso_nota_credito.php";
$location = $original;
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($idEquipo)){       $x1  = $idEquipo;      }else{$x1  = $_SESSION['arriendos_ing_nc_productos'][$_GET['editProd']]['idEquipo'];}
					if(isset($Cantidad_eg)){    $x2  = $Cantidad_eg;   }else{$x2  = Cantidades_decimales_justos($_SESSION['arriendos_ing_nc_productos'][$_GET['editProd']]['Cantidad_eg']);}
					if(isset($idFrecuencia)){   $x3  = $idFrecuencia;  }else{$x3  = $_SESSION['arriendos_ing_nc_productos'][$_GET['editProd']]['idFrecuencia'];}
					if(isset($ValorTotal)){     $x4  = $ValorTotal;    }else{$x4  = Cantidades_decimales_justos($_SESSION['arriendos_ing_nc_productos'][$_GET['editProd']]['ValorTotal']);}
					...
					$Form_Inputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['arriendos_ing_nc_productos'][$_GET['editProd']]['ValorIngreso']));
					$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x4, 2);
					$Form_Inputs->form_input_hidden('vUnitario', Cantidades_decimales_justos($_SESSION['arriendos_ing_nc_productos'][$_GET['editProd']]['ValorIngreso']), 2);
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					<?php
					//Se verifican si existen los datos
					if(isset($Nombre)){  $x1  = $Nombre;  }else{$x1  = $_SESSION['arriendos_ing_nc_otros'][$_GET['editOtros']]['Nombre'];}
					if(isset($vTotal)){  $x2  = $vTotal;  }else{$x2  = Cantidades_decimales_justos($_SESSION['arriendos_ing_nc_otros'][$_GET['editOtros']]['vTotal']);}
					...
					$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['arriendos_ing_nc_otros'][$_GET['editOtros']]['idOtros'], 2);
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					<?php
					//Se verifican si existen los datos
					if(isset($idProveedor)){        $x1  = $idProveedor;      }else{$x1  = $_SESSION['arriendos_ing_nc_basicos']['idProveedor'];}
					if(isset($N_Doc)){              $x2  = $N_Doc;            }else{$x2  = $_SESSION['arriendos_ing_nc_basicos']['N_Doc'];}
					if(isset($Creacion_fecha)){     $x3  = $Creacion_fecha;   }else{$x3  = $_SESSION['arriendos_ing_nc_basicos']['Creacion_fecha'];}
					if(isset($idBodega)){           $x4  = $idBodega;         }else{$x4  = $_SESSION['arriendos_ing_nc_basicos']['idBodega'];}
					if(isset($Observaciones)){      $x5  = $Observaciones;    }else{$x5  = $_SESSION['arriendos_ing_nc_basicos']['Observaciones'];}
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idDocumentos = '.$_SESSION['arriendos_ing_nc_basicos']['idDocumentos'];
	$rowDocumento = db_select_data (false, $SIS_query, 'core_documentos_mercantiles', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowDocumento');

	/*******************************************************/
	// consulto los datos
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idTipo = '.$_SESSION['arriendos_ing_nc_basicos']['idTipo'];
	$rowTipoDocumento = db_select_data (false, $SIS_query, 'bodegas_arriendos_facturacion_tipo', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowTipoDocumento');

	/*******************************************************/
	// consulto los datos
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idProveedor = '.$_SESSION['arriendos_ing_nc_basicos']['idProveedor'];
	$rowProveedor = db_select_data (false, $SIS_query, 'proveedor_listado', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowProveedor');

	/*******************************************************/
	// consulto los datos
	$SIS_query = 'Nombre';
	$SIS_join  = '';
	$SIS_where = 'idBodega = '.$_SESSION['arriendos_ing_nc_basicos']['idBodega'];
	$rowBodega = db_select_data (false, $SIS_query, 'bodegas_arriendos_listado', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowBodega');

	/*******************************************************/
	// consulto los datos
	$SIS_query = 'idEquipo, Nombre';
	$SIS_join  = '';
	$SIS_where = 'idEstado=1';
	$SIS_order = 0;
	$arrServicios = array();
	$arrServicios = db_select_array (false, $SIS_query, 'equipos_arriendo_listado', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrServicios');

	/*******************************************************/
	// consulto los datos
	$SIS_query = 'idImpuesto, Nombre,Porcentaje';
	$SIS_join  = '';
	$SIS_where = '';
	$SIS_order = 'idImpuesto ASC';
	$arrImpuestos = array();
	$arrImpuestos = db_select_array (false, $SIS_query, 'sistema_impuestos', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrImpuestos');

	/*******************************************************/
	// consulto los datos
	$SIS_query = 'idFrecuencia, Nombre';
	$SIS_join  = '';
	$SIS_where = '';
	$SIS_order = 0;
	$arrFrecuencia = array();
	$arrFrecuencia = db_select_array (false, $SIS_query, 'core_tiempo_frecuencia', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrFrecuencia');
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div id="page-wrap">
				...
				<table id="meta" class="pull-left otdata">
					<tbody>
						...
						<tr>
							...
							<td><?php echo $rowDocumento['Nombre'].' N°'.n_doc($_SESSION['arriendos_ing_nc_basicos']['N_Doc'], 8); ?></td>
						</tr>
						<tr>
				...
				<table id="meta" class="otdata2">
					<tbody>
						<tr>
							...
							<td colspan="2"><?php echo Fecha_estandar($_SESSION['arriendos_ing_nc_basicos']['Creacion_fecha']); ?></td>
						</tr>
					</tbody>
				</table>
			</div>
			<table id="items">
				<tbody>
								...
								if($prod['idEquipo']==$producto['idEquipo']){
									...
									<tr class="item-row linea_punteada">
										...
										<td class="item-name">
											...
											echo Cantidades_decimales_justos($producto['Cantidad_eg']).' '.$medida;
											?>
										</td>
					...
					<?php  //Guardo el neto
					$_SESSION['arriendos_ing_nc_basicos']['valor_neto_fact'] = $vtotal_neto;
					?>
						...
						$_SESSION['arriendos_ing_nc_basicos']['valor_neto_imp'] = $vtotal_neto;
						?>
						<tr class="invoice-total" bgcolor="#f1f1f1">
						...
						if (isset($_SESSION['arriendos_ing_nc_impuestos'])){
							...
							foreach ($arrImpuestos as $impto) {
								foreach ($_SESSION['arriendos_ing_nc_impuestos'] as $key => $producto){
									if($impto['idImpuesto']==$producto['idImpuesto']){
										...
										$_SESSION['arriendos_ing_nc_impuestos'][$producto['idImpuesto']]['valor'] = $vtotal_IVA;
						...
						//guardo el total
						$_SESSION['arriendos_ing_nc_basicos']['valor_total_fact'] = $vtotal_neto;
		...
		<div class="col-xs-12">
			<div class="row">
				...
				<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['arriendos_ing_nc_basicos']['Observaciones']; ?></p>
			</div>
		</div>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
		switch ($_GET['order_by']) {
			case 'cliente_asc':  $order_by = 'proveedor_listado.Nombre ASC ';                      $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Proveedor Ascendente'; break;
			case 'cliente_desc': $order_by = 'proveedor_listado.Nombre DESC ';                     $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Proveedor Descendente';break;
	...
	$SIS_where = "bodegas_arriendos_facturacion.idTipo=11";//Solo egresos
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb-bar">
		...
		<?php if ($rowlevel['level']>=3){ ?>
			<?php if (isset($_SESSION['arriendos_ing_nc_basicos']['idProveedor'])&&$_SESSION['arriendos_ing_nc_basicos']['idProveedor']!=''){ ?>
		...
		<div class="well">
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
				<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" autocomplete="off" novalidate>
					...
					$Form_Inputs->form_select_join_filter('Bodega origen','idBodega', $x6, 1, 'idBodega', 'Nombre', 'bodegas_arriendos_listado', 'usuarios_bodegas_arriendos', $v, $dbConn);
