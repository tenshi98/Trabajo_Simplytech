...
if (isset($_GET['deleted'])){ $error['deleted'] = 'sucess/Venta Borrada correctamente';}
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	(SELECT SUM(Cantidad_ing) FROM `bodegas_productos_facturacion_existencias` WHERE idProducto = productos_listado.idProducto AND idBodega='.$_SESSION['productos_egr_basicos']['idBodega'].' LIMIT 1) AS ingreso,
	(SELECT SUM(Cantidad_eg)  FROM `bodegas_productos_facturacion_existencias` WHERE idProducto = productos_listado.idProducto AND idBodega='.$_SESSION['productos_egr_basicos']['idBodega'].' LIMIT 1) AS egreso';
	$SIS_join  = 'LEFT JOIN `sistema_productos_uml` ON sistema_productos_uml.idUml = productos_listado.idUml';
	$SIS_where = 'productos_listado.idProducto='.$_SESSION['productos_egr_productos'][$_GET['editProd']]['idProducto'];
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	foreach ($arrPermisos as $prod) {
		$SIS_where .= " OR (productos_listado.idEstado=1 AND productos_listado.idProducto=".$prod['idProducto'].")";
		$zx1       .= " OR (productos_listado.idEstado=1 AND productos_listado.idProducto=".$prod['idProducto'].")";
	}
	$SIS_order = 'productos_listado.idProducto ASC';
	$arrTipo = array();
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = "bodegas_productos_facturacion.idTipo=2";//Solo egresos
