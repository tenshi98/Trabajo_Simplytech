	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_hidden('oldidProducto', $_SESSION['productos_egr_descuentos'][$_GET['editDescuentos']]['idDescuento'], 2);
				?>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_disabled('Valor Unitario','Unitario', Cantidades_decimales_justos($_SESSION['productos_egr_productos'][$_GET['editProd']]['ValorEgreso']), 1);
				$Form_Inputs->form_input_number('Valor Total Neto', 'ValorTotal', $x3, 2);
				$Form_Inputs->form_input_hidden('ValorEgreso', Cantidades_decimales_justos($_SESSION['productos_egr_productos'][$_GET['editProd']]['ValorEgreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($fecha_fact_desde)) {   $x5  = $fecha_fact_desde; }else{$x5  = $_SESSION['productos_egr_basicos']['fecha_fact_desde'];}
				if(isset($fecha_fact_hasta)) {   $x6  = $fecha_fact_hasta; }else{$x6  = $_SESSION['productos_egr_basicos']['fecha_fact_hasta'];}
				if(isset($idBodega)) {           $x7  = $idBodega;         }else{$x7  = $_SESSION['productos_egr_basicos']['idBodega'];}
				if(isset($idTrabajador)) {       $x8  = $idTrabajador;     }else{$x8  = $_SESSION['productos_egr_basicos']['idTrabajador'];}
				if(isset($Observaciones)) {      $x9  = $Observaciones;    }else{$x9  = $_SESSION['productos_egr_basicos']['Observaciones'];}
				if(isset($OC_Ventas)) {          $x10 = $OC_Ventas;        }else{$x10 = $_SESSION['productos_egr_basicos']['OC_Ventas'];}
				if(isset($idUsoIVA)) {           $x11 = $idUsoIVA;         }else{$x11 = $_SESSION['productos_egr_basicos']['idUsoIVA'];}
				...
				$Form_Inputs->form_select_join_filter('Bodega Origen','idBodega', $x7, 2, 'idBodega', 'Nombre', 'bodegas_productos_listado', 'usuarios_bodegas_productos', $z, $dbConn);
...
<div class="col-sm-12">
		...
		<div id="customer">
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					...
					<?php if(isset($_SESSION['productos_egr_basicos']['idUsoIVA'])&&$_SESSION['productos_egr_basicos']['idUsoIVA']==1){ ?>
						<tr>
			...
			<table id="meta" class="otdata2">
				<tbody>
					...
					<?php if($_SESSION['productos_egr_basicos']['idDocumentos']==2){?>
						...
						<?php if(isset($_SESSION['productos_egr_basicos']['fecha_fact_desde'])&&$_SESSION['productos_egr_basicos']['fecha_fact_desde']!=''&&$_SESSION['productos_egr_basicos']['fecha_fact_desde']!='0'&&$_SESSION['productos_egr_basicos']['fecha_fact_desde']!='0000-00-00'){ ?>
							<tr>
								<td class="meta-head">Facturacion Desde</td>
								<td colspan="2"><?php echo Fecha_estandar($_SESSION['productos_egr_basicos']['fecha_fact_desde'])?></td>
							</tr>
						<?php }?>
						<?php if(isset($_SESSION['productos_egr_basicos']['fecha_fact_hasta'])&&$_SESSION['productos_egr_basicos']['fecha_fact_hasta']!=''&&$_SESSION['productos_egr_basicos']['fecha_fact_hasta']!='0'&&$_SESSION['productos_egr_basicos']['fecha_fact_hasta']!='0000-00-00'){ ?>
							<tr>
								<td class="meta-head">Facturacion Hasta</td>
								<td colspan="2"><?php echo Fecha_estandar($_SESSION['productos_egr_basicos']['fecha_fact_hasta'])?></td>
							</tr>
						<?php }?>
					<?php }?>
				</tbody>
    ...
    <div class="row">
		<div class="col-xs-12">
			...
			<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['productos_egr_basicos']['Observaciones'];?></p>
		</div>
	</div>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($OC_Ventas)) {          $x10 = $OC_Ventas;        }else{$x10 = '';}
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select_join_filter('Bodega Origen','idBodega', $x7, 1, 'idBodega', 'Nombre', 'bodegas_productos_listado', 'usuarios_bodegas_productos', $v, $dbConn);
