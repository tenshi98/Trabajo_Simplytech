...
WHERE idDatosDetalle = ".$_GET['modMed'];
//Consulta
			...
			<table id="meta" class="fleft otdata">
				<tbody>
					<tr>
						...
						<td class="meta-head"><a href="<?php echo $location.'&id='.$_GET['id'].'&modData='.$_GET['id'] ?>" title="Modificar Datos Basicos" class="btn btn-xs btn-primary tooltip fright" style="position: initial;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modificar</a></td>
					</tr>
					<tr>
...
".$z."
ORDER BY aguas_clientes_listado.idCliente";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
			...
			<div id="div-1" class="body">
				...
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
					...
					<div class="form-group" style="margin-top:10px;">
						<input type="submit" class="btn btn-primary fright margin_width fa-input" value="&#xf0c7; Guardar" name="submit_add_client"> 
...
<div class="clearfix"></div>
<div class="col-lg-12 fcenter" style="margin-bottom:30px; margin-top:30px">
<a href="<?php echo $location.'&view=true'; ?>"  class="btn btn-danger fright margin_width"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver</a>
<div class="clearfix"></div>
</div>	
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
		...
		<div id="customer">
			<table id="meta" class="fleft otdata">
				<tbody>
					<tr>
						<td class="meta-head"><strong>DATOS BASICOS</strong></td>
						<td class="meta-head"><a href="<?php echo $location.'&view=true&modBase=true' ?>" title="Modificar Datos Basicos" class="btn btn-xs btn-primary tooltip fright" style="position: initial;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modificar</a></td>
					</tr>
					<tr>
						<td class="meta-head">Creador</td>
		...
		<table id="items">
			<tbody>
				<tr>
					...
					<th colspan="1"><a href="<?php echo $location.'&view=true&addclient=true' ?>" title="Agregar Clientes" class="btn btn-xs btn-primary tooltip fright" style="position: initial;"><i class="fa fa-user-plus" aria-hidden="true"></i> Agregar Clientes</a></th>
				</tr>		  
...
$z.= " AND aguas_mediciones_datos.idTipo=2";
/**********************************************************/
