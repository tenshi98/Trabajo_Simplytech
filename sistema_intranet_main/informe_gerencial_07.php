							...
							<tr class="odd">
								...
								<td>
									<div class="btn-group" style="width: 35px;" >
										<a target="_blank" rel="noopener noreferrer" href="informe_gerencial_08.php'.$search.'" title="Ver Informacion" class="btn btn-primary btn-sm info-tooltip"><i class="fa fa-list" aria-hidden="true"></i></a>
									</div>
								</td>
							</tr>';
						}
