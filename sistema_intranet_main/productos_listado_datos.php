	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'productos_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos Basicos</a></li>
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post"  id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_input_text( 'Codigo', 'Codigo', $x8, 1);
					$Form_Imputs->form_textarea('Ingredientes Activos','IngredienteActivo', $x9, 1, 160);
					//$Form_Imputs->form_ckeditor('Ingredientes Activos','IngredienteActivo', $x9, 1, 2);
					$Form_Imputs->form_input_text( 'Carencia', 'Carencia', $x10, 1);
					$Form_Imputs->form_input_number_spinner('Dosis Recomendada','DosisRecomendada', $x11, 0, 99999, '0.01', 2, 1);
					$Form_Imputs->form_input_number_spinner('Efecto Residual','EfectoResidual', $x12, 0, 500, 1, 0, 1);
					$Form_Imputs->form_input_number_spinner('Efecto Retroactivo','EfectoRetroactivo', $x13, 0, 500, 1, 0, 1);
					$Form_Imputs->form_input_number_spinner('Carencia Exportador','CarenciaExportador', $x14, 0, 500, 1, 0, 1);
