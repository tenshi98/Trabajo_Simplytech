...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Embalaje Creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Embalaje Modificado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Embalaje borrado correctamente';}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_number('Peso', 'Peso', $x3, 1);
				$Form_Imputs->form_textarea('Descripcion','Descripcion', $x4, 1, 130);
...
if(isset($_GET['Codigo']) && $_GET['Codigo'] != ''){ $z .= " AND sistema_cross_analisis_embalaje.Codigo LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['Peso']) && $_GET['Peso'] != ''){     $z .= " AND sistema_cross_analisis_embalaje.Peso LIKE '%".$_GET['Nombre']."%'";}
/**********************************************************/
...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Embalajes</h5>
			<div class="toolbar">
				<?php 
				...
				<thead>
					<tr role="row">
						...
						<th>
							...
							<div class="btn-group pull-right" style="width: 50px;" >
								<a href="<?php echo $location.'&order_by=peso_asc'; ?>" title="Ascendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-asc"></i></a>
								<a href="<?php echo $location.'&order_by=peso_desc'; ?>" title="Descendente" class="btn btn-default btn-xs tooltip"><i class="fa fa-sort-alpha-desc"></i></a>
							</div>
						</th>
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group" style="width: 70px;" >
								<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$uml['idTipo']; ?>" title="Editar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a><?php } ?>
								<?php if ($rowlevel['level']>=4){
									$ubicacion = $location.'&del='.$uml['idTipo'];
