...
$original = "cross_quality_proceso_matriz.php";
$location = $original;
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				//se dibujan los inputs
				$Form_Imputs = new Form_Inputs();
				$Form_Imputs->form_select('Parametro','PuntoidGrupo', $rowdata['Grupo'], 1, 'idGrupo', 'Nombre', 'cross_quality_proceso_matriz_grupos', 0, '', $dbConn);	
