...
$location = $original;
$new_location = "transportes_listado_observaciones.php";
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/transportes_observaciones.php';
}
...
FROM `transportes_observaciones`
	...
	<div class="box dark">	
		...
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_hidden('idTransporte', $_GET['id'], 2);
...
//Obtengo los datos de una observacion
$query = "SELECT 
transportes_listado.Nombre AS nombre_transporte,
usuarios_listado.Nombre AS nombre_usuario,
transportes_observaciones.Fecha,
transportes_observaciones.Observacion
FROM `transportes_observaciones`
LEFT JOIN `transportes_listado`   ON transportes_listado.idTransporte     = transportes_observaciones.idTransporte
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario     = transportes_observaciones.idUsuario
WHERE transportes_observaciones.idObservacion = {$_GET['view']}
ORDER BY transportes_observaciones.idObservacion ASC ";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
<div class="col-sm-8 fcenter">
	<div class="box">	
        ...
        <div class="body">
            ...
            <p class="text-muted">
				<strong>Transporte : </strong><?php echo $rowdata['nombre_transporte']; ?><br/>
...
// Se trae un listado con todas las observaciones el transporte
$arrObservaciones = array();
$query = "SELECT 
transportes_observaciones.idObservacion,
transportes_listado.Nombre AS nombre_transporte,
usuarios_listado.Nombre AS nombre_usuario,
transportes_observaciones.Fecha,
transportes_observaciones.Observacion
...
LEFT JOIN `transportes_listado`   ON transportes_listado.idTransporte     = transportes_observaciones.idTransporte
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario     = transportes_observaciones.idUsuario
WHERE transportes_observaciones.idTransporte = {$_GET['id']}
ORDER BY transportes_observaciones.idObservacion ASC ";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="<?php echo 'transportes_listado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Resumen</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'transportes_listado_observaciones.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Observaciones</a></li>
