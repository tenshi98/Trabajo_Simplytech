...
$location = $original;
$new_location = "clientes_proyectos_listado_datos_persona_contacto.php";
...
if (isset($_GET['created'])) {$error['Cliente'] 	  = 'sucess/Proyecto creado correctamente';}
if (isset($_GET['edited']))  {$error['Cliente'] 	  = 'sucess/Proyecto editado correctamente';}
if (isset($_GET['deleted'])) {$error['Cliente'] 	  = 'sucess/Proyecto borrado correctamente';}
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Proyecto', $rowdata['Nombre'], 'Editar Persona de contacto');?>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li class="active"><a href="<?php echo 'clientes_proyectos_listado_datos_persona_contacto.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-volume-control-phone" aria-hidden="true"></i> Persona Contacto</a></li>
