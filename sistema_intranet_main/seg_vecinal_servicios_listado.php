...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Servicio editado correctamente';}
...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'tipo_asc':      $order_by = 'ORDER BY seg_vecinal_servicios_tipos.Nombre ASC ';      $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Tipo Ascendente';break;
		case 'tipo_desc':     $order_by = 'ORDER BY seg_vecinal_servicios_tipos.Nombre DESC ';     $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Tipo Descendente';break;
		case 'nombre_asc':    $order_by = 'ORDER BY seg_vecinal_servicios_listado.Nombre ASC ';    $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';break;
		case 'nombre_desc':   $order_by = 'ORDER BY seg_vecinal_servicios_listado.Nombre DESC ';   $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Nombre Descendente';break;
		
		default: $order_by = 'ORDER BY seg_vecinal_servicios_listado.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';
	}
}else{
	$order_by = 'ORDER BY seg_vecinal_servicios_listado.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';
}
/**********************************************************/
//Variable de busqueda
$z = "WHERE seg_vecinal_servicios_listado.idServicio!=0";	

/**********************************************************/
//Se aplican los filtros
if(isset($_GET['idTipo']) && $_GET['idTipo'] != ''){             $z .= " AND seg_vecinal_servicios_listado.idTipo=".$_GET['idTipo'];}
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){             $z .= " AND seg_vecinal_servicios_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['idCiudad']) && $_GET['idCiudad'] != ''){         $z .= " AND seg_vecinal_servicios_listado.idCiudad=".$_GET['idCiudad'];}
if(isset($_GET['idComuna']) && $_GET['idComuna'] != ''){         $z .= " AND seg_vecinal_servicios_listado.idComuna=".$_GET['idComuna'];}
if(isset($_GET['Direccion']) && $_GET['Direccion'] != ''){       $z .= " AND seg_vecinal_servicios_listado.Direccion LIKE '%".$_GET['Direccion']."%'";}
/**********************************************************/
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT seg_vecinal_servicios_listado.idServicio FROM `seg_vecinal_servicios_listado` ".$z;
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
...
FROM `seg_vecinal_servicios_listado`
LEFT JOIN `seg_vecinal_servicios_tipos`  ON seg_vecinal_servicios_tipos.idTipo     = seg_vecinal_servicios_listado.idTipo
".$z."
".$order_by."
