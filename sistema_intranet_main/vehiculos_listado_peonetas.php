...
$location = $original;
$new_location = "vehiculos_listado_peonetas.php";
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/vehiculos_listado_peonetas.php';
}
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Peoneta creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Peoneta editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Peoneta borrado correctamente';}
	...
	<div class="box dark">	
		...
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_date('F Nacimiento','Fecha', $x5, 1);
					
					
				$Form_Imputs->form_input_hidden('idPeoneta', $_GET['edit'], 2);
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Peonetas</span>
			</div>
		</div>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<?php if ($rowlevel['level']>=3){?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&new=true'; ?>" class="btn btn-default fright margin_width" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Peoneta</a><?php }?>
	</div>
</div>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						if(isset($rowdata['idOpciones_7'])&&$rowdata['idOpciones_7']==1){?>
							<li class="active"><a href="<?php echo 'vehiculos_listado_peonetas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Peonetas</a></li>
						<?php }
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				<thead>
					<tr role="row">
						<th width="120">Rut</th>
						<th>Nombre</th>
						<th width="160">Fecha Nacimiento</th>
						<th width="10">Acciones</th>
					</tr>
				</thead>
				<tbody role="alert" aria-live="polite" aria-relevant="all">
				<?php foreach ($arrPeonetas as $peoneta) { ?>
					<tr class="odd">		
						<td><?php echo $peoneta['Rut']; ?></td>	
						<td><?php echo $peoneta['Nombre'].' '.$peoneta['ApellidoPat'].' '.$peoneta['ApellidoMat']; ?></td>	
						<td><?php echo fecha_estandar($peoneta['Fecha']); ?></td>	
						<td>
							<div class="btn-group" style="width: 70px;" >
								<?php if ($rowlevel['level']>=2){?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&edit='.$peoneta['idPeoneta']; ?>" title="Editar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a><?php } ?>
								<?php if ($rowlevel['level']>=4){
									$ubicacion = $new_location.'&id='.$_GET['id'].'&del='.$peoneta['idPeoneta'];
