...
WHERE ".$z1." AND bodegas_productos_facturacion.idCliente = {$_GET['view']}
...
$z = "WHERE cotizacion_listado.idCliente = {$_GET['view']}";
//verifico que sea un administrador
		...
		<header>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<?php if(!empty($arrVentas)){ ?>
					<li class=""><a href="#ventas" data-toggle="tab">Ventas realizadas</a></li>
				<?php } ?>
				<?php if(!empty($arrCotizaciones)){ ?>
					<li class=""><a href="#cotizaciones" data-toggle="tab">Cotizaciones realizadas</a></li>
				<?php } ?>
			</ul>	
		</header>
									...
									<tr class="odd">		
										<td>
											<div class="btn-group" style="width: 35px;" >
												<a href="<?php echo 'view_mov_productos.php?view='.$venta['idFacturacion'].'&return=true'; ?>" title="Ver Informacion" class="btn btn-primary btn-sm tooltip"><i class="fa fa-list"></i></a>
											</div>
								...
								<tbody role="alert" aria-live="polite" aria-relevant="all">
									<?php foreach ($arrCotizaciones as $sol) { ?>
										<tr class="odd">
											...
											<td>
												<div class="btn-group" style="width: 35px;" >
													<a href="<?php echo 'view_cotizacion.php?view='.$sol['idCotizacion'].'&return=true'; ?>" title="Ver Orden" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list"></i></a>
												</div>
											</td>
										</tr>
									<?php } ?>
