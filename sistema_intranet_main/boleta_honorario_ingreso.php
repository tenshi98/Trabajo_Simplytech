...
$SIS_where = "boleta_honorarios_facturacion.idTipo=1";//Solo ingresos
...
if(isset($_GET['idTrabajador']) && $_GET['idTrabajador']!=''){      $SIS_where .= " AND boleta_honorarios_facturacion.idTrabajador=".$_GET['idTrabajador'];}
