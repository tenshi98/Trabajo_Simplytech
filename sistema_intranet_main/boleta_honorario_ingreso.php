		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($_SESSION['boleta_ing_servicios'][$_GET['editOtros']]['idExistencia'])&&$_SESSION['boleta_ing_servicios'][$_GET['editOtros']]['idExistencia']!=''){
					$Form_Imputs->form_input_disabled('Valor Total Neto','vTotal_fake', $x2, 1);
				}else{
					$Form_Imputs->form_input_number('Valor Total Neto', 'vTotal', $x2, 2);
				}
				
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['boleta_ing_servicios'][$_GET['editOtros']]['idServicio'], 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($idOcompra)) {          $x4  = $idOcompra;        }else{$x4  = $_SESSION['boleta_ing_basicos']['idOcompra'];}
	...
	<div id="page-wrap">
		...
		<table id="items">
			<tbody>
				...
				$_SESSION['boleta_ing_basicos']['valor_imp']    = $vtotal_neto * 0.10;
				$_SESSION['boleta_ing_basicos']['valor_total']  = $vtotal_neto - ($vtotal_neto * 0.10);
				?>
				...
				<tr>
					<?php if(isset($_SESSION['boleta_ing_basicos']['Observaciones'])&&$_SESSION['boleta_ing_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['boleta_ing_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['boleta_ing_temporal'])&&$_SESSION['boleta_ing_temporal']!=''){
								$non = $_SESSION['boleta_ing_temporal'];
							}	
