...
$query = "SELECT Nombre, Config_imgLogo
FROM `core_sistemas`
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Logo</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php } ?>
						<li class="active"><a href="<?php echo 'admin_datos_datos_imagen.php';?>" >Logo</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				...
				<?php if(isset($rowdata['Config_imgLogo'])&&$rowdata['Config_imgLogo']!=''){?>
					...
					<div class="col-sm-10 fcenter">
					  <img src="upload/<?php echo $rowdata['Config_imgLogo'] ?>" width="100%" > 
					</div> 
					<a href="<?php echo $new_location.'?id='.$_SESSION['usuario']['basic_data']['idSistema'].'&del_img='.$_SESSION['usuario']['basic_data']['idSistema']; ?>" class="btn btn-danger fright margin_width" style="margin-top:10px;margin-bottom:10px;"><i class="fa fa-trash-o" aria-hidden="true"></i> Borrar Imagen</a>
					<div class="clearfix"></div>
				...
				<?php }else{?>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
						...
						$Form_Imputs->form_multiple_upload('Seleccionar archivo','Config_imgLogo', 1, '"jpg", "png", "gif", "jpeg"');
