...
$original = "informe_backup_telemetria_registro_sensores_14.php";
$location = $original;
...
if(isset($ndata_1)&&$ndata_1>=10001){
	...
	$arrEquipos = array();
	$arrEquipos = db_select_array (false, $SIS_query, 'backup_telemetria_listado_tablarelacionada_'.$_GET['idTelemetria'], $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'test_logo');
	...
	<div class="col-sm-12">
		...
		<div class="col-md-6 col-sm-6 col-xs-12 clearfix">
			<a target="new" href="<?php echo 'informe_backup_telemetria_registro_sensores_14_to_excel.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
			...
			<?php }else{ ?>
				<a target="new" href="<?php echo 'informe_backup_telemetria_registro_sensores_14_to_pdf.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-3 pull-right margin_width"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar a PDF</a>
			<?php } ?>
	...
	if(isset($_GET['idGrafico'])&&$_GET['idGrafico']==1){ ?>
		...
		<div class="col-sm-12">
			<div class="box">
				<header>
					...
					<h5> Graficos <?php echo 'Sensor '.$arrEquipos[0]['Grupo'].'-'.$arrEquipos[0]['SensorNombre'].' del equipo '.$rowEquipo['NombreEquipo']; ?></h5>
				</header>
		...
		<div class="col-sm-12" style="display: none;">
			...
			<form method="post" id="make_pdf" action="informe_backup_telemetria_registro_sensores_14_to_pdf.php">
	...
	<div class="col-sm-12">
		<div class="box">
			<header>
				<div class="icons"><i class="fa fa-table" aria-hidden="true"></i></div>
				<h5>Tabla de Datos <?php echo 'Sensor '.$arrEquipos[0]['Grupo'].'-'.$arrEquipos[0]['SensorNombre'].' del equipo '.$rowEquipo['NombreEquipo']; ?></h5>
