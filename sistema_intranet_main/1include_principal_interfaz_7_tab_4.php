<div class="tab-pane fade" id="Menu_tab_4">
	...
	if($prm_x[1]['Val']=='1' OR $_SESSION['usuario']['basic_data']['idTipoUsuario']==1) {
		...
		echo '<div class="col-sm-12 breadcrumb-bar" style="margin-top:15px;">';
			echo '<a href="'.$prm_x[1]['Link'].'&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Tarea Pendiente</a>';
		echo '</div>';
																...
																<div class="profile-image pull-right">';
																	...
																	if(isset($arrRespTemp[$tarea['idTareas']])){
																		foreach ($arrRespTemp[$tarea['idTareas']] as $key =>$resp) {
																			...
																			//imprimo
																			echo '<img class="rounded-circle tooltip fright" style="position: initial;" src="'.$IMG_Resources.'" title="'.$resp['UsuarioNombre'].'" width="30">';
