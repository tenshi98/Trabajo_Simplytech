...
if(!empty($_GET['mod'])){
	...
	$arrPuntos = array();
	$arrPuntos = db_select_array (false, $SIS_query, 'telemetria_geocercas_ubicaciones', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrPuntos');
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 140px;" >
									<?php if ($rowlevel['level']>=1){ ?><a href="<?php echo 'view_geocerca_telemetria.php?view='.simpleEncode($cerca['idZona'], fecha_actual()); ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
