	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_disabled('Valor Unitario','Unitario', Cantidades_decimales_justos($_SESSION['productos_traspaso_productos'][$_GET['editProd']]['ValorEgreso']), 1);
				$Form_Inputs->form_input_hidden('ValorEgreso', Cantidades_decimales_justos($_SESSION['productos_traspaso_productos'][$_GET['editProd']]['ValorEgreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($Observaciones)) {    $x4  = $Observaciones;     }else{$x4  = $_SESSION['productos_traspaso_basicos']['Observaciones'];}
				
				//se dibujan los inputs
				$Form_Inputs = new Form_Inputs();
				$Form_Inputs->form_date('Fecha','Creacion_fecha', $x1, 2);
				$Form_Inputs->form_select_join_filter('Bodega Origen','idBodegaOrigen', $x2, 2, 'idBodega', 'Nombre', 'bodegas_productos_listado', 'usuarios_bodegas_productos', $z1, $dbConn);
				$Form_Inputs->form_select('Bodega Destino','idBodegaDestino', $x3, 2, 'idBodega', 'Nombre', 'bodegas_productos_listado', $z2, '', $dbConn);
...
<div class="col-sm-12">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['productos_traspaso_basicos']['Observaciones'];?></p>
		</div>
	</div>
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				if(isset($idBodegaDestino)) {  $x5  = $idBodegaDestino;   }else{$x5  = '';}
				...
				$Form_Inputs->form_select_join_filter('Bodega Origen','idBodegaOrigen', $x4, 1, 'idBodega', 'Nombre', 'bodegas_productos_listado', 'usuarios_bodegas_productos', $z1, $dbConn);
				$Form_Inputs->form_select('Bodega Destino','idBodegaDestino', $x5, 1, 'idBodega', 'Nombre', 'bodegas_productos_listado', $z2, '', $dbConn);
