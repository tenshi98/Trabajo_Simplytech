...
$location = $original;
$new_location = "unidad_negocio_listado_ubicacion.php";
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Maquina creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Maquina editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Maquina borrado correctamente';}
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Editar Ubicacion</span>
			</div>
		</div>
	</div>
</div>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li class="active"><a href="<?php echo 'unidad_negocio_listado_ubicacion.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Ubicacion</a></li>
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_select_depend5('Ubicacion', 'idUbicacion',  $x1,  2,  'idUbicacion',  'Nombre',  'ubicacion_listado',  'idCliente = '.$rowdata['idCliente'].' AND idEstado=1',   0,
