...
$location = $original;
$new_location = "aguas_clientes_listado_datos_mediciones.php";
...
$query = "SELECT Identificador, Nombre,idSector, idPuntoMuestreo, UTM_norte, UTM_este
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'aguas_clientes_listado_datos_mediciones.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-eyedropper" aria-hidden="true"></i> Datos Mediciones</a></li>
        ...
        <div class="table-responsive">
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter" style="padding-top:40px;padding-bottom:240px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
					...
					$Form_Inputs->form_select('Sector','idSector', $x1, 2, 'idSector', 'Nombre', 'aguas_analisis_sectores', 0, '', $dbConn);
