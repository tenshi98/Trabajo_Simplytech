...
$query = "SELECT idTelemetria, Direccion_img,id_Geo,id_Sensores,Nombre, 
idUsoContrato
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php } ?>
						<li class="active"><a href="<?php echo 'admin_telemetria_listado_imagen.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Imagen</a></li>
