...
$original = "informe_backup_telemetria_errores_1.php";
$location = $original;
...
$z.=" AND backup_telemetria_listado_errores.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];
...
$query = "SELECT backup_telemetria_listado_errores.idErrores FROM `backup_telemetria_listado_errores`  LEFT JOIN `telemetria_listado` ON telemetria_listado.idTelemetria = backup_telemetria_listado_errores.idTelemetria ".$join."  ".$z;
//Consulta
