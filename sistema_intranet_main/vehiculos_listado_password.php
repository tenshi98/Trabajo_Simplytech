...
$query = "SELECT Nombre,Patente,idSistema,Password,vehiculos_listado.idOpciones_1, idOpciones_2, 
idOpciones_3, idOpciones_4, idOpciones_5,idOpciones_6, idOpciones_7, idOpciones_8
	...
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">Cambiar Password</span>
			</div>
		</div>
	</div>
</div>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						if(isset($rowdata['idOpciones_6'])&&$rowdata['idOpciones_6']==1){?>
							<li class="active"><a href="<?php echo 'vehiculos_listado_password.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Password APP</a></li>
						<?php }
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_input_password('Password', 'Password', $x1, 2);
