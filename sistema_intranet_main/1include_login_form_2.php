<!-- Correcciones CSS -->
<style>
	.login .form-signin {max-width: 330px;padding: 20px;margin: 0 auto;border-radius: 15px;position: relative;}
	.login_logo{width:100%!important;margin-bottom: 20px;}
	.tab-content .text-muted {margin-left: 0px !important;}
