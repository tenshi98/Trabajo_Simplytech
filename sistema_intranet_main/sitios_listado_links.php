...
$location = $original;
$new_location = "sitios_listado_links.php";
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/sitios_listado_links.php';
}
...
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Enlace Modificado correctamente';}
...
if(!empty($_GET['edit'])){
// consulto los datos
$SIS_query = 'Nombre,Enlace,PalabrasClave,idEstado';
$SIS_join  = '';
	...
	<div class="box">
		...
		<div class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
				...
				if(isset($Enlace)){          $x2 = $Enlace;          }else{$x2 = $rowData['Enlace'];}
				if(isset($PalabrasClave)){   $x3 = $PalabrasClave;   }else{$x3 = $rowData['PalabrasClave'];}
	...
	<div class="box">
		...
		<div class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
				...
				if(isset($Enlace)){          $x2 = $Enlace;          }else{$x2 = '';}
				if(isset($PalabrasClave)){   $x3 = $PalabrasClave;   }else{$x3 = '';}
...
//Permisos a sistemas
$SIS_query = '
sitios_listado_links.idLinks,
sitios_listado_links.Nombre,
sitios_listado_links.Enlace,
sitios_listado_links.idEstado,
core_estados.Nombre AS Estado';
$SIS_join  = 'LEFT JOIN `core_estados` ON core_estados.idEstado = sitios_listado_links.idEstado';
$SIS_where = 'sitios_listado_links.idSitio = '.simpleDecode($_GET['id'], fecha_actual());
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 105px;" >
									<?php if ($rowlevel['level']>=2){ ?><a href="<?php echo $new_location.'&id='.$_GET['id'].'&edit='.$menu['idLinks']; ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><?php } ?>
