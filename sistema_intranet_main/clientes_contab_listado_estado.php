...
$location = $original;
$new_location = "clientes_contab_listado_estado.php";
...
$SIS_join  = 'LEFT JOIN `core_estados`   ON core_estados.idEstado = clientes_listado.idEstado';
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Cliente', $rowdata['Nombre'], 'Editar Estado'); ?>
</div>
