...
$z = "WHERE seg_vecinal_reportes_post_listado.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];
$z .= " AND seg_vecinal_reportes_post_listado.idRevisado=1"; //solo los no revisados
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['idCliente']) && $_GET['idCliente'] != ''){      $z .= " AND seg_vecinal_reportes_post_listado.idCliente='".$_GET['idCliente']."'";}
if(isset($_GET['idTipo']) && $_GET['idTipo'] != ''){            $z .= " AND seg_vecinal_reportes_post_listado.idTipo='".$_GET['idTipo']."'";}
if(isset($_GET['Fecha']) && $_GET['Fecha'] != ''){              $z .= " AND seg_vecinal_reportes_post_listado.Fecha='".$_GET['Fecha']."'";}
if(isset($_GET['Hora']) && $_GET['Hora'] != ''){                $z .= " AND seg_vecinal_reportes_post_listado.Hora='".$_GET['Hora']."'";}
/**********************************************************/
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idReportes FROM `seg_vecinal_reportes_post_listado` ".$z;
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
if(!$resultado){
