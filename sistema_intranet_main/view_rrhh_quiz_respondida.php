...
rrhh_quiz_listado.idLimiteTiempo,
quiz_realizadas.Total_Preguntas'.$subquery;
$SIS_join  = '
LEFT JOIN `rrhh_quiz_listado`            ON rrhh_quiz_listado.idQuiz                       = quiz_realizadas.idQuiz
...
$SIS_where = 'rrhh_quiz_listado_preguntas.idQuiz ='.$X_idQuiz;
...
<div class="row no-print">
	<div class="col-xs-12">
		<a target="new" href="view_rrhh_quiz_respondida_to_print.php<?php echo '?view='.$_GET['view'].'&idQuiz='.$_GET['idQuiz'] ?>" class="btn btn-default pull-right" style="margin-right: 5px;">
