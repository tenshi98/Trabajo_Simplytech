...
$SIS_where = 'caja_chica_listado.idSistema ='.$_SESSION['usuario']['basic_data']['idSistema'];
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<?php if($x_permisos_4 > 0){ ?>
							<li class="active"><a href="<?php echo 'usuarios_listado_cajas.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-usd" aria-hidden="true"></i> Caja Chica</a></li>
						<?php } ?>
