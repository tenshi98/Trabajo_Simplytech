...
function crear_data($limite, $idTelemetria, $f_inicio, $f_termino, $dbConn ) {
	...
	backup_telemetria_listado_tablarelacionada_'.$idTelemetria.'.GeoLatitud AS GeoLatitudEquipo,
	backup_telemetria_listado_tablarelacionada_'.$idTelemetria.'.GeoLongitud AS GeoLongitudEquipo,
	backup_telemetria_listado_tablarelacionada_'.$idTelemetria.'.GeoVelocidad AS GeoVelocidadEquipo,
	backup_telemetria_listado_tablarelacionada_'.$idTelemetria.'.GeoDireccion AS GeoDireccionEquipo,
	backup_telemetria_listado_tablarelacionada_'.$idTelemetria.'.GeoMovimiento AS GeoMovimientoEquipo'.$subquery;
	$SIS_join  = '
