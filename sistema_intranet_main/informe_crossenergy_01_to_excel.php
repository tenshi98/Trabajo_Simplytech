...
if(isset($ndata_1)&&$ndata_1>=10001){
	...
	// Rename worksheet
	$objPHPExcel->getActiveSheet()->setTitle('Resumen Dia');
	...
	header('Content-Disposition: attachment;filename="Informe Resumen Dia grupo '.$rowGrupo['Nombre'].' del equipo '.$rowEquipo['NombreEquipo'].'.xls"');
