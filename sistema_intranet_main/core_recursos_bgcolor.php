	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="#fuentes" data-toggle="tab">Fuentes</a></li>
			...
			<div class="tab-pane fade active in" id="fuentes">
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<div class="box">
						...
						<div class="body">
							<h3 class="text-muted">Heading 1</h3>
							<h3 class="text-primary">Heading 2</h3>
							<h3 class="text-warning">Heading 3</h3>
							<h3 class="text-danger">Heading 4</h3>
							<h3 class="text-success">Heading 5</h3>
							<h3 class="text-info">Heading 6</h3>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<div class="box">
						...
						<div class="body">
							<h3 class="color-red">-red</h3>
							<h3 class="color-red-light">-red-light</h3>
							<h3 class="color-red-dark">-red-dark</h3>
							<h3 class="color-blue">-blue</h3>
							<h3 class="color-blue-light">-blue-light</h3>
							<h3 class="color-blue-dark">-blue-dark</h3>
							<h3 class="color-green">-green</h3>
							<h3 class="color-green-light">-green-light</h3>
							<h3 class="color-green-dark">-green-dark</h3>
							<h3 class="color-yellow">-yellow</h3>
							<h3 class="color-yellow-light">-yellow-light</h3>
							<h3 class="color-yellow-dark">-yellow-dark</h3>
							<h3 class="color-dark">-dark</h3>
							<h3 class="color-dark-light">-dark-light</h3>
							<h3 class="color-dark-dark">-dark-dark</h3>
							<h3 class="color-gray">-gray</h3>
							<h3 class="color-gray-light">-gray-light</h3>
							<h3 class="color-gray-dark">-gray-dark</h3>
							<h3 class="color-white">-white</h3>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<div class="box">
						...
						<div class="body">
							<h3 class="color-mdb-text">-mdb-text</h3>
							<h3 class="color-red-text">-red-text</h3>
							<h3 class="color-pink-text">-pink-text</h3>
							<h3 class="color-purple-text">-purple-text</h3>
							<h3 class="color-deep-purple-text">-deep-purple-text</h3>
							<h3 class="color-indigo-text">-indigo-text</h3>
							<h3 class="color-blue-text">-blue-text</h3>
							<h3 class="color-light-blue-text">-light-blue-text</h3>
							<h3 class="color-cyan-text">-cyan-text</h3>
							<h3 class="color-teal-text">-teal-text</h3>
							<h3 class="color-green-text">-green-text</h3>
							<h3 class="color-light-green-text">-light-green-text</h3>
							<h3 class="color-lime-text">-lime-text</h3>
							<h3 class="color-yellow-text">-yellow-text</h3>
							<h3 class="color-amber-text">-amber-text</h3>
							<h3 class="color-orange-text">-orange-text</h3>
							<h3 class="color-deep-orange-text">-deep-orange-text</h3>
							<h3 class="color-brown-text">-brown-text</h3>
							<h3 class="color-blue-grey-text">-blue-grey-text</h3>
							<h3 class="color-grey-text">-grey-text</h3>
						</div>
					</div>
				</div>
			...
			<div class="tab-pane fade" id="mycolors">
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<ul class="list-unstyled">
						...
						<li class="rgba-grey-strong">rgba-grey-strong</li>
					</ul>
				</div>
