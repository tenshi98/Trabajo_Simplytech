...
$original = "informe_gerencial_14.php";
$location = $original;
...
".$z1."
GROUP BY bodegas_arriendos_facturacion.idProveedor, bodegas_arriendos_facturacion.Creacion_mes
...
".$z2."
GROUP BY bodegas_insumos_facturacion.idProveedor, bodegas_insumos_facturacion.Creacion_mes
...
".$z3."
GROUP BY bodegas_productos_facturacion.idProveedor, bodegas_productos_facturacion.Creacion_mes
...
".$z4."
GROUP BY bodegas_servicios_facturacion.idProveedor, bodegas_servicios_facturacion.Creacion_mes
...
foreach ($arrTemporal_1 as $temp) {
	...
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['idProveedor']       = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Creacion_mes']    = $temp['Creacion_mes'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Neto_1']          = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Total_1']         = $temp['ValorTotal'];
}
foreach ($arrTemporal_2 as $temp) {
	$arrCreativo[$temp['idProveedor']][0]['Proveedor']                             = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['idProveedor']       = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Creacion_mes']    = $temp['Creacion_mes'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Neto_2']          = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Total_2']         = $temp['ValorTotal'];
}
foreach ($arrTemporal_3 as $temp) {
	$arrCreativo[$temp['idProveedor']][0]['Proveedor']                             = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['idProveedor']       = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Creacion_mes']    = $temp['Creacion_mes'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Neto_3']          = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Total_3']         = $temp['ValorTotal'];
}
foreach ($arrTemporal_4 as $temp) {
	$arrCreativo[$temp['idProveedor']][0]['Proveedor']                             = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['idProveedor']       = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Creacion_mes']    = $temp['Creacion_mes'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Neto_4']          = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_mes']]['Total_4']         = $temp['ValorTotal'];
}
/*************************************************************************************************/
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
	<a target="new" href="<?php echo 'informe_gerencial_14_to_excel_4.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
</div>
		...
		<div class="table-responsive">
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					<?php foreach ($arrCreativo as $datais) { ?>
						<tr class="odd"><td align="left" colspan="12" style="background-color: #BFBFBF;"><strong><?php echo $datais[0]['Proveedor']; ?></strong></td></tr>
...
LEFT JOIN `proveedor_listado`    ON proveedor_listado.idProveedor   = bodegas_arriendos_facturacion.idProveedor
".$z1."
GROUP BY bodegas_arriendos_facturacion.idProveedor, bodegas_arriendos_facturacion.Creacion_fecha
...
LEFT JOIN `proveedor_listado`    ON proveedor_listado.idProveedor   = bodegas_insumos_facturacion.idProveedor
".$z2."
GROUP BY bodegas_insumos_facturacion.idProveedor, bodegas_insumos_facturacion.Creacion_fecha
...
LEFT JOIN `proveedor_listado`    ON proveedor_listado.idProveedor   = bodegas_productos_facturacion.idProveedor
".$z3."
GROUP BY bodegas_productos_facturacion.idProveedor, bodegas_productos_facturacion.Creacion_fecha
...
LEFT JOIN `proveedor_listado`    ON proveedor_listado.idProveedor   = bodegas_servicios_facturacion.idProveedor
".$z4."
GROUP BY bodegas_servicios_facturacion.idProveedor, bodegas_servicios_facturacion.Creacion_fecha
...
foreach ($arrTemporal_1 as $temp) {
	$arrCreativo[$temp['idProveedor']][0]['Proveedor']                               = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['idProveedor']       = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Creacion_fecha']  = $temp['Creacion_fecha'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Neto_1']          = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Total_1']         = $temp['ValorTotal'];
}
foreach ($arrTemporal_2 as $temp) {
	$arrCreativo[$temp['idProveedor']][0]['Proveedor']                               = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['idProveedor']       = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Creacion_fecha']  = $temp['Creacion_fecha'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Neto_2']          = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Total_2']         = $temp['ValorTotal'];
}
foreach ($arrTemporal_3 as $temp) {
	$arrCreativo[$temp['idProveedor']][0]['Proveedor']                               = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['idProveedor']       = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Creacion_fecha']  = $temp['Creacion_fecha'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Neto_3']          = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Total_3']         = $temp['ValorTotal'];
}
foreach ($arrTemporal_4 as $temp) {
	$arrCreativo[$temp['idProveedor']][0]['Proveedor']                               = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['idProveedor']       = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Creacion_fecha']  = $temp['Creacion_fecha'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Neto_4']          = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']][$temp['Creacion_fecha']]['Total_4']         = $temp['ValorTotal'];
}
/*************************************************************************************************/
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
	<a target="new" href="<?php echo 'informe_gerencial_14_to_excel_3.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
</div>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
	<a target="new" href="<?php echo 'informe_gerencial_14_to_excel_2.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
</div>
...
$arrCreativo = array();
foreach ($arrTemporal_1 as $temp) {
	$arrCreativo[$temp['idProveedor']]['idProveedor']    = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']]['Proveedor']      = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']]['Neto_1']       = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']]['Total_1']      = $temp['ValorTotal'];
}
foreach ($arrTemporal_2 as $temp) {
	$arrCreativo[$temp['idProveedor']]['idProveedor']    = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']]['Proveedor']      = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']]['Neto_2']       = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']]['Total_2']      = $temp['ValorTotal'];
}
foreach ($arrTemporal_3 as $temp) {
	$arrCreativo[$temp['idProveedor']]['idProveedor']    = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']]['Proveedor']      = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']]['Neto_3']       = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']]['Total_3']      = $temp['ValorTotal'];
}
foreach ($arrTemporal_4 as $temp) {
	$arrCreativo[$temp['idProveedor']]['idProveedor']    = $temp['idProveedor'];
	$arrCreativo[$temp['idProveedor']]['Proveedor']      = $temp['ProveedorNombre'];
	$arrCreativo[$temp['idProveedor']]['Neto_4']       = $temp['ValorNeto'];
	$arrCreativo[$temp['idProveedor']]['Total_4']      = $temp['ValorTotal'];
}
/*************************************************************************************************/
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
	<a target="new" href="<?php echo 'informe_gerencial_14_to_excel_1.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
</div>
					...
					function drawBasic() {
						...
						data.addRows([
							<?php foreach ($arrCreativo as $prod) {
								...
								if(isset($prod['Neto_4'])){$sub = $sub + $prod['Neto_4'];}
								?>
								["<?php echo $prod['Proveedor']; ?>", <?php echo valores_enteros($sub) ?>],
							<?php } ?>
						]);
		...
		<div class="table-responsive">
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					<?php foreach ($arrCreativo as $prod) { ?>
						<tr class="odd">
							<td align="left"><?php echo $prod['Proveedor']; ?></td>
