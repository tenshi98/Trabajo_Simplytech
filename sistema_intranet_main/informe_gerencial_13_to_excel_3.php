...
foreach ($arrCreativo as $datais) {
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A'.$nn, $datais[0]['Cliente']);
	$nn++;
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Ventas Clientes Por dia');
...
header('Content-Disposition: attachment;filename="Ventas Clientes Por dia Resumen.xls"');
