...
$SIS_where = "bodegas_arriendos_facturacion.idTipo=2";//Solo egresos
$SIS_where.= " AND bodegas_arriendos_facturacion.idEstadoDevolucion=1";//solo los que no tengan devolucion
$SIS_where.= " AND bodegas_arriendos_facturacion.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];	//sistema
/**********************************************************/
