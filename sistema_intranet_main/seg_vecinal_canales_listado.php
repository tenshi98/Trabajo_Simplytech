...
$original = "seg_vecinal_canales_listado.php";
$location = $original;
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/seg_vecinal_canales_listado.php';
}
...
if (isset($_GET['created'])){ $error['created'] = 'sucess/Canal Creado correctamente';}
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Canal Modificado correctamente';}
if (isset($_GET['deleted'])){ $error['deleted'] = 'sucess/Canal borrado correctamente';}
	...
	<div class="box dark">
		...
		<div class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				if(isset($Channel_ID)){   $x4 = $Channel_ID;  }else{$x4 = '';}
...
if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){     $SIS_where .= " AND seg_vecinal_canales_listado.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default pull-right margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Canal</a><?php } ?>
	...
	<div class="well">
		<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				//se dibujan los inputs
				$Form_Inputs = new Form_Inputs();
				$Form_Inputs->form_select('Categoria','idCategoria', $x1, 1, 'idCategoria', 'Nombre', 'seg_vecinal_canales_categorias', 0, '', $dbConn);
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table" aria-hidden="true"></i></div><h5>Listado de Canales</h5>
			<div class="toolbar">
				<?php
