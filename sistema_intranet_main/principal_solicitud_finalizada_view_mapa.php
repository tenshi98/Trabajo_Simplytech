...
WHERE cross_solicitud_aplicacion_listado_tractores.idTelemetria = ".simpleDecode($_GET['idTelemetria'], fecha_actual());
//Consulta
...
WHERE cross_solicitud_aplicacion_listado.idSolicitud = ".simpleDecode($_GET['idSolicitud'], fecha_actual())." 
