...
$location = $original;
$new_location = "clientes_contab_listado_datos.php";
...
/*******************************************************/
// consulto los datos
$SIS_query = 'idTipo, Nombre,fNacimiento, idCiudad, idComuna, Direccion, idSistema, Rut, idPrevired';
$SIS_join  = '';
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="<?php echo 'clientes_contab_listado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-bars" aria-hidden="true"></i> Resumen</a></li>
				<li class="active"><a href="<?php echo 'clientes_contab_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-list-alt" aria-hidden="true"></i> Datos Básicos</a></li>
        ...
        <div class="table-responsive">
			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($idPrevired)){       $x8  = $idPrevired;        }else{$x8  = $rowdata['idPrevired'];}
					if(isset($new_folder)){       $x9  = $new_folder;        }else{$x9  = '';}
					...
					$Form_Inputs->form_select('Uso de Previred','idPrevired', $x8, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);

					$Form_Inputs->form_tittle(3, 'Carpeta documentos plataforma clientes');
					$Form_Inputs->form_select('Recrear Carpeta','new_folder', $x9, 2, 'idOpciones', 'Nombre', 'core_sistemas_opciones', 0, '', $dbConn);
