...
if(isset($_GET['idNota_1']) && $_GET['idNota_1'] != ''){      $z .= " AND cross_quality_calidad_matriz.idNota_1=".$_GET['idNota_1'];}
if(isset($_GET['idNota_2']) && $_GET['idNota_2'] != ''){      $z .= " AND cross_quality_calidad_matriz.idNota_2=".$_GET['idNota_2'];}
if(isset($_GET['idNota_3']) && $_GET['idNota_3'] != ''){      $z .= " AND cross_quality_calidad_matriz.idNota_3=".$_GET['idNota_3'];}
