...
$SIS_where = 'insumos_listado.idEstado=1';
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" style="border: 1px solid black;background-color: #ffffff;">
	<thead>
		<tr>
			...
			<th style="font-size: 10px;border-bottom: 1px solid black;text-align:center;background-color: #c3c3c3;" width="160">Stock Minimo</th>
			<th style="font-size: 10px;border-bottom: 1px solid black;text-align:center;background-color: #c3c3c3;" width="160">Stock Actual</th>
		</tr>
	</thead>
	<tbody>';
		...
		foreach ($arrProductos as $productos) {
			...
			$html .='<tr>
						...
						<td style="font-size: 10px;border-bottom: 1px solid black;text-align:center" width="160">'.Cantidades_decimales_justos($productos['StockLimite']).' '.$productos['UnidadMedida'].'</td>
						<td style="font-size: 10px;border-bottom: 1px solid black;text-align:center" width="160">'.Cantidades_decimales_justos($stock_actual).' '.$productos['UnidadMedida'].'</td>
					</tr>';
		}
