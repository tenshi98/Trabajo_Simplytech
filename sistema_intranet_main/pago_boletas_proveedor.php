...
$original = "pago_boletas_proveedor.php";
$location = $original;     
...
if (!empty($_GET['del_boleta'])){
	...
	require_once 'A1XRXS_sys/xrxs_form/z_pagos_boletas_proveedores.php';
}
/************************************************************/
...
<div class="row inbox"> 
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<h3>
			<strong>Proveedor : </strong><?php echo $row_data['Nombre']; ?><br/>
		</h3>
		<hr>	
	</div>
</div>
...
<script>
	...
	function saveData(idFacturacion, pago) {
		$.get("pago_boletas_proveedor_ok_save.php?idFacturacion="+idFacturacion+"&pago="+pago);
		return false;
	}
	//////////////////////////////////////////////////////////
	...
	function delData(idFacturacion) {
		$.get("pago_boletas_proveedor_ok_delete.php?idFacturacion="+idFacturacion);
		return false;
	}
	//////////////////////////////////////////////////////////
...
$location .= '?submit_filter=true';
if(isset($_GET['idProveedor'])&&$_GET['idProveedor']!=''){
	$Docsubmit_filter .= ' AND boleta_honorarios_facturacion.idProveedor='.$_GET['idProveedor'];
...
".$Docsubmit_filter."
AND boleta_honorarios_facturacion.idTipo=3
...
<script>
	...
	function doSomething(number) {
		$.get("pago_boletas_proveedor_execute.php?idFacturacion="+number);
		return false;
	}
