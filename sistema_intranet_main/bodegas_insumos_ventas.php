...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	(SELECT SUM(Cantidad_ing) FROM `bodegas_insumos_facturacion_existencias` WHERE idProducto = insumos_listado.idProducto AND idBodega='.$_SESSION['insumos_vent_basicos']['idBodega'].' LIMIT 1) AS ingreso,
	(SELECT SUM(Cantidad_eg)  FROM `bodegas_insumos_facturacion_existencias` WHERE idProducto = insumos_listado.idProducto AND idBodega='.$_SESSION['insumos_vent_basicos']['idBodega'].' LIMIT 1) AS egreso';
	$SIS_join  = 'LEFT JOIN `sistema_productos_uml` ON sistema_productos_uml.idUml = insumos_listado.idUml';
	$SIS_where = 'insumos_listado.idProducto='.$_SESSION['insumos_vent_productos'][$_GET['editProd']]['idProducto'];
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_where = "bodegas_insumos_facturacion.idTipo=2";//Solo egresos
