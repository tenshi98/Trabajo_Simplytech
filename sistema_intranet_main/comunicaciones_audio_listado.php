...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/AudioConferencia Creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/AudioConferencia Modificada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/AudioConferencia borrada correctamente';}
...
WHERE comunicaciones_audio_listado.idAudio = ".$_GET['id'];
//Consulta
...
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario   = comunicaciones_audio_listado_usuarios.idUsuario

WHERE comunicaciones_audio_listado_usuarios.idAudio = ".$_GET['id']."
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class=""><a href="<?php echo 'comunicaciones_audio_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-list-alt" aria-hidden="true"></i> Datos Basicos</a></li>
...
$z = "WHERE comunicaciones_audio_listado.idEstado!=0";
//Verifico el tipo de usuario que esta ingresando
$z.=" AND comunicaciones_audio_listado.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];	
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){        $z .= " AND comunicaciones_audio_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['Fecha']) && $_GET['Fecha'] != ''){          $z .= " AND comunicaciones_audio_listado.Fecha='".$_GET['Fecha']."'";}
if(isset($_GET['idEstado']) && $_GET['idEstado'] != ''){    $z .= " AND comunicaciones_audio_listado.idEstado='".$_GET['idEstado']."'";}
...
".$z."
ORDER BY comunicaciones_audio_listado.idEstado ASC, comunicaciones_audio_listado.Fecha ASC
";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
while ( $row = mysqli_fetch_assoc ($resultado)) {
array_push( $arrAudioConferencia,$row );
}
//Verifico el tipo de usuario que esta ingresando
