			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php if(isset($rowdata['doc_resolucion_sanitaria'])&&$rowdata['doc_resolucion_sanitaria']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						...
						<br/>
						<a href="<?php echo $new_location.'&id='.$_GET['id'].'&del_doc_resolucion_sanitaria='.$_GET['id']; ?>" class="btn btn-danger fright margin_width" style="margin-top:10px;margin-bottom:10px;"><i class="fa fa-trash-o" aria-hidden="true"></i> Borrar Archivo</a>
					</div>
					<div class="clearfix"></div>
