...
$z.=" AND telemetria_listado_errores_999.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];
...
$query = "SELECT telemetria_listado_errores_999.idErrores FROM `telemetria_listado_errores_999`  LEFT JOIN `telemetria_listado` ON telemetria_listado.idTelemetria = telemetria_listado_errores_999.idTelemetria ".$join."  ".$z;
//Consulta
