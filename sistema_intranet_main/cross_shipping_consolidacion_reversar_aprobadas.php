						...
						<td>
							<div class="btn-group" style="width: 70px;" >
								...
								<?php if ($rowlevel['level']>=3){
									$ubicacion = $location.'&reversar='.$tipo['idConsolidacion'];
									$dialogo   = '¿Realmente deseas reversar la  Consolidacion '.$tipo['CTNNombreCompañia'].'?';?>
									<a onClick="dialogBox('<?php echo $ubicacion ?>', '<?php echo $dialogo ?>')" title="Reversar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o"></i></a>
								<?php } ?>								
							</div>
						</td>
					</tr>
