						...
						<td>
							<div class="btn-group" style="width: 70px;" >
								...
								<?php if ($rowlevel['level']>=3){
									...
									<a onClick="dialogBox('<?php echo $ubicacion ?>', '<?php echo $dialogo ?>')" title="Reversar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
								<?php } ?>
							</div>
						</td>
					</tr>
