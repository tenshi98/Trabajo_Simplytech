...
$original = "informe_backup_telemetria_registro_sensores_12.php";
$location = $original;
...
if(isset($ndata_1)&&$ndata_1>=10001){
	...
	LEFT JOIN `telemetria_listado_sensores_activo`  ON telemetria_listado_sensores_activo.idTelemetria   = backup_telemetria_listado_tablarelacionada_'.$_GET['idTelemetria'].'.idTelemetria';
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 clearfix">
			<a target="new" href="<?php echo 'informe_backup_telemetria_registro_sensores_12_to_excel.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-2 pull-right margin_width"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar a Excel</a>
			...
			<?php }else{ ?>
				<a target="new" href="<?php echo 'informe_backup_telemetria_registro_sensores_12_to_pdf.php?bla=bla'.$search ; ?>" class="btn btn-sm btn-metis-3 pull-right margin_width"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar a PDF</a>
			<?php } ?>
	...
	if(isset($_GET['idGrafico'])&&$_GET['idGrafico']==1){ ?>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="display: none;">
			...
			<form method="post" id="make_pdf" action="informe_backup_telemetria_registro_sensores_12_to_pdf.php">
