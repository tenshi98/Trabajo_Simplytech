...
if(!empty($_GET['editProd'])){
	...
	(SELECT SUM(Cantidad_ing) FROM `bodegas_productos_facturacion_existencias` WHERE idProducto = productos_listado.idProducto AND idBodega='.$_SESSION['productos_traspasoempresa_basicos']['idBodegaOrigen'].' LIMIT 1) AS ingreso,
	(SELECT SUM(Cantidad_eg)  FROM `bodegas_productos_facturacion_existencias` WHERE idProducto = productos_listado.idProducto AND idBodega='.$_SESSION['productos_traspasoempresa_basicos']['idBodegaOrigen'].' LIMIT 1) AS egreso';
		...
		<div class="box">
			...
			<div class="body">
				<form class="form-horizontal" method="post" id="form1" name="form1" autocomplete="off" novalidate>
					...
					if(isset($Observaciones)){     $x5  = $Observaciones;      }else{$x5  = $_SESSION['productos_traspasoempresa_basicos']['Observaciones'];}
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="col-xs-12">
			<div class="row">
				...
				<p class="text-muted well well-sm no-shadow" ><?php echo $_SESSION['productos_traspasoempresa_basicos']['Observaciones']; ?></p>
			</div>
		</div>
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
		switch ($_GET['order_by']) {
			case 'origen_asc':         $order_by = 'bodega1.Nombre ASC ';                                $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Origen Ascendente'; break;
			case 'origen_desc':        $order_by = 'bodega1.Nombre DESC ';                               $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Origen Descendente';break;
			case 'destino_asc':        $order_by = 'bodega2.Nombre ASC ';                                $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Destino Ascendente';break;
			case 'destino_desc':       $order_by = 'bodega2.Nombre DESC ';                               $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Destino Descendente';break;
	...
	$SIS_where = "bodegas_productos_facturacion.idTipo=6";//Solo traspaso a otra empresa
