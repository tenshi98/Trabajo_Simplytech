...
$original = "informe_telemetria_registro_promedios_4.php";
$location = $original;
...
?>
<div class="col-sm-12">
	<a target="new" href="<?php echo 'informe_telemetria_registro_promedios_4_to_excel.php'.$search ; ?>" class="btn btn-sm btn-metis-2 fright margin_width"><i class="fa fa-file-excel-o"></i> Exportar a Excel</a>
</div>
