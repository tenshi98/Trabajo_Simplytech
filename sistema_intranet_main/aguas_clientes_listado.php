...
if(isset($_GET['Identificador']) && $_GET['Identificador']!=''){  $SIS_where .= " AND aguas_clientes_listado.Identificador LIKE '%".EstandarizarInput($_GET['Identificador'])."%'";}
if(isset($_GET['Nombre']) && $_GET['Nombre']!=''){         $SIS_where .= " AND aguas_clientes_listado.Nombre LIKE '%".EstandarizarInput($_GET['Nombre'])."%'";}
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group" style="width: 105px;" >
								<?php if ($rowlevel['level']>=1){ ?><a href="<?php echo 'view_aguas_cliente.php?view='.simpleEncode($usuarios['idCliente'], fecha_actual()); ?>" title="Ver Información" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a><?php } ?>
