...
if(isset($ndata_1)&&$ndata_1>=10001){
	...
	// Rename worksheet
	$objPHPExcel->getActiveSheet()->setTitle('Registro Camaras');
	...
	header('Content-Disposition: attachment;filename="Registro Camaras del equipo '.$rowEquipo['NombreEquipo'].'.xls"');
