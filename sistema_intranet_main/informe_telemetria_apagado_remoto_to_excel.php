...
$SIS_order = 'telemetria_listado_historial_encendidos.idEncendido DESC';
$arrEncendidos = array();
...
foreach ($arrErrores as $error) {
	...
	$spreadsheet->setActiveSheetIndex(0)
				...
				->setCellValue('D'.$nn, $error['Encendido'])
				->setCellValue('E'.$nn, $error['Usuario']);
	$nn++;
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Resumen de Encendidos');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Resumen de Encendidos';
