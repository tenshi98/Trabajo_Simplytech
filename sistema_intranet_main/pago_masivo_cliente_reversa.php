...
if(!empty($_GET['submit_filter'])){
	...
	//datos de la obra
	$NDocsubmit_filter1   = '';
	if(isset($_GET['idDocPago'])&&$_GET['idDocPago']!=''){	$NDocsubmit_filter1 .= ' AND pagos_facturas_clientes.idDocPago='.$_GET['idDocPago'];}
	if(isset($_GET['N_DocPago'])&&$_GET['N_DocPago']!=''){	$NDocsubmit_filter1 .= ' AND pagos_facturas_clientes.N_DocPago='.$_GET['N_DocPago'];}
	/*******************************************************/
	// consulto los datos
	$SIS_query = '
	...
	$SIS_where = '
	(bodegas_arriendos_facturacion.idTipo=2 '.$NDocsubmit_filter1.')
	...
	$SIS_order = 0;
	$arrReversa = array();
	$arrReversa = db_select_array (false, $SIS_query, 'pagos_facturas_clientes', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrReversa');
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
		switch ($_GET['order_by']) {
			case 'fecha_asc':        $order_by = 'pagos_facturas_clientes_reversa.Fecha ASC ';         $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ascendente'; break;
			case 'fecha_desc':       $order_by = 'pagos_facturas_clientes_reversa.Fecha DESC ';        $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Fecha Descendente';break;
			...
			case 'n_documento_asc':  $order_by = 'pagos_facturas_clientes_reversa.N_DocPago ASC ';     $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> N° Documento Ascendente'; break;
			case 'n_documento_desc': $order_by = 'pagos_facturas_clientes_reversa.N_DocPago DESC ';    $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> N° Documento Descendente';break;
			case 'monto_asc':        $order_by = 'pagos_facturas_clientes_reversa.Monto ASC ';         $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Monto Ascendente'; break;
			case 'monto_desc':       $order_by = 'pagos_facturas_clientes_reversa.Monto DESC ';        $bread_order = '<i class="fa fa-sort-alpha-desc" aria-hidden="true"></i> Monto Descendente';break;
			...
			default: $order_by = 'pagos_facturas_clientes_reversa.Fecha ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ascendente';
		}
	}else{
		$order_by = 'pagos_facturas_clientes_reversa.Fecha ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Fecha Ascendente';
	}
	...
	$arrAFP = array();
	$arrAFP = db_select_array (false, $SIS_query, 'pagos_facturas_clientes_reversa', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrAFP');
