...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$SIS_join  = 'LEFT JOIN `quiz_categorias` ON quiz_categorias.idCategoria = quiz_listado_preguntas.idCategoria';
	$SIS_where = 'quiz_listado_preguntas.idQuiz='.$_GET['idQuiz'];
	$SIS_where.= ' GROUP BY quiz_listado_preguntas.idCategoria';
	$SIS_order = 'quiz_listado_preguntas.idCategoria ASC';
	$arrCategoria = array();
	$arrCategoria = db_select_array (false, $SIS_query, 'quiz_listado_preguntas', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrCategoria');
