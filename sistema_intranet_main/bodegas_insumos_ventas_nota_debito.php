...
WHERE insumos_listado.idProducto='{$_SESSION['insumos_egr_nd_productos'][$_GET['editProd']]['idProducto']}'
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_disabled('Valor Unitario Neto','Unitario', Cantidades_decimales_justos($_SESSION['insumos_egr_nd_productos'][$_GET['editProd']]['ValorIngreso']), 1);
				$Form_Imputs->form_input_number('Valor Total Neto', 'ValorTotal', $x3, 2);
				$Form_Imputs->form_input_hidden('ValorIngreso', Cantidades_decimales_justos($_SESSION['insumos_egr_nd_productos'][$_GET['editProd']]['ValorIngreso']), 2);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_hidden('oldidProducto', $_SESSION['insumos_egr_nd_otros'][$_GET['editOtros']]['idOtros'], 2);
	...
	<div id="page-wrap">
		...
		<table id="items">
			<tbody>
				...
				<tr>
					<?php if(isset($_SESSION['insumos_egr_nd_basicos']['Observaciones'])&&$_SESSION['insumos_egr_nd_basicos']['Observaciones']!=''){ ?>
					
						<td colspan="5" class="blank word_break"> 
							<?php echo $_SESSION['insumos_egr_nd_basicos']['Observaciones'];?>
						</td>
						<td class="blank">
							<div class="btn-group" style="width: 35px;" >
								<?php 
					...
					<?php }else{?>
						<td colspan="5" class="blank"> 
							<?php 
							$non = '';
							if(isset($_SESSION['insumos_egr_nd_temporal'])&&$_SESSION['insumos_egr_nd_temporal']!=''){
								$non = $_SESSION['insumos_egr_nd_temporal'];
							}	
...
$z="WHERE bodegas_insumos_facturacion.idTipo=12";//Solo ingresos
//Verifico el tipo de usuario que esta ingresando
	...
	<div class="well">
		<div class="col-sm-8 fcenter">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Imputs->form_date('F Documento','Creacion_fecha', $x4, 1);
				$Form_Imputs->form_select_join_filter('Bodega origen','idBodega', $x7, 1, 'idBodega', 'Nombre', 'bodegas_insumos_listado', 'usuarios_bodegas_insumos', $y, $dbConn);
