...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C1', $arrRutas[0]['Grupo'].'-'.$arrRutas[0]['SensorNombre'])
...
header('Content-Disposition: attachment;filename="Informe Trazabilidad Sensor del equipo '.$arrRutas[0]['NombreEquipo'].'.xls"');
