...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Zona de Peligro Modificado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Zona de Peligro borrado correctamente';}
...
$z = "WHERE seg_vecinal_peligros_listado.idPeligro!=0";
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['idCliente']) && $_GET['idCliente'] != ''){      $z .= " AND seg_vecinal_peligros_listado.idCliente='".$_GET['idCliente']."'";}
...
if(isset($_GET['Direccion']) && $_GET['Direccion'] != ''){      $z .= " AND seg_vecinal_peligros_listado.Direccion='".$_GET['Direccion']."'";}
if(isset($_GET['Fecha']) && $_GET['Fecha'] != ''){              $z .= " AND seg_vecinal_peligros_listado.Fecha='".$_GET['Fecha']."'";}
if(isset($_GET['Hora']) && $_GET['Hora'] != ''){                $z .= " AND seg_vecinal_peligros_listado.Hora='".$_GET['Hora']."'";}
if(isset($_GET['idEstado']) && $_GET['idEstado'] != ''){        $z .= " AND seg_vecinal_peligros_listado.idEstado='".$_GET['idEstado']."'";}
if(isset($_GET['idValidado']) && $_GET['idValidado'] != ''){    $z .= " AND seg_vecinal_peligros_listado.idValidado='".$_GET['idValidado']."'";}
/**********************************************************/
