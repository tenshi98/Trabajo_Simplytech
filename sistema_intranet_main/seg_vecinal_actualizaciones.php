...
$original = "seg_vecinal_actualizaciones.php";
$location = $original;
...
if (!empty($_POST['submit'])){
	...
	$form_trabajo= 'insert';
	require_once 'A1XRXS_sys/xrxs_form/seg_vecinal_actualizaciones.php';
}
...
if (isset($_GET['created'])){ $error['created'] = 'sucess/Actualizacion Creada correctamente';}
if (isset($_GET['edited'])){  $error['edited']  = 'sucess/Actualizacion Modificada correctamente';}
if (isset($_GET['deleted'])){ $error['deleted'] = 'sucess/Actualizacion Borrada correctamente';}
...
if(!empty($_GET['id'])){
	...
	$rowData = db_select_data (false, $SIS_query, 'seg_vecinal_actualizaciones', $SIS_join, $SIS_where, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'rowData');
	...
	<div class="col-xs-12 col-sm-10 col-md-9 col-lg-8 fcenter">
		<div class="box">
			<header>
				...
				<h5>Modificación de Actualizacion</h5>
			</header>
			<div class="body">
...
<?php //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$arrBloqueo = array();
	$arrBloqueo = db_select_array (false, $SIS_query, 'seg_vecinal_actualizaciones', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrBloqueo');
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 70px;" >
									<a href="<?php echo $location.'&id='.$bloqueo['idLog']; ?>" title="Editar Información" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
									<?php
