...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Actualizacion Creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Actualizacion Modificada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Actualizacion borrada correctamente';}
...
FROM `seg_vecinal_actualizaciones`
WHERE idLog = ".$_GET['id'];
//Consulta
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Actualizacion</a><?php }?>
