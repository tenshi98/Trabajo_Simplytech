...
if(isset($_GET['order_by'])&&$_GET['order_by']!=''){
	switch ($_GET['order_by']) {
		case 'nombre_asc':        $order_by = 'oficinas_listado.Nombre ASC ';         $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';break;
		...
		default: $order_by = 'oficinas_listado.idEstado ASC, oficinas_listado.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';
	}
}else{
	$order_by = 'oficinas_listado.idEstado ASC, oficinas_listado.Nombre ASC '; $bread_order = '<i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Nombre Ascendente';
}
/**********************************************************/
//Variable de busqueda
$SIS_where = "oficinas_listado.idOficina!=0";
//sistema
$SIS_where.= " AND oficinas_listado.idSistema=".$_SESSION['usuario']['basic_data']['idSistema'];	
/**********************************************************/
//Se aplican los filtros
if(isset($_GET['idEstado']) && $_GET['idEstado'] != ''){      $SIS_where .= " AND oficinas_listado.idEstado=".$_GET['idEstado'];}
if(isset($_GET['Nombre']) && $_GET['Nombre'] != ''){          $SIS_where .= " AND oficinas_listado.Nombre LIKE '%".$_GET['Nombre']."%'";}
if(isset($_GET['Ubicacion']) && $_GET['Ubicacion'] != ''){    $SIS_where .= " AND oficinas_listado.Ubicacion LIKE '%".$_GET['Ubicacion']."%'";}
...
$arrUsers = array();
$arrUsers = db_select_array (false, $SIS_query, 'oficinas_listado', $SIS_join, $SIS_where, $SIS_order, $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'arrUsers');
