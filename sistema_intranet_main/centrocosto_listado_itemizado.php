...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Centro de Costo creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Centro de Costo editada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Centro de Costo borrada correctamente';}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Imputs->form_input_hidden('idCentroCosto', $_GET['id'], 2);
				$Form_Imputs->form_input_hidden('lvl', $_GET['lvl'], 2);
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="<?php echo 'centrocosto_listado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Resumen</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li class="active"><a href="<?php echo 'centrocosto_listado_itemizado.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Itemizado</a></li>
					</ul>
                </li>           
			</ul>	
		</header>
