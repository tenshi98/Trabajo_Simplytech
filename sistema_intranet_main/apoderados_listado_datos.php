	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'apoderados_listado_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Datos</a></li>
        ...
        <div class="table-responsive">
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>		
					...
					$Form_Imputs->form_date('F. Nacimiento','FNacimiento', $x5, 1);
					$Form_Imputs->form_input_phone('Fono', 'Fono1', $x6, 1);
					$Form_Imputs->form_input_phone('Fono', 'Fono2', $x7, 1);
					...
					$Form_Imputs->form_date('F. Inicio Contrato','F_Inicio_Contrato', $x11, 1);
					$Form_Imputs->form_date('F. Termino Contrato','F_Termino_Contrato', $x12, 1);
