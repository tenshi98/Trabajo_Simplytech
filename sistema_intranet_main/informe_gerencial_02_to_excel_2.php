...
//sololas del mismo sistema
$SIS_where_1.=" GROUP BY bodegas_arriendos_facturacion.idTrabajador, bodegas_arriendos_facturacion.Creacion_Semana";
$SIS_where_2.=" GROUP BY bodegas_insumos_facturacion.idTrabajador, bodegas_insumos_facturacion.Creacion_Semana";
$SIS_where_3.=" GROUP BY bodegas_productos_facturacion.idTrabajador, bodegas_productos_facturacion.Creacion_Semana";
$SIS_where_4.=" GROUP BY bodegas_servicios_facturacion.idTrabajador, bodegas_servicios_facturacion.Creacion_Semana";
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Ventas Vendedores por semana');
...
/**************************************************************************/
//Nombre del archivo
$filename = 'Ventas Vendedores por semana';
